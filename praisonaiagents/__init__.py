...
_LAZY_IMPORTS = {
    ...
    'LearnConfig': ('praisonaiagents.config.feature_configs', 'LearnConfig'),
    'LearnScope': ('praisonaiagents.config.feature_configs', 'LearnScope'),
    'LearnMode': ('praisonaiagents.config.feature_configs', 'LearnMode'),
    'LearnBackend': ('praisonaiagents.config.feature_configs', 'LearnBackend'),
    'LearnProtocol': ('praisonaiagents.memory.learn.protocols', 'LearnProtocol'),
    'AsyncLearnProtocol': ('praisonaiagents.memory.learn.protocols', 'AsyncLearnProtocol'),
    'LearnManagerProtocol': ('praisonaiagents.memory.learn.protocols', 'LearnManagerProtocol'),
    'LearnManager': ('praisonaiagents.memory.learn', 'LearnManager'),
