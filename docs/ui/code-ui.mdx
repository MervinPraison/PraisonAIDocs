---
title: "PraisonAI Code UI"
sidebarTitle: "Code UI"
...
<Note>
For complete documentation on external agents UI toggles across all PraisonAI interfaces, see [External Agents in UI](/features/external-agents-ui).
</Note>
