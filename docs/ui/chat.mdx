...
PraisonAI Chat supports various database backends for different use cases:
...
- **Oracle**
  - `oracle+cx_oracle://user:password@host:port/service`
- **Microsoft SQL Server**
  - `mssql+aioodbc://user:password@host:port/database`

#### Modern & NoSQL Databases
- **SurrealDB** (multi-model: document, graph, relational)
  - `surrealdb://user:password@host:port/namespace/database`
...
- **Chroma** (vector database)
  - `chromadb://host:port/collection`
- **Pinecone** (managed vector database)
  - `pinecone://api-key@environment/index`
- **Weaviate** (vector search engine)
  - `weaviate://host:port`
- **LanceDB** (vector database)
  - `lancedb://path/to/database`

For other database types, refer to the specific database documentation for the correct connection string format.
