---
title: "Deepseek Streamlit UI"
description: "Create interactive chat interfaces with Deepseek models using Streamlit"
icon: "window"
---
...
<Steps>
    ...
    <Step title="Setup Environment">
        ...
        ```bash
        export OPENAI_MODEL_NAME=ollama/deepseek-r1
        export OPENAI_BASE_URL=http://localhost:11434/v1
        export OPENAI_API_KEY=fake-key
        ```

        <Warning>
        Naming the model is required. With only `OPENAI_BASE_URL` set, the OpenAI default `gpt-4o-mini` is sent to Ollama and fails with `404 model 'gpt-4o-mini' not found`. See [Ollama → Common pitfall](/models/ollama#common-pitfall-naming-the-model-matters).
        </Warning>
    </Step>
