...
Together AI provides fast, affordable access to leading open-source models. Format: `together_ai/model-name`
...
- **DeepSeek**: `together_ai/deepseek-ai/DeepSeek-R1-Distill-Llama-70B`
