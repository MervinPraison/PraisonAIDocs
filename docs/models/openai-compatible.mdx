...
<Tab title="vLLM">
You can also use the registered `vllm/…` / `hosted_vllm/…` prefix directly — see [Custom Provider Registry](/models/custom-provider) for the registry-based route.
...
<Tab title="LM Studio">
You can also use the registered `lm_studio/…` prefix directly — see [Custom Provider Registry](/models/custom-provider) for the registry-based route.
