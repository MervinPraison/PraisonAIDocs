...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/rag/quickstart">
    Get started in 5 minutes
  </Card>
  <Card title="RAG Module" icon="cube" href="/rag/module">
    Detailed API reference
  </Card>
  <Card title="CLI Commands" icon="terminal" href="/rag/cli">
    Command-line usage
  </Card>
  <Card title="Citations" icon="quote-left" href="/rag/citations">
