...
<Note>
**One vocabulary:** `approval=` is the same word you already use on the agent — `Agent(name="…", approval="high")`. See [Agent Approval](/docs/features/approval). `requires_approval=` still works as a deprecated alias (below).
</Note>
