...
See [Prompt Cache Optimisation](/features/prompt-cache-optimization) for tool sorting and the deterministic memory prefix.
</Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
<Card title="Prompt Cache Optimisation" icon="database" href="/features/prompt-cache-optimization">
