...
See [Platform SDK Client](/features/platform/sdk-client) for endpoint-level detail.
...
<CardGroup cols={2}>
<Card title="Platform SDK Reference" icon="api" href="/features/platform/sdk-client">
  REST endpoints and request schemas
</Card>
<Card title="Platform Client SDK Testing" icon="vial" href="/features/platform-client-sdk-testing">
