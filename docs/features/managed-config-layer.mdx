...
<Note>
This is a **config resolution layer** for org-wide defaults and policy. It is unrelated to [ManagedAgent](/features/managed-typed-configs), which is a hosted-agent runtime feature. This page is about *how config values are resolved*, not about running hosted agents.
</Note>
