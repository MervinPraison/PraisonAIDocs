...
<CardGroup cols={2}>
<Card title="Platform Auth Configuration" icon="shield" href="/features/platform/auth-configuration">
  Authentication and authorisation setup
</Card>
<Card title="Platform Agents" icon="robot" href="/features/platform/agents">
