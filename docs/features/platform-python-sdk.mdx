...
<CardGroup cols={2}>
<Card title="Platform SDK Client" icon="cloud" href="/features/platform-sdk">
  Complete PlatformClient method reference
</Card>
<Card title="Platform Authentication" icon="shield" href="/features/platform/authentication">
