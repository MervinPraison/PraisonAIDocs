...
Declare approval right on the `@tool` decorator — the agent pauses and asks a human before the tool runs. See [Tool Requires Approval](/docs/features/tool-requires-approval).

<Card title="Tool Requires Approval" icon="shield-check" href="/docs/features/tool-requires-approval">
