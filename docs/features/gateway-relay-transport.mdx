...
See [Gateway Scale-to-Zero](/features/gateway-scale-to-zero) for configuring the full idle policy.
...
On reconnect the relay may miss messages. Enable [Durable Delivery](/features/durable-delivery) so the outbound outbox survives relay disconnections.
</Accordion>
...
<CardGroup cols={2}>
<Card title="Gateway Scale-to-Zero" icon="circle-pause" href="/features/gateway-scale-to-zero">
