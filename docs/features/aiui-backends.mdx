...
sequenceDiagram
    ...
    User->>Agent: Open UI page
    Agent->>Backend: set_backend lookup
    Backend-->>Agent: Data / hooks
    Agent-->>User: Rendered page
```
...
```mermaid
graph TB
    Q{What are you wiring?} -->|Token analytics| U[usage_sink / usage_query]
    Q -->|YAML workflows| W[workflows]
    Q -->|UI hook list| H[hooks]
    Q -->|Human approvals| A[approvals_pending / approvals_policies]
...
<Card title="L3 Dashboard Pages" icon="chart-line" href="/features/l3-dashboard-pages">
