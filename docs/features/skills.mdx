...
<Tip>
**Distribute skills across a team from a git repo?** See [Remote Skills](/docs/features/remote-skills) — one command syncs a shared skill set into every project's cache.
</Tip>
...
2. `~/.praisonai/skills/`
3. `~/.praisonai/cache/remote-skills/*/current/` (populated by `praisonai skills sync` — see [Remote Skills](/docs/features/remote-skills))
...
<CardGroup cols={2}>
  ...
  <Card title="Remote Skills" icon="cloud-arrow-down" href="/docs/features/remote-skills">
