...
<Tip>
**Distribute skills across a team from a git repo?** See [Remote Skill Sources](/docs/features/skills-remote-sources) — one command syncs a shared skill set into every project's cache.
</Tip>
...
<Card title="SkillsConfig SDK Reference" icon="code" href="/docs/sdk/reference/praisonaiagents/modules/feature_configs">
...
2. `~/.praisonai/skills/`
3. `~/.praisonai/cache/remote-skills/*/current/` (populated by `praisonai skills sync` — see [Remote Skill Sources](/docs/features/skills-remote-sources))
...
See [Skill Bundles](/docs/features/skill-bundles) for the full guide.
...
<CardGroup cols={2}>
  <Card title="Skill Bundles" icon="box" href="/docs/features/skill-bundles">
  ...
  <Card title="Remote Skill Sources" icon="cloud-arrow-down" href="/docs/features/skills-remote-sources">
