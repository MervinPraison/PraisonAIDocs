...
<CardGroup cols={2}>
  <Card title="Bot Display Policy" icon="sliders" href="/docs/features/bot-display-policy">
    Per-platform policy for streaming, tool progress, and footer — what the operator WANTS (vs what the platform CAN do)
  </Card>
