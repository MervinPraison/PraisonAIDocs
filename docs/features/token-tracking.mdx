...
Since PraisonAI PR [#4462](https://github.com/MervinPraison/PraisonAI/pull/4462), `PraisonAIAgents` exposes instance-scoped views that filter the singleton to the team's own agents — so two concurrent teams never see each other's spend.
