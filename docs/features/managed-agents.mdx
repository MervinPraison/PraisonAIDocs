...
<CardGroup cols={2}>
<Card title="Local Provider" icon="desktop" href="/docs/features/managed-agents-local">
  Run on local infrastructure with cloud management
</Card>
<Card title="Docker Compute" icon="docker" href="/docs/features/managed-agents-docker">
  Containerized execution environments
</Card>
<Card title="E2B Cloud" icon="cloud-bolt" href="/docs/features/managed-agents-e2b">
  Instant cloud sandboxes for code execution
</Card>
<Card title="Modal Compute" icon="server" href="/docs/features/managed-agents-modal">
  Serverless compute for scalable workloads
</Card>
<Card title="Daytona Workspaces" icon="code" href="/docs/features/managed-agents-daytona">
