...
<Note>
Truncated outputs are persisted to disk so the agent can retrieve them — see [Tool Output Store](/features/tool-output-store).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card icon="database" href="/features/tool-output-store" title="Tool Output Store">
