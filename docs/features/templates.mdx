...
<Card title="TemplateConfig API Reference" icon="code" href="/sdk/reference/praisonaiagents/modules/feature_configs">
...
<Card title="Industry Templates" icon="building-2" href="/features/industry-templates/overview">
