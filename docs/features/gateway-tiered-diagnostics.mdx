...
<Card title="Runtime Preflight" icon="list-check" href="/docs/features/runtime-preflight">
  Pre-start readiness verification
</Card>
<Card title="Loop Watchdog" icon="rotate" href="/docs/features/gateway-loop-watchdog">
