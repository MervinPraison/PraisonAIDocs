...
<Note>
A thread the gateway spawns can also be routed to a specialist agent on the inbound side — see [Parent-chain matching](/features/gateway-route-bindings#parent-chain-matching).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Live Session Handoff" icon="arrow-right-arrow-left" href="/features/gateway-live-handoff">
    Re-home a conversation onto a thread on another platform
  </Card>
</CardGroup>
