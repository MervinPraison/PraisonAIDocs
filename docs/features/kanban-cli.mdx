...
<Note>
**Feature Status:** The CLI commands documented here require wrapper implementation. The core SDK provides protocols only. See [praisonaiagents.kanban.protocols](/docs/features/kanban) for available interfaces.
</Note>
