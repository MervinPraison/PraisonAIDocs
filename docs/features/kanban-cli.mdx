...
<Note>
**Feature Status:** The CLI commands documented here require wrapper implementation. The core SDK provides protocols only. See [praisonaiagents.kanban.protocols](/features/kanban) for available interfaces.
</Note>
...
<CardGroup cols={2}>
<Card title="Kanban Feature" icon="kanban" href="/features/kanban">
