...
History injection loads previous conversation messages from a session store and includes them in the agent's context for seamless multi-turn conversations.
