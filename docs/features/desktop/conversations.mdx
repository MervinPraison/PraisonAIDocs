...
The raw response codes behind these paths — `200`, `400`, `500` — are in [Engine API](/features/desktop/api).
...
The same engine powers the terminal — see [Session Search](/cli/session-search).
