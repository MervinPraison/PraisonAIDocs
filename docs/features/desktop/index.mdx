...
description: "Native desktop chat app that runs PraisonAI agents locally"
icon: "display"
---

PraisonAI Desktop is a native app for macOS, Windows, and Linux that runs your PraisonAI agents locally with streaming chat, tool calls, approvals, MCP servers, fine-tuning, and per-conversation memory — no browser required.
