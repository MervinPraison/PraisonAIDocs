...
Generate an MP4 from a prompt — MiniMax, Sora 2, or Veo 3.1
</Card>
...
<Card title="Agent Framework" icon="layer-group" href="/features/desktop/frameworks">
