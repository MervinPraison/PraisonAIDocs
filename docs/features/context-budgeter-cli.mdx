...
Use [Token Estimation CLI](/features/context-token-estimation-cli) accurate mode when validating budget numbers.
</Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Token Estimation CLI" icon="calculator" href="/features/context-token-estimation-cli">
