...
<AccordionGroup>
  ...
  <Accordion title="Rotate and protect log files">
    Store logs outside web-served directories. The audit path is protected by default — do not disable [Protected Paths](/features/protected-paths) on production hosts.
  </Accordion>
</AccordionGroup>
