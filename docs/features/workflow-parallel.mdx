...
sequenceDiagram
    ...
    User->>Workflow: Start parallel workflow
    par Parallel execution
        Workflow->>Agent1: Task 1
        Workflow->>Agent2: Task 2
        Workflow->>Agent3: Task 3
    end
    Agent1-->>Workflow: Result 1
    Agent2-->>Workflow: Result 2
    Agent3-->>Workflow: Result 3
    Workflow-->>User: Combined results
```
