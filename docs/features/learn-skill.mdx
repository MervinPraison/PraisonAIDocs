...
<Note>
Skills authored by `learn_skill` go through the **same human approval gate** as any other agent-created skill. By default the tool returns `{"status": "pending", "id": "skl-…"}` and disk is not touched until a human approves. See [Skill Manage](/features/skill-manage).
</Note>
...
<CardGroup cols={2}>
  <Card title="Skill Manage" icon="shield-check" href="/features/skill-manage">
  ...
  <Card title="Self-Improving Agents" icon="rotate" href="/features/self-improve">
  ...
  <Card title="Prompt Optimizer" icon="wand-magic-sparkles" href="/features/prompt-optimizer">
    Sibling self-improvement method that optimises the agent's instructions
  </Card>
