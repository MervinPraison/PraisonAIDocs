...
<Note>
For voice-note transcription in gateway bots (Telegram/Slack/WhatsApp), see [Voice Notes](/features/gateway-voice-notes) — the bot layer already wires `stt_tool` for you.
</Note>
