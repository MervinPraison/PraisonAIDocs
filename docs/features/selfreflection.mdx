...
<Card title="ReflectionConfig SDK Reference" icon="code" href="/sdk/reference/praisonaiagents/modules/feature_configs">
...
<CardGroup cols={2}>
<Card title="Self Improve" icon="sparkles" href="/features/self-improve">
...
<Card title="Execution Systems" icon="play" href="/features/execution-systems">
