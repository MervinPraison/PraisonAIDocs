...
Attribution sanitisation covers untrusted platform metadata; [Prompt Injection Protection](/features/prompt-injection-protection) covers untrusted tool output. Use both for defence in depth.
</Accordion>
...
<Card title="Bot Gateway" icon="network-wired" href="/features/bot-gateway">
