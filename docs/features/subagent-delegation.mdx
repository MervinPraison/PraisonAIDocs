...
<Note>
For delegating to your own named agents defined in `.praisonai/agents/*.md` — by name, mid-run, with no Python — see [Named Agent Delegation](/docs/features/named-agent-delegation).
</Note>
...
The dedicated [Named Agent Delegation](/docs/features/named-agent-delegation) page owns this topic in full.
