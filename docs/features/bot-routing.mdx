...
<AccordionGroup>
  ...
  <Accordion title="Use bindings for fine-grained routing">
    When chat-type routing is not enough, add priority-ordered [Gateway Route Bindings](/features/gateway-route-bindings) for specific users, roles, or channel IDs.
  </Accordion>
