...
# Returns: ['./.praison/plugins/', '~/.praison/plugins/']
...
| `~/.praison/plugins/` | User-wide |

### Generate Plugin Template

```python
from praisonaiagents.plugins import get_plugin_template, ensure_plugin_dir
...
plugin_dir = ensure_plugin_dir()  # Creates ~/.praison/plugins/
```
