...
sequenceDiagram
    participant User
    participant Agent
    participant Feature as Context Optimizer CLI
...
<CardGroup cols={2}>
  <Card title="Context Optimizer" icon="database" href="/features/optimizer">
  ...
  <Card title="Intelligent Conversation Compaction" icon="compress" href="/features/intelligent-conversation-compaction">
