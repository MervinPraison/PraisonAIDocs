...
sequenceDiagram
    ...
    User->>Agent: Request
    Agent->>ContextOptimizer: Process
    ContextOptimizer-->>Agent: Result
    Agent-->>User: Response
```
...
sequenceDiagram
    participant User
    participant Agent
    participant Feature as Context Optimizer
...
<CardGroup cols={2}>
  ...
  <Card title="Optimizer CLI" icon="terminal" href="/features/optimizer-cli">
