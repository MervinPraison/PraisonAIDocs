...
For the full walkthrough and decision tree, see [Knowledge → If your configured backend seems ignored](/features/knowledge#if-your-configured-backend-seems-ignored).
