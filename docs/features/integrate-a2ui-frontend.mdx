...
sidebarTitle: "Integrate A2UI with Your Frontend"
...
sequenceDiagram
    participant User
    participant Agent
    participant Feature as Integrate A2UI with Your Frontend
...
See [Generative UI](/features/generative-ui) for the full tier list:
...
<CardGroup cols={2}>
<Card title="A2UI Protocol" icon="puzzle-piece" href="/features/a2ui">
