...
frameworks = ["autogen", "autogen_v4", "crewai", "ag2", "agno"]
...
| `agno` | Three-step probe: `dist("agno")` → `find_spec("agno")` → `from agno.agent import Agent` | Install: `pip install "praisonai-frameworks[agno]>=0.1.6"` |
