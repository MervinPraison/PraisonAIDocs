...
| WhatsApp | 🔜 Planned | Falls back to plain text |
...
Call `adapt_presentation(presentation, PresentationLimits.telegram())` before sending to preview which buttons survive the Telegram limit and how select menus are degraded.
</Accordion>
</AccordionGroup>
