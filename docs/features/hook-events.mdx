...
| `KANBAN_TASK_MOVED` | `KanbanHookInput` | Task status changed. Also fires when the dispatcher auto-promotes a dependent task to `ready` (see [Dependency Auto-Promotion](/docs/features/kanban#dependency-auto-promotion)). |
