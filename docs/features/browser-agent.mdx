...
<CardGroup cols={2}>
<Card title="Workflows" icon="arrows-split-up-and-left" href="/docs/features/workflows">
  Orchestrate multi-agent flows
</Card>
