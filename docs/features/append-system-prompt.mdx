...
<Step title="Or read the suffix from a file">
...
<Step title="Or set the env var (CI-friendly)">

```python
import os
from praisonaiagents import Agent

os.environ["PRAISONAI_APPEND_SYSTEM_PROMPT"] = "Always answer in French"

agent = Agent(instructions="You are a helpful assistant")
agent.start("Explain gradient descent.")
```
