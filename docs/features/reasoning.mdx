...
<Note>
This page covers reasoning as a **technique** (step-by-step problem solving). For **reasoning models** (OpenAI `o1`/`o3`/`o4`/`gpt-5.x`) and how PraisonAI normalises their parameters, see [Reasoning Models](/features/reasoning-models).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Reasoning Extract" icon="brain-circuit" href="/features/reasoning-extract">
