...
os.environ["OPENAI_API_KEY"] = os.getenv("OPENAI_API_KEY", "")  # set OPENAI_API_KEY in your shell before running
...
os.environ["GOOGLE_API_KEY"] = os.getenv("GOOGLE_API_KEY", "")  # set GOOGLE_API_KEY in your shell before running
...
os.environ["ANTHROPIC_API_KEY"] = os.getenv("ANTHROPIC_API_KEY", "")  # set ANTHROPIC_API_KEY in your shell before running
