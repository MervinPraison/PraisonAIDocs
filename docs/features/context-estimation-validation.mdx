...
<CardGroup cols={2}>
<Card title="Token Estimation" icon="calculator" href="/features/context-token-estimation">
  Fast offline token counting
</Card>
<Card title="Context Observability" icon="chart-line" href="/features/context-observability">
