...
<Note>
For the full hook lifecycle model, see the [Hooks concept page](/concepts/hooks).
</Note>
...
<Card title="Bot Lifecycle Hooks" icon="activity" href="/features/bot-lifecycle-hooks">
  Hooks for bot startup and shutdown
</Card>
<Card title="Tool Availability" icon="wrench" href="/features/tool-availability">
