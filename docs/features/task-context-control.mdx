...
sequenceDiagram
    participant User
    participant Agent
    participant Feature as Task Context Control
...
Pair selective retention with [Context Window Management](/features/context-window-management) for automatic overflow protection on agents.
</Accordion>
</AccordionGroup>
...
<Card title="Workflow Validation" icon="circle-check" href="/features/workflow-validation">
