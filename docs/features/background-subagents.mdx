...
description: "Spawn subagents that run in the background and deliver results back to chat automatically"
icon: "rocket"
---
...
| `platform` | `str` | `""` | Origin platform (e.g. `"telegram"`, `"slack"`). Injected automatically by `BotOS`. |
