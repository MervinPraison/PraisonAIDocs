...
| `error` | `errorRowName(kind, message)` — the `errorTitle` in front of the provider prose | The message is whatever the provider said; the kind is the only dependable part of the announcement. |
