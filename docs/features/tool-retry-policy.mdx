...
| `max_delay_ms` | `int` | `30000` | **Hard ceiling** on the delay between retries. Applied *after* jitter, so no wait ever exceeds this value ([PR #5050](https://github.com/MervinPraison/PraisonAI/pull/5050)). |
