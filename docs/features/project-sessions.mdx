...
<Note>
`shared_memory` is auto-enabled for active sessions — you do **not** need `memory: true` in `agents.yaml` for continuity to work. See [YAML / Team Session Continuity](/docs/features/yaml-session-continuity) for the full team flow.
</Note>
