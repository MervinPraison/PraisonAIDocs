...
<CardGroup cols={2}>
<Card title="Gateway Overview" icon="gateway" href="/features/gateway-overview">
  How the gateway connects agents to channels
</Card>
<Card title="Gateway Scale-to-Zero" icon="power" href="/features/gateway-scale-to-zero">
...
<Card title="Multi-Channel Bots" icon="layers" href="/features/multi-channel-bots">
