...
agent = Agent(name="summariser", instructions="Create hierarchical summaries of long documents.")
agent.start("Summarise this 50-page report into a 3-level hierarchy.")
```
...
sequenceDiagram
    participant User
    participant Agent
    participant Feature as Hierarchical Summaries
...
<CardGroup cols={2}>
  ...
  <Card title="RAG Overview" icon="database" href="/features/rag">
