...
<Note>
  This page covers sending images **to** agents. To have tools **return** images and files that the model can see, see [Multimodal Tool Output](./multimodal-tool-output).
</Note>
...
<CardGroup cols={2}>
  <Card title="Multimodal Tool Output" icon="images" href="./multimodal-tool-output">
    Tools that return images and files the model can see
  </Card>
