...
<CardGroup cols={2}>
<Card title="praisonai-train" icon="graduation-cap" href="/features/praisonai-train-package">
...
<Card title="Cross-file dedup" icon="layer-group" href="/features/praisonai-train-dataset-tooling#cross-file-dedup">
