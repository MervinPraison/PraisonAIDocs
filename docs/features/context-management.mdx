...
flowchart TB
    ...
    class MSG,SYS,TOOL,MEM,RAG source
    class EST,BUD,OPT,MON process
    class LLM,RES output
...
flowchart TB
    ...
    classDef output fill:#189AB4,stroke:#7C90A0,color:#fff
    class START start
    class CHECK,STRATEGY,BENEFIT process
    class LLM output
```
...
flowchart LR
    ...
    classDef priority fill:#8B0000,stroke:#7C90A0,color:#fff
    class SPEED,RECENT,QUALITY,BALANCE,TOOLS,SAFE priority
```
...
flowchart TB
    ...
    classDef init fill:#8B0000,stroke:#7C90A0,color:#fff
    classDef active fill:#10B981,stroke:#7C90A0,color:#fff
    classDef complete fill:#189AB4,stroke:#7C90A0,color:#fff
    class INIT,GOAL,PLAN init
    class EXEC,PROGRESS active
    class DONE complete
```
...
flowchart TB
    ...
    class QUERY input
    class AGG,MERGE process
    class MEM,KNOW,RAG,OUT source
```
