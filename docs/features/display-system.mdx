...
The display system formats agent output in the terminal and exposes hooks for custom rendering. For per-channel display on messaging platforms, see [Bot Display Policy](/docs/features/bot-display-policy).
