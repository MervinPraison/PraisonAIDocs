...
2. Picks an embedding-capable model from the server's listing (preferring `nomic-embed-text`, then `mxbai-embed-large`, `bge-m3`, `snowflake-arctic-embed`, `all-minilm`).
