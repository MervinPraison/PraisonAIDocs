...
<Card title="Looking for what was saved?" icon="list-check" href="/features/praisonai-train-checkpoints">
Run `praisonai-train checkpoints` — list every saved step with its size, newest first, no need to `ls` the output directory.
</Card>
...
<Card title="Checkpoints CLI" icon="list-check" href="/features/praisonai-train-checkpoints">
  List what a run saved — every step with its size, newest first.
</Card>
...
<Card title="Multi-GPU" icon="microchip" href="/features/praisonai-train-multigpu">
