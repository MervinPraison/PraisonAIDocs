...
<Tip>
Migrate from Python: `repair_gateway_config(path, fix=True).config_version_migrated` — see [Gateway Admin API](/features/gateway-admin-api).
</Tip>
...
<Card title="GatewayConfig SDK Reference" icon="code" href="/docs/sdk/reference/praisonaiagents/classes/GatewayConfig">
