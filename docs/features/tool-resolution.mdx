...
<Card title="Tool Call Self-Repair" icon="screwdriver-wrench" href="/docs/features/tool-call-self-repair">
  Runtime auto-fix when the LLM emits a drifted tool name during a run.
</Card>
<Card title="Gateway Pre-flight Tool Check" icon="plane-departure" href="/docs/features/gateway-cli#pre-flight-tool-check">
