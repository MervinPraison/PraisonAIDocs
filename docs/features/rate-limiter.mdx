...
<Note>
Looking for **bot/messaging rate limiting** (throttle outbound Telegram/Discord/Slack messages)? See [Bot Rate Limiting](/features/bot-rate-limiting). This page is about **LLM API** rate limiting.
</Note>
