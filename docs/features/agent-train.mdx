...
See [Learn vs Train Comparison](/docs/features/learn-vs-train) for detailed differences.
...
<CardGroup cols={2}>
  ...
  <Card title="Learn vs Train" icon="scale-balanced" href="/docs/features/learn-vs-train">
    Detailed comparison
  </Card>
</CardGroup>
