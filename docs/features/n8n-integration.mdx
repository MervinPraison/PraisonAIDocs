...
export N8N_API_KEY="<your-n8n-api-key>"  # Optional for local
```
</Step>
...
<CardGroup cols={2}>
  <Card title="Agents → n8n Workflows" icon="arrow-right" href="/features/n8n-tools">
    Agents execute n8n workflows to access 400+ integrations
  </Card>
  <Card title="n8n → Agent API" icon="arrow-left" href="/features/n8n-api">
  ...
  <Card title="CLI Export Tools" icon="terminal" href="/cli/n8n">
