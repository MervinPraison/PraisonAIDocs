...
<CardGroup cols={2}>
<Card title="AWS Deploy" icon="aws" href="/deploy/cli/aws">
  CLI deploy to AWS
</Card>
<Card title="Azure Deploy" icon="microsoft" href="/deploy/cli/azure">
  CLI deploy to Azure
</Card>
<Card title="GCP Deploy" icon="google" href="/deploy/cli/gcp">
  CLI deploy to GCP
</Card>
</CardGroup>
...
<CardGroup cols={2}>
<Card title="Deploy Overview" icon="rocket" href="/deploy/index">
