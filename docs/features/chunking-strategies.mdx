...
flowchart LR
    ...
    classDef chunker fill:#F59E0B,stroke:#7C90A0,color:#fff
    classDef store fill:#6366F1,stroke:#7C90A0,color:#fff
    classDef result fill:#10B981,stroke:#7C90A0,color:#fff
    class Document agent
    class Agent,Chunker chunker
    class Token,Sentence,Recursive,Semantic chunker
...
flowchart TD
    ...
    classDef result fill:#10B981,stroke:#7C90A0,color:#fff
    classDef fast fill:#189AB4,stroke:#7C90A0,color:#fff
