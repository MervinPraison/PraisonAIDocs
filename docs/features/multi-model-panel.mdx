...
agent.start("What are the trade-offs of this design?")
```

The user asks once; reference models advise and the aggregator produces the final answer.
...
<Card title="Model Fallback" icon="shield-check" href="/features/model-fallback">
