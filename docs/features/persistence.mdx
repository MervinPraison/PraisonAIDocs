...
<CardGroup cols={2}>
<Card title="SQLite" icon="database" href="/features/persistence-sqlite">
  Local file database for development and single-instance apps
</Card>
<Card title="PostgreSQL" icon="elephant" href="/features/persistence-postgres">
  Production SQL with JSONB and connection pooling
</Card>
<Card title="MySQL" icon="database" href="/features/persistence-mysql">
  Popular SQL database with broad tooling support
</Card>
<Card title="Redis" icon="cubes-stacked" href="/features/persistence-redis">
  Fast in-memory state store
</Card>
<Card title="MongoDB" icon="leaf" href="/features/persistence-mongodb">
  Flexible document store for complex state
</Card>
<Card title="ClickHouse" icon="chart-line" href="/features/persistence-clickhouse">
  Analytics database for large-scale data
</Card>
<Card title="JSON Files" icon="file-code" href="/features/persistence-json">
...
<CardGroup cols={2}>
<Card title="Database Persistence (Advanced)" icon="database" href="/features/database-persistence">
