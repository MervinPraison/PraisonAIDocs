...
This is different from single-agent `PlanningConfig` (see [Planning Mode](/features/planning-mode)), which makes a single agent break down its own task into steps before acting.
</Note>
...
<Card title="Autonomous Workflow" icon="robot" href="/features/autonomous-workflow">
