...
|--------|------|---------|-------------|
| `typing_indicator` | `bool` | `False` | Enable typing indicator while agent is working |
| `keepalive_interval` | `float` | `4.0` | Seconds between keepalive resends |
| `circuit_breaker_threshold` | `int` | `3` | Consecutive failures before circuit opens |
| `safety_ttl` | `float` | `60.0` | Max seconds the indicator can stay active |
