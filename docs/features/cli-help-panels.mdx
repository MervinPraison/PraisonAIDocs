...
<CardGroup cols={2}>
<Card title="CLI Reference" icon="terminal" href="/cli/cli">
  Full command and flag reference
</Card>
<Card title="CLI Dispatcher" icon="arrows-split-up-and-left" href="/features/cli-dispatcher">
  How the CLI routes commands
</Card>
<Card title="CLI Command Lazy Dispatch" icon="bolt" href="/features/cli-command-lazy-dispatch">
  Lazy command resolution for fast startup
</Card>
<Card title="Unknown Command Guard" icon="shield-check" href="/cli/cli#unknown-command-guard">
