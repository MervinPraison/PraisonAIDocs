...
agent = Agent(name="n8n-editor-agent", instructions="Use n8n visual editor to build workflows.")
agent.start("Build a workflow that sends a Slack message when a form is submitted.")
```
...
<CardGroup cols={2}>
  ...
  <Card title="n8n API Integration" icon="code" href="/features/n8n-api">
