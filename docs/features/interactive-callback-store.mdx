...
<CardGroup cols={2}>
  ...
  <Card title="Message Presentation" icon="comment" href="/features/message-presentation">
    Build reply and select prompts agents send to chat
  </Card>
  <Card title="Bot Presentations" icon="table-cells" href="/features/bot-presentations">
    Adapt presentations to each channel's limits
  </Card>
  <Card title="Telegram Durable Approval" icon="shield" href="/features/telegram-durable-approval">
