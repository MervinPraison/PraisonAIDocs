...
Any time a script that used `tools_run_on=` crashed or you killed it, run `managed ps` before starting a new run. Costs stack quietly.
</Accordion>
...
<Card title="Shared Sandbox" icon="share-nodes" href="/features/shared-sandbox">
  What `tools_run_on=` does and how to choose a provider
</Card>
