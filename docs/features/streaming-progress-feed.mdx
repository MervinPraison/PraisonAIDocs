...
<CardGroup cols={2}>
<Card title="Streaming" icon="cpu" href="/features/streaming">
  Streaming responses from agents
</Card>
<Card title="Streaming Tool Events" icon="bolt" href="/features/streaming-tool-events">
...
<Card title="Run Stream Events" icon="list" href="/features/run-stream-events">
