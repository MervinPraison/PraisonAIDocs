...
<Note>
Gateway providers ship pre-registered. To register your **own** provider, see [Custom Provider Registry](/docs/models/custom-provider) — as of [PR #3011](https://github.com/MervinPraison/PraisonAI/pull/3011) user-registered providers are visible to the same wrapper hot paths that gateway providers use.
</Note>
