...
<Card title="Context Compaction" icon="compress" href="/features/intelligent-conversation-compaction">
  Adjacent context-management feature — compact conversation history when approaching token limits.
</Card>
<Card title="Dynamic Context Discovery" icon="brain-circuit" href="/features/dynamic-context-discovery">
  How agents discover and use artifact references in their context window.
</Card>
<Card title="Caching" icon="database" href="/features/prompt-caching">
