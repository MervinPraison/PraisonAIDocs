...
To harden a Windows sandbox, switch backends — see [Sandbox Backends](/docs/features/sandbox-backends).
</Step>
...
See [MCP STDIO Server Transport](/docs/features/mcp-stdio-server-transport) for the reliability guarantees.
</Step>
</Steps>
