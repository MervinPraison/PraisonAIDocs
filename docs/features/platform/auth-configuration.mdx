...
<CardGroup cols={2}>
  <Card title="RBAC Enforcement" icon="shield-check" href="/features/platform/rbac-enforcement">
    Workspace membership and role-based access control
  </Card>
  <Card title="Platform SDK" icon="code" href="/features/platform-python-sdk">
