...
<CardGroup cols={2}>
<Card title="API Authentication" icon="key" href="/features/platform/auth-configuration">
  Learn how to authenticate API requests
</Card>
<Card title="Error Handling" icon="exclamation-triangle" href="/features/error-handling">
