...
See [Authentication Configuration](/features/platform/auth-configuration) for JWT secret setup and security requirements.
</Accordion>
</AccordionGroup>
...
<Card title="Authentication" icon="key" href="/features/platform/authentication">
