...
<Accordion title="Dependency Deletion Security">
...
<CardGroup cols={2}>
<Card title="Issue Management" icon="clipboard" href="/features/platform/issues">
  Core issue creation and management
</Card>
<Card title="Workspace API" icon="building" href="/features/platform/workspaces">
