...
<Card title="Platform Client API Reference" icon="code" href="/features/platform-sdk">
...
<CardGroup cols={2}>
<Card title="Authentication & Security" icon="shield" href="/security">
  Platform security and authentication guides
</Card>
<Card title="Agent Development" icon="robot" href="/features/platform/agents">
