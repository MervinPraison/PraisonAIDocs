...
<CardGroup cols={2}>
<Card title="Platform Dependencies" icon="puzzle-piece" href="/features/platform/dependencies">
  Manage platform service dependencies
</Card>
<Card title="API Error Handling" icon="bug" href="/features/error-handling">
