...
graph TB
    ...
    QualityChoice -->|No| PrefixCustom{"Custom framing?"}
    ...
    class DefaultOK,Customize,QualityChoice,PrefixCustom,TemplateChoice,IterativeChoice decision
    class Simple,LLMSummarize,CustomPrefix,FlatSummary,NoIterative,FullConfig config
```
