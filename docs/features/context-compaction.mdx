...
<Note>
This is fully backward compatible — sessions without a checkpoint resume from raw messages exactly as before. See [Compacted Session Resume](/docs/features/session-compaction-checkpoint) for the persistence details.
</Note>
