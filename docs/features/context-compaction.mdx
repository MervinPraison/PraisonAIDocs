...
# Agent with context compaction for long conversations
agent = Agent(
    name="LongChat",
...
agent.start("Let's have a detailed discussion about AI history...")

# Strategies: TRUNCATE, SLIDING, SUMMARIZE, SMART
```
