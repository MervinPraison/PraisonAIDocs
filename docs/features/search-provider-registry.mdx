...
<CardGroup cols={2}>
<Card title="Tool Search" icon="magnifying-glass" href="/features/tool-search">
  Progressive disclosure when agents have many MCP tools
</Card>
<Card title="Endpoint Provider Registry" icon="plug" href="/features/endpoint-provider-registry">
