...
See [Fail-Loud Defaults](/features/fail-loud-defaults) for migration guidance.
...
<CardGroup cols={2}>
  <Card title="Memory Management" icon="brain" href="/features/memory">
