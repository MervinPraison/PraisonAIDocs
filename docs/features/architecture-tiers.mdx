...
description: "How praisonaiagents, praisonai-code, praisonai-bot, praisonai-train, and praisonai layer on top of each other"
icon: "layer-group"
---

PraisonAI ships as five packages that stack — pick the smallest one that covers what you need.
