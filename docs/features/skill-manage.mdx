...
description: "Let agents propose, create, edit, and patch their own skills — with a human approval gate by default"
...
The skill management system provides six mutation actions and three approval actions:
...
| **delete** | Remove skills completely | ✅ Yes |
...
| `delete` | `name` | `propose` | Remove a skill entirely |
