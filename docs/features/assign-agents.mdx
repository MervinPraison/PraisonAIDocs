...
result = researcher.start("Research the latest AI trends.")
writer.start(result)
```
...
<CardGroup cols={2}>
<Card title="Platform API Reference" icon="code" href="/api">
Complete API documentation for all endpoints
</Card>
<Card title="Python SDK Client" icon="python" href="/features/platform-python-sdk">
