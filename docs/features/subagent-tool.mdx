...
<Note>
Background mode (`background=True`) and the `subagent_result` companion tool require **PraisonAI SDK ≥ 0.0.81** (upstream PR #2399). Check your installed version before using this section. The synchronous API above works with all current releases.
</Note>
