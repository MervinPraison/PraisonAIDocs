...
<!-- AUTO-GENERATED: counts may be regenerated by upstream parity tooling. Do not hand-edit category rows — fix docs or the generator in MervinPraison/PraisonAI instead. -->
