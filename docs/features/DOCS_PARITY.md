<!-- AUTO-GENERATED — Do not edit manually. This file is regenerated by generate_docs_parity.py (run via update_repos.sh or manually). Any manual edits will be overwritten on the next generation run. See AGENTS.md §1.8 for details. -->
