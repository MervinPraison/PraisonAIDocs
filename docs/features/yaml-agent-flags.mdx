...
|---|---|---|---|---|
| `planning` | `bool` | `planning=` | Enables planning mode. | [Planning](/features/planning-mode) |
| `reflection` | `bool` | `reflection=` | Enables self-reflection. | [Reflection](/features/reflection) |
| `guardrails` | `list[str]` | `guardrails=` | Names of guardrails to apply. | [Guardrails](/features/guardrails) |
| `web` | `bool` | `web=` | Enables built-in web tools. | [Web](/features/web) |
| `skills` | `list[str]` | `skills=` | Skills the agent has. | [Skills](/features/skills) |
| `autonomy` | `int 0-10` | `autonomy=` (preset str) | Wrapper maps 1-3→`suggest`, 4-7→`auto_edit`, 8-10→`full_auto`. Also accepts bool/str/dict passthrough. | [Autonomy](/features/autonomy) |
