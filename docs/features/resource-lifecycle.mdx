...
<Card icon="code" href="/docs/sdk/reference/praisonaiagents/functions/AgentTeam-context_manager">
...
<CardGroup cols={2}>
<Card title="Agent Management" icon="user" href="/docs/concepts/agents">
  Core agent concepts and configuration
</Card>
<Card title="Memory Systems" icon="brain" href="/docs/memory/overview">
