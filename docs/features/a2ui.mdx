...
[Generative UI](/features/generative-ui) covers most CopilotKit and structured-output cases with less setup.
</Accordion>
...
<CardGroup cols={2}>
  <Card title="Generative UI" icon="sparkles" href="/features/generative-ui">
    Tiered UI options overview
  </Card>
  <Card title="Integrate A2UI Frontend" icon="code" href="/features/integrate-a2ui-frontend">
