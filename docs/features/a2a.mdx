...
<Note>
A2A `message/stream` currently emits text-only artifacts. For live A2UI during streaming, prefer [AG-UI](/docs/deploy/servers/agui) or [PraisonAIUI](/docs/features/integrate-a2ui-frontend).
</Note>

See [A2UI Protocol](/docs/features/a2ui) for the tool contract and renderer options.
...
<CardGroup cols={2}>
<Card title="A2UI Protocol" icon="window" href="/docs/features/a2ui">
