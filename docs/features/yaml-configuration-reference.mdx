...
Duplicate agent/task names and unknown `agent:` references can also **raise** instead of warn — set `PRAISONAI_VALIDATE_STRICT=true`. See [YAML Validation](/docs/features/yaml-validation).
</Note>
