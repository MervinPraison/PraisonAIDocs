...
Six per-agent keys map directly onto the matching `Agent(...)` kwargs. See [Agent Behaviour Flags in YAML](/docs/features/yaml-agent-flags) for the full mapping and [Autonomy](/docs/features/autonomy) for the level presets.
...
Deep dives: [Planning](/docs/features/planning), [Reflection](/docs/features/reflection), [Guardrails](/docs/features/guardrails), [Web](/docs/features/web), [Skills](/docs/features/skills), [Autonomy](/docs/features/autonomy).
