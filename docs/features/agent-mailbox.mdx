...
<CardGroup cols={2}>
  <Card icon="code" href="/sdk/reference/praisonaiagents/modules/main">
...
<CardGroup cols={2}>
  ...
  <Card title="Multi-Agent Patterns" icon="diagram-project" href="/features/multi-agent-patterns">
    Orchestration patterns for agent teams
  </Card>
  <Card title="Named Agent Delegation" icon="user-group" href="/features/named-agent-delegation">
