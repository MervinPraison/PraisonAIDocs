...
<Note>
Files an agent writes inside a Novita sandbox reach the user through the outbound media path — see [Remote-sandbox media](/features/outbound-media-delivery#remote-sandbox-media-modal-e2b-daytona-fly-io-ssh).
</Note>
