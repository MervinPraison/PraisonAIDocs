...
|---------|----------|-------------|
| `pip install praisonai-train` | `praisonai-train agents/list/show/apply/benchmark`, no CUDA/Unsloth; litellm included for LLM-as-Judge grading | Fastest way to try LLM-as-Judge / human-feedback agent training, or [benchmark deployments](/docs/features/praisonai-train-benchmark) before you fine-tune |
