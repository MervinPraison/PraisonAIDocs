...
<Card title="Injected Tools TypeScript Reference" icon="code" href="/sdk/reference/typescript/classes/LLM">
  TypeScript injected state configuration
</Card>
<Card title="Tools Rust Reference" icon="code" href="/sdk/reference/rust/classes/Tool">
...
<CardGroup cols={2}>
<Card title="Tools" icon="wrench" href="/features/toolsets">
