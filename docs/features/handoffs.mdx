...
sequenceDiagram
    ...
    Agent1->>Router: Evaluate handoff condition
    Router-->>Agent1: Transfer to Agent2
    Agent1->>Agent2: Handoff with context
    Agent2->>Agent2: Process with new context
    Agent2-->>User: Response from specialist
```
