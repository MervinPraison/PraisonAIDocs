...
<Tip>
**Combine with remote:** multi-GPU on a remote box is `--remote-host gpubox --remote-gpus 4`. See [Remote in one step](/features/praisonai-train-inline-remote).
</Tip>
...
<Card title="Checkpointing, Resume & Best-Checkpoint" icon="database" href="/features/praisonai-train-checkpointing">
...
<Card title="Remote GPU Training" icon="server" href="/features/praisonai-train-remote">
  Run multi-GPU on a remote box over SSH — runs survive your laptop closing.
</Card>
...
<Card title="Remote in One Step" icon="server" href="/features/praisonai-train-inline-remote">
  Send the run to a remote GPU box with `--remote-host … --remote-gpus 4`.
</Card>
