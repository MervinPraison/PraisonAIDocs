...
sidebarTitle: "Session Store Protocol"
...
<CardGroup cols={2}>
  <Card icon="floppy-disk" href="/docs/features/session-persistence">
    Learn about session persistence details
  </Card>
  <Card icon="clock-rotate-left" href="/docs/features/sessions">
