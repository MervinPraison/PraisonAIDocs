...
Queued messages are processed in FIFO order. See [Gateway Session Continuity](/features/gateway-session-continuity) for drain behaviour and persisted session shape.
