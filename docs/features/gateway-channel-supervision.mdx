...
<Card title="Full-restart Rollback" icon="rotate-left" href="/features/gateway-hot-reload#full-restart-safety-validated-cutover--rollback">
  Automatic previous-config restore complements per-channel self-healing on a full restart
</Card>
</CardGroup>