...
| `"at:2026-03-01T09:00:00"` | one-shot | ISO 8601 timestamp |
...
|------------|------|------------|-------|
| `"at 9am"` | one-shot | `at:<next 09:00 in tz>` | Fires once at the next 09:00 in the schedule's timezone. If the clock time already passed today, the next occurrence is tomorrow. |
