...
In `default` mode, "Always allow" persists the narrowest reusable pattern by default; a blanket `tool:*` grant is a separate, explicit choice. See [Interactive Approval › Rich / Textual TUI](/docs/features/interactive-approval#rich-%2F-textual-tui-praisonai-code-praisonai-chat).
</Note>
