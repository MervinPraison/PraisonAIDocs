...
<Card title="praisonai-train Package" icon="box" href="/docs/features/praisonai-train-package">
Install matrix for the standalone trainer.
</Card>
<Card title="Multi-GPU Training" icon="server" href="/docs/features/praisonai-train-multigpu">
