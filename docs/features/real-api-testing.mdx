...
<Note>
For **offline** tests that never reach a provider — no API keys, no network, no bill — see [Offline Testing](./offline-testing).
</Note>
...
<CardGroup cols={3}>
<Card title="Offline Testing" icon="flask" href="/features/offline-testing">
  Unit-test agents without hitting a provider
</Card>
<Card title="Real API Testing CLI" icon="terminal" href="/cli/real-api-testing">
  CLI commands for live API tests
</Card>
<Card title="Performance Benchmarks" icon="chart-line" href="/features/performance-benchmarks">
