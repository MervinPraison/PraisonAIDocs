...
<CardGroup cols={2}>
  ...
  <Card title="/learn" icon="graduation-cap">
    Distil a grounded skill from sources you describe. **Privileged** — admin-only by default when a policy is configured. See [Command Access Control](/docs/features/bot-command-access-control).
  </Card>
</CardGroup>
