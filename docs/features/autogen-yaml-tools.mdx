...
<CardGroup cols={2}>
<Card title="AutoGen Tool Registry Migration" icon="arrows-rotate" href="/features/tool-registry-autogen-migration">
  Migrate tool registries into AutoGen
</Card>
<Card title="AutoGen LLM config_list" icon="list" href="/features/llm-autogen-config-list">
