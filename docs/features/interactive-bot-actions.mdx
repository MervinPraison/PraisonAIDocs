...
<Note>
Pending approvals can be made restart-safe by attaching an `ApprovalStore` to the `PresentationApprovalHandler`. See [Durable Approvals](/docs/features/durable-approvals).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Durable Approvals" icon="database" href="/docs/features/durable-approvals">
    Persist pending approvals across bot restarts
  </Card>
</CardGroup>
