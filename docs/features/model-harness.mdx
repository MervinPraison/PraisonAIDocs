...
<Note>
Not related to the offline-testing **model_harness** module (`ScriptedModel`, `allow_model_requests`). The SDK reuses the name `model_harness` for that unrelated concept — see [Offline Testing](./offline-testing).
</Note>
...
<Card title="Rules" icon="scroll" href="/features/rules">
