...
<CardGroup cols={2}>
<Card title="Platform SDK Client" icon="code" href="/features/platform/sdk-client">
  Complete PlatformClient API reference
</Card>
<Card title="RBAC Enforcement" icon="shield" href="/features/platform/rbac-enforcement">
