...
# Add documents with automatic processing (URLs aren't ingested yet)
...
<CardGroup cols={2}>
  ...
  <Card title="Memory Advanced Search" icon="magnifying-glass-plus" href="/features/memory-advanced-search">
