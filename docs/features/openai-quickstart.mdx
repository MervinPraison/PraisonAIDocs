...
<Warning>
On reasoning models (`o1`/`o3`/`o4`/`gpt-5.x`), `temperature` is dropped and `max_tokens` becomes `max_completion_tokens`. See [Reasoning Models](/features/reasoning-models).
</Warning>
...
<CardGroup cols={2}>
  <Card title="Advanced Agent Features" icon="brain" href="/features/reasoning">
    Explore planning, reflection, and advanced reasoning capabilities
  </Card>
  <Card title="Multi-Agent Teams" icon="users" href="/features/multi-agent-pipelines">
  ...
  <Card title="Memory & Knowledge" icon="database" href="/features/memory">
