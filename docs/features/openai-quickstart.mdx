...
graph LR
    ...
    classDef verify fill:#189AB4,stroke:#7C90A0,color:#fff
    classDef agent fill:#8B0000,stroke:#7C90A0,color:#fff
    classDef advanced fill:#10B981,stroke:#7C90A0,color:#fff
...
<Steps>
<Step title="Choose Your Installation">
...
**For Python SDK scripts, add this to load .env:**
```python
from dotenv import load_dotenv
load_dotenv()
```

**For CLI usage:** `.env` files are loaded automatically.
</Tab>
</Tabs>
...
<CardGroup cols={2}>
  ...
  <Card title="Multi-Agent Teams" icon="users" href="/docs/concepts/agents">
  ...
  <Card title="Memory & Knowledge" icon="database" href="/docs/concepts/memory">
