...
<Tip>
For the high-level approval lifecycle model, see the [Approval concept page](/concepts/approval).
</Tip>
...
<CardGroup cols={2}>
<Card title="Approval (Concept)" icon="check-circle" href="/concepts/approval">
...
<Card title="Interactive Approval" icon="mouse-pointer" href="/features/interactive-approval">
