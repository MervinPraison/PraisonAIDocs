...
<CardGroup cols={2}>
<Card title="Interactive Approval" icon="check-circle" href="/features/interactive-approval">
  Deep dive into the interactive approval flow and how to customise it
</Card>
<Card title="Core Controls" icon="sliders" href="/features/core-controls">
  Other safety controls available for agents
</Card>
<Card title="Shell Modes" icon="terminal" href="/features/praison-shell">
  How `praisonai code` refuses shell operators unless a real shell is opted in
</Card>
<Card title="OS Sandbox" icon="shield-check" href="/features/os-sandbox">
  Kernel-enforced containment for agent shell commands
</Card>
</CardGroup>
