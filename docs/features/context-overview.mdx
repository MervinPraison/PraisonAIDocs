...
**PraisonAI 2026-09-03 ([PR #4729](https://github.com/MervinPraison/PraisonAI/pull/4729))**: the streaming path now runs the same `_apply_context_management` step as the non-streaming path. Long-running streamed chats no longer blow past the context window. Fixes [#4714](https://github.com/MervinPraison/PraisonAI/issues/4714).
</Note>
