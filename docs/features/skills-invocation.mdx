...
<Steps>
  ...
  <Step title="Remote cache">`~/.praisonai/cache/remote-skills/<source>/current/` — populated by `praisonai skills sync` (see [Remote Skills](/docs/features/remote-skills))</Step>
