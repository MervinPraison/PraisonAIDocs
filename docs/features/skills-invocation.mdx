...
<Note>
Sharing skills across a team? See **[Remote Skill Sources](/docs/features/skills-remote-sources)** — declare a git URL once and every project stays in sync.
</Note>
...
<Steps>
  ...
  <Step title="Remote cache">`~/.praisonai/cache/remote-skills/<source>/current/` — populated by `praisonai skills sync` (see [Remote Skill Sources](/docs/features/skills-remote-sources))</Step>
