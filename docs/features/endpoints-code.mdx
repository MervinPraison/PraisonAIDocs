...
description: "Programmatic access to PraisonAI endpoints using Python"
icon: "plug"
---
...
<Card title="Recipe Code Server" icon="code" href="/docs/features/recipe-serve-code">
  Serve code-based recipes
</Card>
</CardGroup>
