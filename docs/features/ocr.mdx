...
<CardGroup cols={2}>
  <Card title="OCRAgent" icon="robot" href="/sdk/reference/praisonaiagents/classes/OCRAgent">
    Agent class reference
  </Card>
  <Card title="OCRConfig" icon="sliders" href="/sdk/reference/praisonaiagents/classes/OCRConfig">
...
<CardGroup cols={2}>
  <Card title="Mistral OCR" icon="m" href="/ocr/mistral">
...
<CardGroup cols={2}>
  <Card title="Knowledge" icon="brain" href="/features/knowledge">
