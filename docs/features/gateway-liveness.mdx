...
Treat this close as expected. A reaped peer sees `GatewayCloseCode.LIVENESS_TIMEOUT` (value `"liveness_timeout"`) in the WebSocket close reason. Match on it to reconnect and resume — don't surface it as a fatal error to the user.
</Accordion>
...
<Card title="Hot-Reload Observability" icon="rotate" href="/features/gateway-hot-reload#observability">
