...
The `praisonai.run` / `agents_generator` module is fully lazy after PR [#4821](https://github.com/MervinPraison/PraisonAI/pull/4821) — framework adapters load only when a framework is selected. See [Lazy Imports & Fast Startup](/features/lazy-imports).
...
<CardGroup cols={2}>
<Card title="Lazy Imports & Fast Startup" icon="bolt" href="/features/lazy-imports">
