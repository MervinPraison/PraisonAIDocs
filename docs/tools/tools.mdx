...
| Feature | [Knowledge](/features/knowledge) | [Tools](/features/toolsets) |
|---------|--------------------------------|---------------------------|
...
<CardGroup cols={2}>
  ...
  <Card title="LSP Tools" icon="compass" href="/tools/lsp_tools">
    Language-server-accurate go-to-definition, find-references, and symbol search
  </Card>
  <Card title="Search Tools (grep/glob)" icon="magnifying-glass" href="/tools/search-tools">
    Fast, capped grep and glob built-ins for code-searching agents
  </Card>
  <Card title="Computer Use Tools" icon="computer-mouse" href="/features/computer-use-tools">
...
<CardGroup cols={2}>
  ...
  <Card title="Registry Proxy" icon="plug" href="/features/registry-proxy">
    Call hundreds of API endpoints through one token
  </Card>
</CardGroup>
