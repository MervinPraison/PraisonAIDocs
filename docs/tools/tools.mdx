...
<CardGroup cols={2}>
  ...
  <Card title="Exa" icon="search" href="/docs/tools/exa">
...
<CardGroup cols={2}>
  ...
  <Card title="Tavily Tools" icon="magnifying-glass" href="/docs/tools/tavily">
    AI-optimized web search, news, and content extraction
  </Card>
  <Card title="You.com Tools" icon="globe" href="/tools/you">
    Web search with AI-powered results
  </Card>
  <Card title="Exa Tools" icon="search" href="/docs/tools/exa">
    Neural search for finding similar content
  </Card>
  ...
  <Card title="Spider Tools" icon="spider" href="/docs/tools/spider_tools">
    Web crawling and scraping capabilities for data extraction
  </Card>
  <Card title="Arxiv Tools" icon="book" href="/docs/tools/arxiv_tools">
    Access and search academic papers from arXiv repository
  </Card>
  <Card title="Newspaper Tools" icon="newspaper" href="/docs/tools/newspaper_tools">
    Extract and parse content from news articles and websites
  </Card>
  <Card title="DuckDB Tools" icon="database" href="/docs/tools/duckdb_tools">
    Fast analytical SQL database operations and queries
  </Card>
  <Card title="DuckDuckGo Tools" icon="duck" href="/docs/tools/duckduckgo_tools">
    Web search functionality using DuckDuckGo's API
  </Card>
  <Card title="SearxNG Tools" icon="search" href="/docs/tools/searxng">
    Privacy-focused web search using local SearxNG instance
  </Card>
  <Card title="Calculator Tools" icon="calculator" href="/docs/tools/calculator_tools">
    Perform mathematical calculations and conversions
  </Card>
  <Card title="YAML Tools" icon="file-code" href="/docs/tools/yaml_tools">
    Parse and manipulate YAML format data
  </Card>
  <Card title="JSON Tools" icon="brackets-curly" href="/docs/tools/json_tools">
    Handle JSON data structures and operations
  </Card>
  <Card title="Pandas Tools" icon="table" href="/docs/tools/pandas_tools">
    Data analysis and manipulation using Pandas
  </Card>
  <Card title="YFinance Tools" icon="chart-line" href="/docs/tools/yfinance_tools">
  ...
  <Card title="LSP Tools" icon="compass" href="/docs/tools/lsp_tools">
    Language-server-accurate go-to-definition, find-references, and symbol search
  </Card>
  <Card title="Search Tools (grep/glob)" icon="magnifying-glass" href="/docs/tools/search-tools">
    Fast, capped grep and glob built-ins for code-searching agents
  </Card>
  <Card title="Wikipedia Tools" icon="book-open" href="/docs/tools/wikipedia_tools">
    Access and search Wikipedia articles and data
  </Card>
  <Card title="XML Tools" icon="code" href="/docs/tools/xml_tools">
  ...
  <Card title="Excel Tools" icon="file-excel" href="/docs/tools/excel_tools">
    Work with Excel spreadsheets and workbooks
  </Card>
  <Card title="CSV Tools" icon="file-csv" href="/docs/tools/csv_tools">
...
- Utilities: `file_tools`, `shell_tools`, `python_tools`, `ast_grep_tools`, `lsp_definition`, `lsp_references`, `lsp_hover`, `lsp_document_symbols`, `lsp_workspace_symbols`
...
<CodeGroup>
```python Core Tools (from praisonaiagents)
from praisonaiagents import Agent
...
```python Extended Tools (from praisonai_tools)
from praisonaiagents import Agent
...
<CardGroup cols={2}>
  <Card title="Data Format Tools" icon="brackets-curly" href="/docs/tools/json_tools">
  ...
  <Card title="Research Tools" icon="book" href="/docs/tools/arxiv_tools">
    **Package:** `praisonai-tools`
    - `search_arxiv`, `get_arxiv_paper`
    - `wikipedia_search`
    - `pubmed_search`
  </Card>
  <Card title="Finance/Analytics" icon="chart-line" href="/docs/tools/yfinance_tools">
    **Package:** `praisonai-tools`
    - `get_stock_price` (YFinance)
    - `calculate`, `solve_equation`
    - `duckdb_query`, `pandas_read_csv`
  </Card>
  <Card title="Integration Tools" icon="plug" href="/docs/tools/external/email">
    **Package:** `praisonai-tools`
