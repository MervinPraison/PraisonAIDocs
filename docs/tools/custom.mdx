...
See the [Tool Parameter Types](/tools/parameter-types) page for complete guide.
...
For comprehensive validation details and error fixes, see [Tool Schema Validation](/features/tool-schema-validation).
