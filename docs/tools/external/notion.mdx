...
<CardGroup cols={2}>
  <Card title="File" icon="file" href="/docs/tools/external/file">
    Read and write local documents
  </Card>
  <Card title="Google Search" icon="magnifying-glass" href="/docs/tools/external/google-search">
    Search the web for content
  </Card>
  <Card title="Slack" icon="slack" href="/docs/tools/external/slack">
