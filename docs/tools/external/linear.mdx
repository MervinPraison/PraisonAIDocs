...
<Tip>
Use Linear tools alongside the [LinearBot](/features/linear-bot) for complete issue-to-code automation workflows.
</Tip>
...
<Card title="GitHub Tools" icon="github" href="/tools/external/github">
...
<Card title="Jira" icon="book" href="/tools/jira">
  Project management
</Card>
</CardGroup>