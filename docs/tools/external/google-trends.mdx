...
<CardGroup cols={2}>
  <Card title="Serp Search" icon="book" href="/tools/external/serp-search">
    SerpAPI search
  </Card>
  <Card title="Google Search" icon="book" href="/tools/external/google-search">
    LangChain Google search
  </Card>
  <Card title="Tavily" icon="book" href="/tools/external/tavily">
    AI-powered search
  </Card>
</CardGroup>
