...
<CardGroup cols={2}>
  <Card title="Slack" icon="book" href="/tools/external/slack">
    Slack messaging
  </Card>
  <Card title="Discord" icon="book" href="/tools/external/discord">
    Discord messaging
  </Card>
  <Card title="WhatsApp" icon="book" href="/mcp/whatsapp">
    WhatsApp messaging
  </Card>
</CardGroup>
