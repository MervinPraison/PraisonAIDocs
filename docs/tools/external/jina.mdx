...
<CardGroup cols={2}>
  <Card title="Firecrawl" icon="book" href="/tools/external/firecrawl">
    Web scraping API
  </Card>
  <Card title="Crawl4AI" icon="book" href="/tools/external/crawl4ai">
    Open-source crawler
  </Card>
  <Card title="Trafilatura" icon="book" href="/tools/trafilatura">
    Content extraction
  </Card>
</CardGroup>
