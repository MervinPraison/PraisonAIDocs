...
<CardGroup cols={2}>
  <Card title="Pinecone" icon="book" href="/databases/pinecone">
    Managed vector DB
  </Card>
  <Card title="Chroma" icon="book" href="/databases/chroma">
    Open-source vector DB
  </Card>
  <Card title="Weaviate" icon="book" href="/databases/weaviate">
