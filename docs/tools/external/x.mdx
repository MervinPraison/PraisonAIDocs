...
<Card title="Slack Integration" icon="slack" href="/tools/external/slack">
  Send messages to Slack channels
</Card>
<Card title="Telegram Bot" icon="telegram" href="/tools/external/telegram">  
  Send messages via Telegram bots
</Card>
<Card title="Custom Tools" icon="puzzle-piece" href="/tools/custom">
