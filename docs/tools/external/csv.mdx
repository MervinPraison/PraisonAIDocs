...
<CardGroup cols={2}>
  <Card title="JSON" icon="book" href="/tools/external/json">
    JSON files
  </Card>
  <Card title="SQLite" icon="database" href="/tools/external/sqlite">
    Query structured data
  </Card>
  <Card title="File" icon="book" href="/tools/external/file">
    General files
  </Card>
</CardGroup>
