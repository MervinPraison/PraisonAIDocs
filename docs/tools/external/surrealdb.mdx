...
<CardGroup cols={2}>
  <Card title="PostgreSQL" icon="book" href="/tools/external/postgres">
    Relational database
  </Card>
  <Card title="MongoDB" icon="book" href="/tools/external/mongodb">
    Document database
  </Card>
  <Card title="Redis" icon="book" href="/tools/external/redis">
    Key-value store
  </Card>
  <Card title="MySQL" icon="book" href="/tools/external/mysql">
    Relational database
  </Card>
  <Card title="SQLite" icon="book" href="/tools/external/sqlite">
    Embedded database
  </Card>
</CardGroup>
