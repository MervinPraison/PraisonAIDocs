...
<AccordionGroup>
<Accordion title="Prefer Optional types over bare parameters">
...
<CardGroup cols={2}>
<Card title="Tool Schema Validation" icon="check-circle" href="/features/tool-schema-validation">
Validate tool schemas and catch type errors
</Card>

<Card title="Custom Tools Guide" icon="wrench" href="/guides/tools/create-custom-tools">
...
<Card title="Different Ways to Create Tools" icon="code" href="/guides/tools/different-ways-to-create-tools">
