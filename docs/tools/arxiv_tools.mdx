...
<Steps>
  ...
  <Step title="Import Components">
    ...
    from praisonaiagents import search_arxiv, get_arxiv_paper, get_papers_by_author, get_papers_by_category
    ```
  </Step>
...
```python
from praisonaiagents import search_arxiv
from praisonaiagents import get_arxiv_paper
from praisonaiagents import get_papers_by_author
from praisonaiagents import get_papers_by_category
```
