...
sidebarTitle: "Unified Web Search"
...
<Note>
See also [Hosted Tools](/docs/features/hosted-tools) for the provider-hosted equivalent, `WebSearchTool`, which runs on the provider instead of locally.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Crawl4AI URL Safety" icon="shield-halved" href="/tools/crawl4ai#url-safety">
    How fetched URLs are validated against SSRF-unsafe targets
  </Card>
</CardGroup>
