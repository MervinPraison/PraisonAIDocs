...
sidebarTitle: "Chain-of-Thought Tools"
...
sequenceDiagram
    participant User
    participant Agent
    participant Feature as Chain-of-Thought Tools
...
<Step title="Enable chain-of-thought reasoning">
```python
from praisonaiagents import Agent
...
For more examples and integration patterns, see the [Generate Reasoning documentation](/features/generate-reasoning).
