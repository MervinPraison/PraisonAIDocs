...
sidebarTitle: "Gemini Internal Tools"
...
<CardGroup cols={2}>
  <Card title="Google Gemini Models" icon="google" href="/models/google">
    Learn about Gemini model configuration
  </Card>
  <Card title="External Search Tools" icon="magnifying-glass" href="/tools/external/google-search">
