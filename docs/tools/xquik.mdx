...
<CardGroup cols={2}>
<Card title="Tavily Search" icon="magnifying-glass" href="/tools/tavily">
Web search with AI-optimised results
</Card>
<Card title="Exa Search" icon="search" href="/tools/exa">
Neural search for the web
</Card>
<Card title="Tool Availability" icon="toggle-on" href="/features/tool-availability">
