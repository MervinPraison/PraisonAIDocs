...
See [praisonai upgrade](/features/praisonai-upgrade) and [praisonai uninstall](/features/praisonai-uninstall).
...
<Note>
Not sure which manager to pick? The installer chooses automatically. Read more in [Isolation Backends](/install/isolation-backends).
</Note>
...
See the [praisonai uninstall](/features/praisonai-uninstall) page for details and JSON output.
