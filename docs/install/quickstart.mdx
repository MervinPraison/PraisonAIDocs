...
`praisonai-code` gives you the agent runtime and full CLI (`run`, `chat`, `code`, …) without gateway or messaging-bot integrations. `praisonaiagents` is the pure Python SDK with no CLI at all — import it directly in your own application. See [Installation](/installation) for a full comparison.
...
<CardGroup cols={2}>
  ...
  <Card title="Upgrade & Uninstall" icon="arrow-up" href="/features/praisonai-upgrade">
