...
| `framework` | str | `"praisonai"` | Framework: `praisonai`, `crewai`, `autogen`, `langgraph` (or any name registered via the entry-point group; precedence: CLI flag → YAML `framework:` → default) |
