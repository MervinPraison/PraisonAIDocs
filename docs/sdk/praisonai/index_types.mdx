...
title: "Index Module"
sidebarTitle: "Index"
description: "Indexing strategies for document retrieval"
icon: "list-ol"
---

# Index Module

The Index module provides configurable indexing strategies for efficient document retrieval.

## Import

```python
from praisonai.knowledge import Index, get_index
```

## Quick Example

```python
from praisonai.knowledge import get_index
...
- Hybrid index combining vector and keyword search
- Graph index for entity relationships (placeholder)
