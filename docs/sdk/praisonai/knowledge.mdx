...
from praisonai.adapters import (
    ...
    FusionRetriever,
    LLMReranker,
    register_default_adapters,   # optional: wire retrievers / rerankers too
)
# register_default_adapters()  # uncomment if using retrievers/rerankers by name from the registry
```
