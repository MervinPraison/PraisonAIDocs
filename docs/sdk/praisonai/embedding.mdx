...
- [Embeddings Capability](/capabilities/embeddings) - Full embeddings documentation
- [Embeddings CLI](/capabilities/embeddings-cli) - CLI commands
- [Vector Store Module](/sdk/praisonai/vector_store) - Store and query embeddings
- [Knowledge Module](/sdk/praisonai/knowledge) - RAG with embeddings
- [Memory Module](/sdk/praisonaiagents/memory/memory) - Agent memory with embeddings
