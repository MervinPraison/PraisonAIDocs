...
- `instructions:  # Canonical: use 'instructions' instead of 'backstory' str` - Background story of the agent
...
- `context: bool | ManagerConfig | ContextManager = False` - Context management (True for defaults, ManagerConfig for custom)
