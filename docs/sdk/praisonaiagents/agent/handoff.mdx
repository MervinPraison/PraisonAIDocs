...
description: "API reference for the agent handoff system"
icon: "code"
---
...
<ParamField path="agent" type="Union[str, Agent]" required>
  Target agent name or Agent instance
</ParamField>

<ParamField path="template" type="str" default="DEFAULT_TEMPLATE">
  Template for handoff instructions
</ParamField>

<ParamField path="description" type="str" default="DEFAULT_DESCRIPTION">
  Description of the handoff tool
</ParamField>

<ParamField path="input_model" type="Optional[Type[BaseModel]]">
  Pydantic model for structured input
</ParamField>

<ParamField path="callback" type="Optional[Callable]">
...
<ParamField path="agent" type="Optional[Union[str, Agent]]">
  Target agent for handoff
</ParamField>

<ParamField path="name" type="str" default="handoff">
...
```python
from praisonaiagents import Agent, Task, Agents, handoff
