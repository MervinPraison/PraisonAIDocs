...
See [AG-UI server](/deploy/servers/agui).
...
Sync `message/send` can emit A2UI `DataPart` artifacts when the agent used `send_a2ui_messages`. See [A2A Protocol](/features/a2a).
...
For rendering and parsing, see [Integrate A2UI with Your Frontend](/features/integrate-a2ui-frontend).

## Related

- [UI module reference](/sdk/reference/praisonaiagents/modules/ui)
- [A2UI Protocol](/features/a2ui)
- [Generative UI](/features/generative-ui)
- [Agent](/sdk/praisonaiagents/agent/agent)
