...
|-----------|------|---------|-------------|
| `backend` | `MemoryBackend` | `FILE` | Storage backend (FILE, SQLITE, CHROMA, MEM0, MONGODB, DAKERA, IN_MEMORY) |
...
- [Memory Configuration](/configuration/memory-config)
- [praisonaiagents SDK](/sdk/praisonaiagents/index)
