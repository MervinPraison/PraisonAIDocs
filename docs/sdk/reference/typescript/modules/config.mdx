...
<CardGroup cols={2}>
  ...
  <Card title="RulesConfigOptions" icon="brackets-curly" href="../classes/RulesConfigOptions">
  ...
  <Card title="PreCompactionMemoryFlushConfigOptions" icon="brackets-curly" href="../classes/PreCompactionMemoryFlushConfigOptions">
    TypeScript PreCompactionMemoryFlushConfigOptions class
  </Card>
  ...
  <Card title="ToolSearchConfigOptions" icon="brackets-curly" href="../classes/ToolSearchConfigOptions">
    TypeScript ToolSearchConfigOptions class
  </Card>
  <Card title="ToolSearchConfig" icon="brackets-curly" href="../classes/ToolSearchConfig">
