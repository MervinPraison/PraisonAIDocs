...
<CardGroup cols={2}>
  <Card title="JS Hooks Manager" icon="anchor" href="/js/hooks-manager" />
  <Card title="JS Memory Hooks" icon="database" href="/js/memory-hooks" />
  <Card title="JS Workflow Hooks" icon="diagram-project" href="/js/workflow-hooks" />
