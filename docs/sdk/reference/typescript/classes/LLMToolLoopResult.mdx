---
title: "LLM Tool Loop Result • TypeScript AI Agent SDK"
sidebarTitle: "LLM Tool Loop Result"
description: "LLMToolLoopResult: TypeScript LLMToolLoopResult class"
icon: "brackets-curly"
---
...
graph LR
    agent["Agent"] -- "uses" --> tool["Tool: LLMToolLoopResult"]
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-ts/src/llm/index.ts#L365">
  `src/llm/index.ts` at line 365
</Card>
