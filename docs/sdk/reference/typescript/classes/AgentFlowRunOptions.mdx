---
title: "Agent Flow Run Options • TypeScript AI Agent SDK"
sidebarTitle: "Agent Flow Run Options"
description: "AgentFlowRunOptions: TypeScript AgentFlowRunOptions class"
icon: "brackets-curly"
---
...
TypeScript AgentFlowRunOptions class

```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#8B0000', 'primaryTextColor': '#fff', 'primaryBorderColor': '#710101', 'lineColor': '#189AB4', 'secondaryColor': '#189AB4', 'tertiaryColor': '#fff' }}}%%

graph LR
    input["Input Data"] --> agent["Agent: AgentFlowRunOptions"]
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-ts/src/workflows/index.ts#L390">
  `src/workflows/index.ts` at line 390
</Card>
