...
<Accordion title="analyze_complexity(topic: str) -> str">
...
<AccordionGroup>
<Accordion title="recommend_pattern(topic: str) -> str">
...
<Accordion title="generate(merge: Any) -> Any">
...
<Accordion title="convert_and_save(json_data: Any, merge: Any) -> Any">
...
<Accordion title="merge_with_existing_agents(new_json_data: Any) -> Any">
...
<Accordion title="recommend_pattern_llm(topic: str) -> PatternRecommendation">
...
<Accordion title="generate(pattern: str, merge: bool) -> str">
...
<Accordion title="merge_with_existing_workflow(new_data: Dict) -> Dict">
