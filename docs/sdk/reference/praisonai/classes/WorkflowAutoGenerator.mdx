...
<CardGroup cols={2}>
  ...
  <Card title="agenerate()" icon="function" href="../functions/WorkflowAutoGenerator-agenerate">
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai/praisonai/auto.py#L1415">
  `praisonai/auto.py` at line 1415
</Card>
