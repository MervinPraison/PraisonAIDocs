...
<AccordionGroup>
<Accordion title="set_deployer(deployer: DeployerInterface) -> Any">
  Set custom deployer implementation.
</Accordion>
<Accordion title="start(schedule_expr: str, max_retries: int) -> bool">
...
<Accordion title="deploy_once() -> bool">
