---
title: "profiler • AI Agents Framework"
...
<CardGroup cols={2}>
  ...
  <Card title="ProfilerCompat" icon="brackets-curly" href="../classes/ProfilerCompat">
...
<CardGroup cols={2}>
  <Card title="get_profiler()" icon="function" href="../functions/get_profiler">
    Get the current profiler (context-aware or default).
  </Card>
  <Card title="set_profiler()" icon="function" href="../functions/set_profiler">
