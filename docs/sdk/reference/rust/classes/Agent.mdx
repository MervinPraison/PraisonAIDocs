...
sidebarTitle: "Agent"
description: "Agent: The core Agent struct Agents are the primary execution unit in PraisonAI. They combine: - LLM provider for generating responses - Tools for..."
icon: "brackets-curly"
---
