...
```rust
fn query(&self, _question: &str) -> Result<RAGResult>
```
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-rust/praisonai/src/rag/mod.rs#L475">
  `praisonai/src/rag/mod.rs` at line 475
</Card>
