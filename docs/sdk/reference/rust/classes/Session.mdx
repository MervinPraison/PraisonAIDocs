...
description: "Session: Session manager - main API for session persistence"
icon: "brackets-curly"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/ARC-Solutions/praisonai-rust/blob/main/praisonai/src/session/mod.rs#L440">
