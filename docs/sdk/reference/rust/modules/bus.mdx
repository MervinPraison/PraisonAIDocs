...
sidebarTitle: "bus"
description: "Event Bus Module for PraisonAI Agents.  Provides a publish-subscribe event system for agent communication.  # Features  - Type-safe event publishing..."
icon: "file-code"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Event Bus" icon="brackets-curly" href="../classes/EventBus">
