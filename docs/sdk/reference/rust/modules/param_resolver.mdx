...
description: "Parameter Resolver  Unified parameter resolution following precedence rules: Instance > Config > Dict > Array > String > Bool > Default"
icon: "file-code"
---
...
<CardGroup cols={2}>
  <Card title="Resolve Options" icon="brackets-curly" href="../classes/ResolveOptions">
    Options for parameter resolution
  </Card>
  <Card title="Array Mode" icon="brackets-curly" href="../classes/ArrayMode">
    Array parsing modes for parameter resolution
  </Card>
  <Card title="Resolved Value" icon="brackets-curly" href="../classes/ResolvedValue">
    Result of parameter resolution
  </Card>
  <Card title="String Mode" icon="brackets-curly" href="../classes/StringMode">
