...
description: "Display and callback system for PraisonAI  This module provides display functions and callback registration matching the Python SDK's main.py display..."
icon: "file-code"
---
...
<CardGroup cols={2}>
  <Card title="Color Palette" icon="brackets-curly" href="../classes/ColorPalette">
  ...
  <Card title="Display Type" icon="brackets-curly" href="../classes/DisplayType">
