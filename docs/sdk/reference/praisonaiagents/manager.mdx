...
<AccordionGroup>
<Accordion title="check_and_add(content_hash: str, agent_name: str, tokens: int) -> bool">
...
<Accordion title="merge() -> ManagerConfig">
...
<AccordionGroup>
<Accordion title="process(messages: List) -> Dict">
...
<Accordion title="capture_llm_boundary(messages: List) -> SnapshotHookData">
...
<Accordion title="register_snapshot_callback(callback: Callable) -> None">
  Register a callback for LLM boundary snapshots.
</Accordion>
<Accordion title="get_last_snapshot_hook() -> Optional">
  Get the last LLM boundary snapshot.
</Accordion>
<Accordion title="estimate_tokens(text: str, validate: bool) -> Tuple">
...
<Accordion title="get_tool_budget(tool_name: str) -> int">
  Get token budget for a specific tool.
</Accordion>
<Accordion title="set_tool_budget(tool_name: str, max_tokens: int, protected: bool) -> None">
  Set token budget for a specific tool.
</Accordion>
<Accordion title="truncate_tool_output(tool_name: str, output: str) -> str">
  Truncate tool output according to its budget.
</Accordion>
<Accordion title="get_history() -> List">
  Get optimization history.
</Accordion>
<Accordion title="get_stats() -> Dict">
  Get current context statistics.
</Accordion>
<Accordion title="emergency_truncate(messages: List) -> List">
...
<Accordion title="get_resolved_config() -> Dict">
  Get the fully resolved configuration with source info.
</Accordion>
<Accordion title="reset() -> None">
  Reset manager state.
</Accordion>
</AccordionGroup>
...
<AccordionGroup>
<Accordion title="get_agent_manager(agent_id: str, model: str) -> ContextManager">
  Get or create context manager for an agent.
</Accordion>
<Accordion title="get_session_cache() -> SessionDeduplicationCache">
  Get the session deduplication cache.
</Accordion>
<Accordion title="set_agent_policy(agent_id: str, policy: ContextPolicy) -> None">
  Set context policy for an agent.
</Accordion>
<Accordion title="get_agent_policy(agent_id: str) -> ContextPolicy">
  Get context policy for an agent.
</Accordion>
<Accordion title="prepare_handoff(from_agent: str, to_agent: str, messages: List) -> List">
...
<Accordion title="get_combined_stats() -> Dict">
