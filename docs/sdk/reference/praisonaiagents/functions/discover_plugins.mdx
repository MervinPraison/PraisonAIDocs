...
- [`ToolRegistry.get_tool_definition`](../functions/ToolRegistry-get_tool_definition)


## Source

<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/tools/registry.py#L695">
  `praisonaiagents/tools/registry.py` at line 695
</Card>
