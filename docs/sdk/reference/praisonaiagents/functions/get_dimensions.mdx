...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/embedding/dimensions.py#L63">
  `praisonaiagents/embedding/dimensions.py` at line 63
</Card>
