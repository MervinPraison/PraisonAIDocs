...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/rag/retrieval_config.py#L348">
  `praisonaiagents/rag/retrieval_config.py` at line 348
</Card>
