...
```python
async def execute(event: HookEvent, input_data: HookInput, target: Optional[str], _hooks: Optional[List['HookDefinition']]) -> List[HookExecutionResult]
```
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/hooks/runner.py#L81">
