...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/config/param_resolver.py#L495">
  `praisonaiagents/config/param_resolver.py` at line 495
</Card>
