---
title: "Get Last Snapshot Hook • AI Agent SDK"
sidebarTitle: "Get Last Snapshot Hook"
description: "get_last_snapshot_hook: Get the last LLM boundary snapshot."
icon: "function"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/context/manager.py#L643">
  `praisonaiagents/context/manager.py` at line 643
</Card>
