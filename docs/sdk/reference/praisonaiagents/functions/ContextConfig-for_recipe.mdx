...
<CardGroup cols={2}>
  <Card title="Recipes Concept" icon="book-open" href="/concepts/recipes" />
  <Card title="Recipes Guide" icon="utensils" href="/guides/recipes/index" />
  <Card title="Modular Recipes" icon="puzzle-piece" href="/features/modular-recipes" />
</CardGroup>
