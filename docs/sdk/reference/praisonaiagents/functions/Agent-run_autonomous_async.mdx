...
<ParamField query="max_iterations" type="Optional[int]" required={false}>
...
<ParamField query="completion_promise" type="Optional[str]" required={false}>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/agent.py#L4247">
  `praisonaiagents/agent/agent.py` at line 4247
</Card>
