...
<ParamField query="working_dir" type="Optional[str]" required={false}>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/sandbox/protocols.py#L234">
  `praisonaiagents/sandbox/protocols.py` at line 234
</Card>
