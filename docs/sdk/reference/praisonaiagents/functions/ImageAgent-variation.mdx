...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/image_agent.py#L308">
  `praisonaiagents/agent/image_agent.py` at line 308
</Card>
