---
title: "Compute Quality Score • AI Agent SDK"
sidebarTitle: "Compute Quality Score"
description: "compute_quality_score: Combine multiple sub-metrics into one final score, as an example."
icon: "function"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/memory/memory.py#L633">
  `praisonaiagents/memory/memory.py` at line 633
</Card>
