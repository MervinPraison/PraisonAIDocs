...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/mcp/mcp.py#L967">
  `praisonaiagents/mcp/mcp.py` at line 967
</Card>
