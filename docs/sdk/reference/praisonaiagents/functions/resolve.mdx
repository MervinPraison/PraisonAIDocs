...
<ParamField query="config_class" type="Optional[Type]" required={false}>
...
<ParamField query="array_mode" type="Optional[str]" required={false}>
  How to handle array values (see ArrayMode)
</ParamField>

<ParamField query="string_mode" type="Optional[str]" required={false}>
