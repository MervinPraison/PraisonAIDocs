...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/skills/parser.py#L92">
  `praisonaiagents/skills/parser.py` at line 92
</Card>
