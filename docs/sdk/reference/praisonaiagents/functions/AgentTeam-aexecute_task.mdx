...
description: "aexecute_task: Async version of execute_task method - now using DRY helpers"
icon: "function"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agents/agents.py#L1184">
  `praisonaiagents/agents/agents.py` at line 1184
</Card>
