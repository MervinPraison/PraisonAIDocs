---
title: "From Template • AI Agent SDK"
sidebarTitle: "From Template"
description: "from_template: Create an Agent from a template."
icon: "function"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/agent.py#L414">
  `praisonaiagents/agent/agent.py` at line 414
</Card>
