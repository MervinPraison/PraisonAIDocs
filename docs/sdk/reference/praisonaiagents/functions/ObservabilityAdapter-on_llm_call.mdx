...
<ParamField query="response" type="Optional[str]" required={false}>
  No description available.
</ParamField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/obs/__init__.py#L99">
  `praisonaiagents/obs/__init__.py` at line 99
</Card>
