...
<ParamField query="output_json" type="Optional[str]" required={false}>
  No description available.
</ParamField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/image_agent.py#L207">
  `praisonaiagents/agent/image_agent.py` at line 207
</Card>
