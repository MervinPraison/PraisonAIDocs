---
title: "Is Webhook Mode • AI Agent SDK"
sidebarTitle: "Is Webhook Mode"
description: "is_webhook_mode: Whether bot is configured for webhook mode."
icon: "function"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/bots/config.py#L183">
  `praisonaiagents/bots/config.py` at line 183
</Card>
