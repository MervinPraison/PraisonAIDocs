...
<ParamField query="variables" type="Dict[str, Any]" required={true}>
  Dictionary containing variables for substitution.
</ParamField>

<ParamField query="previous_output" type="Optional[str]" required={false}>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/conditions/evaluator.py#L128">
  `praisonaiagents/conditions/evaluator.py` at line 128
</Card>
