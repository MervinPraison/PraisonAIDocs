...
<ParamField query="latency_ms" type="Optional[float]" required={false}>
  No description available.
</ParamField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/obs/__init__.py#L111">
  `praisonaiagents/obs/__init__.py` at line 111
</Card>
