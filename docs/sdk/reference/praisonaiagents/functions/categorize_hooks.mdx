...
<ParamField query="hooks" type="List[Callable]" required={true}>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/hooks/middleware.py#L305">
  `praisonaiagents/hooks/middleware.py` at line 305
</Card>
