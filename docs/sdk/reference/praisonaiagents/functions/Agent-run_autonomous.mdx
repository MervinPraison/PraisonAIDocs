---
title: "Run Autonomous • AI Agent SDK"
sidebarTitle: "Run Autonomous"
description: "run_autonomous: Run an autonomous task execution loop."
icon: "function"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/agent.py#L3843">
  `praisonaiagents/agent/agent.py` at line 3843
</Card>
