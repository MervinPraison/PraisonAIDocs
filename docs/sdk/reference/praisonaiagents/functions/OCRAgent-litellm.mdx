...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/ocr_agent.py#L127">
  `praisonaiagents/agent/ocr_agent.py` at line 127
</Card>
