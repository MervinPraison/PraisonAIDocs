...
<ParamField query="steps" type="List[str]" required={true}>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/main.py#L531">
