...
description: "restore_session_state: Restore team session state for deterministic resume. Returns True if restored."
icon: "function"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agents/agents.py#L2315">
  `praisonaiagents/agents/agents.py` at line 2315
</Card>
