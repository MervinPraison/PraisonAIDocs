...
description: "store_short_term: Store in ChromaDB (short-term and long-term treated the same)."
icon: "function"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/memory/adapters/factories.py#L287">
  `praisonaiagents/memory/adapters/factories.py` at line 287
</Card>
