---
title: "Default Tool Description • AI Agent SDK"
sidebarTitle: "Default Tool Description"
description: "default_tool_description: Generate default tool description based on agent role and goal."
icon: "function"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/handoff.py#L404">
  `praisonaiagents/agent/handoff.py` at line 404
</Card>
