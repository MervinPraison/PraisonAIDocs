---
title: "Register Function • AI Agent SDK"
sidebarTitle: "Register Function"
description: "register_function: Register a Python function as a hook."
icon: "function"
---
...
<ParamField query="matcher" type="Optional[str]" required={false}>
...
- [`enable_pii_redaction`](../functions/enable_pii_redaction)


## Source

<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/hooks/registry.py#L87">
  `praisonaiagents/hooks/registry.py` at line 87
</Card>
