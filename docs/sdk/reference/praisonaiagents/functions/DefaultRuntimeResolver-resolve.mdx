...
description: "resolve: Resolve runtime based on model reference."
icon: "function"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/runtime/resolve.py#L107">
  `praisonaiagents/runtime/resolve.py` at line 107
</Card>
