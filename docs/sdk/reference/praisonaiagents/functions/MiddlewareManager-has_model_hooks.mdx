---
title: "Has Model Hooks • AI Agent SDK"
sidebarTitle: "Has Model Hooks"
description: "has_model_hooks: Check if any model hooks are registered."
icon: "function"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/hooks/middleware.py#L345">
  `praisonaiagents/hooks/middleware.py` at line 345
</Card>
