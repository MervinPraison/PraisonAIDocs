---
title: "retrieve • AI Agent SDK"
sidebarTitle: "retrieve"
description: "retrieve: Retrieve context from knowledge without LLM generation."
icon: "function"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/agent.py#L5592">
  `praisonaiagents/agent/agent.py` at line 5592
</Card>
