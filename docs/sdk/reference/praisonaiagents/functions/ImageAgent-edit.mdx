...
sidebarTitle: "edit"
description: "edit: Edit an existing image with a prompt."
icon: "function"
---
...
<ParamField query="mask" type="Optional[str]" required={false}>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/image_agent.py#L229">
  `praisonaiagents/agent/image_agent.py` at line 229
</Card>
