...
sidebarTitle: "on"
description: "on: Decorator to register a function as a hook."
icon: "function"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/hooks/registry.py#L168">
  `praisonaiagents/hooks/registry.py` at line 168
</Card>
