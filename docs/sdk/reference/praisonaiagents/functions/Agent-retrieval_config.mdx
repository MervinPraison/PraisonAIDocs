...
```python
def retrieval_config() -> Optional[Any]
```
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/agent.py#L6034">
  `praisonaiagents/agent/agent.py` at line 6034
</Card>
