---
title: "Execute File • AI Agent SDK"
...
<ParamField query="limits" type="Optional[ResourceLimits]" required={false}>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/sandbox/protocols.py#L256">
  `praisonaiagents/sandbox/protocols.py` at line 256
</Card>
