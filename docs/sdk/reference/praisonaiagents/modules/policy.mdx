...
| Name | Value |
|------|-------|
| `_LAZY_IMPORTS` | `{'PolicyEngine': (f'{__name__}.engine', 'PolicyEngine'), 'Policy': (f'{__name__}.policy', 'Policy'), 'PolicyRule': (f'{__name__}.policy', 'PolicyRule'), 'PolicyResult': (f'{__name__}.types', 'PolicyRe...` |
