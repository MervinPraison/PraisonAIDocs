...
| Name | Value |
|------|-------|
| `_LAZY_GROUPS` | `{'models': {'SkillProperties': ('praisonaiagents.skills.models', 'SkillProperties'), 'SkillMetadata': ('praisonaiagents.skills.models', 'SkillMetadata'), 'SkillRequirements': ('praisonaiagents.skills....` |
