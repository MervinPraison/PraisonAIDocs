...
<CardGroup cols={2}>
  ...
  <Card title="KanbanHookInput" icon="brackets-curly" href="../classes/KanbanHookInput">
...
| Name | Value |
|------|-------|
| `_LEGACY_EVENT_VALUES` | `{'before_message': 'message_received', 'after_message': 'message_sending', 'tool_result_persist': 'after_tool'}` |
