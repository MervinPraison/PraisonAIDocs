---
title: "Parse Utils • AI Agent SDK"
...
<CardGroup cols={2}>
  ...
  <Card title="canonical_preset_key()" icon="function" href="../functions/canonical_preset_key">
    The single spelling rule for preset names. Validation and resolution must
  </Card>
  <Card title="validate_preset_string()" icon="function" href="../functions/validate_preset_string">
