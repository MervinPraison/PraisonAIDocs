...
**[Dedicated Page: ToolPermission](../classes/ToolPermission)**
...
**[Dedicated Page: PermissionAllowlist](../classes/PermissionAllowlist)**
...
**[Dedicated Page: ApprovalDecision](../classes/ApprovalDecision)**
...
**[Dedicated Page: get_permission_allowlist()](../functions/get_permission_allowlist)**
...
**[Dedicated Page: set_permission_allowlist()](../functions/set_permission_allowlist)**
...
**[Dedicated Page: set_approval_callback()](../functions/set_approval_callback)**
...
**[Dedicated Page: get_approval_callback()](../functions/get_approval_callback)**
...
**[Dedicated Page: mark_approved()](../functions/mark_approved)**
...
**[Dedicated Page: is_already_approved()](../functions/is_already_approved)**
...
**[Dedicated Page: clear_approval_context()](../functions/clear_approval_context)**
...
**[Dedicated Page: require_approval()](../functions/require_approval)**
...
**[Dedicated Page: console_approval_callback()](../functions/console_approval_callback)**
...
**[Dedicated Page: request_approval()](../functions/request_approval)**
...
**[Dedicated Page: configure_default_approvals()](../functions/configure_default_approvals)**
...
**[Dedicated Page: add_approval_requirement()](../functions/add_approval_requirement)**
...
**[Dedicated Page: remove_approval_requirement()](../functions/remove_approval_requirement)**
...
**[Dedicated Page: is_approval_required()](../functions/is_approval_required)**
...
**[Dedicated Page: get_risk_level()](../functions/get_risk_level)**
