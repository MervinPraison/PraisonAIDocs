...
| Name | Value |
|------|-------|
| `_LAZY_GROUPS` | `{'protocol': {'ActionEvent': ('praisonaiagents.trace.protocol', 'ActionEvent'), 'ActionEventType': ('praisonaiagents.trace.protocol', 'ActionEventType'), 'ActionTraceConfig': ('praisonaiagents.trace.p...` |
