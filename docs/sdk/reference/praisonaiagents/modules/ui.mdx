...
Parsing and rendering belong in your UI layer — see [Integrate A2UI with Your Frontend](/features/integrate-a2ui-frontend).

## Related

- [A2UI Protocol](/features/a2ui)
- [A2A Protocol](/features/a2a)
- [AG-UI server](/deploy/servers/agui)
