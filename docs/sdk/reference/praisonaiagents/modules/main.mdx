...
| `SUPPORTED_CALLBACK_TYPES` | `['tool_call', 'interaction', 'error', 'llm_start', 'llm_end', 'llm_content', 'autonomy_iteration', 'autonomy_stage_change', 'autonomy_doom_loop', 'autonomy_complete', 'retry']` |
