...
<Accordion title="knowledge() -> Knowledge">
  Lazy-loaded knowledge instance
</Accordion>
<Accordion title="Agent(name: str, role: str, instructions: Optional) -> Agent">
...
<Accordion title="create_agent() -> Agent">
  Backward compatibility wrapper for Agent method
</Accordion>
<Accordion title="save_state(state_data: Dict) -> None">
...
<Accordion title="restore_state() -> Dict">
...
<Accordion title="increment_state(key: str, increment: int, default: int) -> None">
  Increment a numeric state value
</Accordion>
<Accordion title="add_memory(text: str, memory_type: str) -> None">
...
<Accordion title="search_memory(query: str, memory_type: str, limit: int) -> List">
...
<Accordion title="add_knowledge(source: str) -> None">
  Add knowledge source to session.

Args:
    source: File path, URL, or text content
</Accordion>
<Accordion title="search_knowledge(query: str, limit: int) -> List">
...
<Accordion title="clear_memory(memory_type: str) -> None">
  Clear session memory.

Args:
    memory_type: "short", "long", or "all"
</Accordion>
<Accordion title="get_context(query: str, max_items: int) -> str">
...
<Accordion title="send_message(message: str) -> str">
