...
<ParamField query="rag" type="Optional[RAG]" required={false}>
  No description available.
</ParamField>

<ParamField query="config" type="Optional[AutoRagConfig]" required={false}>
  No description available.
</ParamField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agents/auto_rag_agent.py#L102">
  `praisonaiagents/agents/auto_rag_agent.py` at line 102
</Card>
