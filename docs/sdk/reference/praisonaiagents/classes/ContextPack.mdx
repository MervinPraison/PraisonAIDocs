---
title: "ContextPack"
description: "Context pack for orchestrator pattern - retrieval without generation."
icon: "brackets-curly"
---
...
<CardGroup cols={2}>
  <Card title="from_dict()" icon="function" href="../functions/ContextPack-from_dict">
    Create from dictionary.
  </Card>
  <Card title="to_dict()" icon="function" href="../functions/ContextPack-to_dict">
