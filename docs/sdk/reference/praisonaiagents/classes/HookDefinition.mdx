---
title: "Hook Definition • AI Agent SDK"
...
<ResponseField name="matcher" type="Optional[str]">
  No description available.
</ResponseField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/hooks/types.py#L294">
  `praisonaiagents/hooks/types.py` at line 294
</Card>
