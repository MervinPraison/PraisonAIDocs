---
title: "Audio Agent • AI Agent SDK"
sidebarTitle: "Audio Agent"
description: "AudioAgent: A specialized agent for audio processing using AI models."
icon: "brackets-curly"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/audio_agent.py#L66">
  `praisonaiagents/agent/audio_agent.py` at line 66
</Card>
