---
title: "Context Agent • AI Agent SDK"
sidebarTitle: "Context Agent"
description: "ContextAgent: Advanced Context Engineering Agent - Comprehensive context generation for AI coding assistants."
icon: "brackets-curly"
---
...
<ParamField query="project_path" type="Optional[str]" required={false}>
  No description available.
</ParamField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/context_agent.py#L89">
  `praisonaiagents/agent/context_agent.py` at line 89
</Card>
