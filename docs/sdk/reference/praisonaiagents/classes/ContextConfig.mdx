...
<ResponseField name="protected_tools" type="List[str]">
  No description available.
</ResponseField>

<ResponseField name="tool_limits" type="Dict[str, int]">
  No description available.
</ResponseField>
...
<ResponseField name="conversation_compaction" type="bool">
  No description available.
</ResponseField>

<ResponseField name="conversation_analyzer_strategy" type="str">
  No description available.
</ResponseField>

<ResponseField name="conversation_min_compaction_ratio" type="float">
  No description available.
</ResponseField>
...
<ResponseField name="aggregate_sources" type="List[str]">
  No description available.
</ResponseField>
...
<ResponseField name="tool_budgets" type="Dict[str, Any]">
  No description available.
</ResponseField>

<ResponseField name="tool_summarize_limits" type="Dict[str, int]">
  No description available.
</ResponseField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/context/models.py#L247">
  `praisonaiagents/context/models.py` at line 247
</Card>
