---
title: "HandoffConfig"
description: "Unified configuration for handoff behavior."
icon: "brackets-curly"
---
...
<CardGroup cols={2}>
  <Card title="from_dict()" icon="function" href="../functions/HandoffConfig-from_dict">
    Create config from dictionary.
  </Card>
  <Card title="to_dict()" icon="function" href="../functions/HandoffConfig-to_dict">
