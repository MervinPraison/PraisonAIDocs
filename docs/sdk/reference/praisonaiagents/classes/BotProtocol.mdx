...
<CardGroup cols={2}>
  ...
  <Card title="capabilities()" icon="function" href="../functions/BotProtocol-capabilities">
    Channel capabilities for feature discovery.
  </Card>
  <Card title="platform_capabilities()" icon="function" href="../functions/BotProtocol-platform_capabilities">
  ...
  <Card title="add_reaction()" icon="function" href="../functions/BotProtocol-add_reaction">
    Add a reaction emoji to a message.
  </Card>
  <Card title="remove_reaction()" icon="function" href="../functions/BotProtocol-remove_reaction">
  ...
  <Card title="probe()" icon="function" href="../functions/BotProtocol-probe">
    Test channel connectivity without starting the bot.
  </Card>
  <Card title="health()" icon="function" href="../functions/BotProtocol-health">
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/bots/protocols.py#L836">
  `praisonaiagents/bots/protocols.py` at line 836
</Card>
