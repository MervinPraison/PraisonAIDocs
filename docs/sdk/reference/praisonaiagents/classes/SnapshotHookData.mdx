...
<ResponseField name="ledger" type="Optional[ContextLedger]">
  No description available.
</ResponseField>

<ResponseField name="budget" type="Optional[BudgetAllocation]">
  No description available.
</ResponseField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/context/manager.py#L204">
  `praisonaiagents/context/manager.py` at line 204
</Card>
