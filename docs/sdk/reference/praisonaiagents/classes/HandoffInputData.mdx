...
<ResponseField name="handoff_chain" type="List[str]">
  No description available.
</ResponseField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/handoff.py#L215">
  `praisonaiagents/agent/handoff.py` at line 215
</Card>
