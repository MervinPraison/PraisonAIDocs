...
<CardGroup cols={2}>
  ...
  <Card title="canonicalize()" icon="function" href="../functions/BasePlatformAdapter-canonicalize">
  ...
  <Card title="supports_delete()" icon="function" href="../functions/BasePlatformAdapter-supports_delete">
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/bots/base.py#L464">
  `praisonaiagents/bots/base.py` at line 464
</Card>
