...
<ParamField query="learn" type="Optional" required={false}>
  No description available.
</ParamField>

<ParamField query="tools_run_on" type="Optional" required={false}>
  No description available.
</ParamField>

<ParamField query="run_on" type="Optional" required={false}>
  No description available.
</ParamField>
...
<CardGroup cols={2}>
  <Card title="stream_emitter()" icon="function" href="../functions/AgentTeam-stream_emitter">
  ...
  <Card title="where_does_it_run()" icon="function" href="../functions/AgentTeam-where_does_it_run">
  ...
  <Card title="start_for_each()" icon="function" href="../functions/AgentTeam-start_for_each">
    Run this team once per input dict, interpolating ``key`` placeholders.
  </Card>
  <Card title="astart_for_each()" icon="function" href="../functions/AgentTeam-astart_for_each">
  ...
  <Card title="close()" icon="function" href="../functions/AgentTeam-close">
    Close all agent resources and cleanup connections.
  </Card>
  <Card title="spawn_sub_agent()" icon="function" href="../functions/AgentTeam-spawn_sub_agent">
    Spawn a sub-agent for non-blocking execution (sync version).
  </Card>
  <Card title="announce_completion()" icon="function" href="../functions/AgentTeam-announce_completion">
    Announce sub-agent completion via event bus (sync version).
  </Card>
  <Card title="get_spawned_agents()" icon="function" href="../functions/AgentTeam-get_spawned_agents">
    Get list of currently spawned sub-agents.
  </Card>
  <Card title="wait_for_completions()" icon="function" href="../functions/AgentTeam-wait_for_completions">
    Wait for sub-agent completions (optional blocking method).
  </Card>
  <Card title="aspawn_sub_agent()" icon="function" href="../functions/AgentTeam-aspawn_sub_agent">
    Async version of spawn_sub_agent using asyncio primitives.
  </Card>
  <Card title="aannounce_completion()" icon="function" href="../functions/AgentTeam-aannounce_completion">
    Async version of announce_completion.
  </Card>
  <Card title="await_for_completions()" icon="function" href="../functions/AgentTeam-await_for_completions">
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agents/agents.py#L814">
  `praisonaiagents/agents/agents.py` at line 814
</Card>
