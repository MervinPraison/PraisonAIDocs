...
description: "Unified configuration for Agent retrieval behavior."
icon: "brackets-curly"
---
...
<CardGroup cols={2}>
  <Card title="from_dict()" icon="function" href="../functions/RetrievalConfig-from_dict">
  ...
  <Card title="to_dict()" icon="function" href="../functions/RetrievalConfig-to_dict">
