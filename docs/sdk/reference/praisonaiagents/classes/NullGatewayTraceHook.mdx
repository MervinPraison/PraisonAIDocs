...
<CardGroup cols={2}>
  ...
  <Card title="inject_context()" icon="function" href="../functions/NullGatewayTraceHook-inject_context">
    No-op: leave ``carrier`` untouched when tracing is disabled.
  </Card>
  <Card title="extract_carrier()" icon="function" href="../functions/NullGatewayTraceHook-extract_carrier">
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/gateway/protocols.py#L5251">
  `praisonaiagents/gateway/protocols.py` at line 5251
</Card>
