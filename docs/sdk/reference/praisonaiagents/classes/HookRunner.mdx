---
title: "Hook Runner • AI Agent SDK"
sidebarTitle: "Hook Runner"
description: "HookRunner: Executes hooks from a registry."
icon: "brackets-curly"
---
...
<ParamField query="registry" type="Optional[HookRegistry]" required={false}>
...
<CardGroup cols={2}>
  ...
  <Card title="execute_async()" icon="function" href="../functions/HookRunner-execute_async">
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/hooks/runner.py#L29">
