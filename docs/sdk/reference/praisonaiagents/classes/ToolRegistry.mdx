...
<ParamField query="discovery_enabled" type="bool" required={false} default="True">
...
<CardGroup cols={2}>
  ...
  <Card title="get_tool_definition()" icon="function" href="../functions/ToolRegistry-get_tool_definition">
