---
title: "Output Config • AI Agent SDK"
...
<ResponseField name="editor_output" type="bool">
  No description available.
</ResponseField>

<ResponseField name="output_file" type="Optional[str]">
  No description available.
</ResponseField>

<ResponseField name="template" type="Optional[str]">
  No description available.
</ResponseField>

<ResponseField name="tool_output_limit" type="int">
  No description available.
</ResponseField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/config/feature_configs.py#L629">
  `praisonaiagents/config/feature_configs.py` at line 629
</Card>
