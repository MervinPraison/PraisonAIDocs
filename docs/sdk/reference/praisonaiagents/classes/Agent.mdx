...
<ParamField query="allow_code_execution" type="Optional[bool]" required={false} default="False">
  No description available.
</ParamField>
...
<ParamField query="auto_save" type="Optional[str]" required={false}>
  No description available.
</ParamField>
...
<ParamField query="rules" type="Optional" required={false}>
  No description available.
</ParamField>
...
<ParamField query="self_improve" type="Optional" required={false} default="False">
  No description available.
</ParamField>
...
<ParamField query="tool_config" type="Optional" required={false}>
  No description available.
</ParamField>
...
<ParamField query="backend" type="Optional" required={false}>
  No description available.
</ParamField>

<ParamField query="cli_backend" type="Optional" required={false}>
  No description available.
</ParamField>

<ParamField query="runtime" type="Optional" required={false}>
  No description available.
</ParamField>

<ParamField query="interrupt_controller" type="Optional[InterruptController]" required={false}>
  No description available.
</ParamField>

<ParamField query="tool_search" type="Optional" required={false} default="False">
  No description available.
</ParamField>

<ParamField query="message_steering" type="Optional" required={false} default="False">
  No description available.
</ParamField>

<ParamField query="sandbox" type="Optional" required={false}>
  No description available.
</ParamField>

<ParamField query="retry" type="Optional" required={false}>
  No description available.
</ParamField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/agent.py#L231">
  `praisonaiagents/agent/agent.py` at line 231
</Card>
