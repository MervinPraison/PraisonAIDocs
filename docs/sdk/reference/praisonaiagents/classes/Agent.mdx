...
<CardGroup cols={2}>
  ...
  <Card title="guardrail_retry_count()" icon="function" href="../functions/Agent-guardrail_retry_count">
    How many times output validation has sent the model back for a retry.
  </Card>
  <Card title="last_guardrail_error()" icon="function" href="../functions/Agent-last_guardrail_error">
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/agent.py#L250">
  `praisonaiagents/agent/agent.py` at line 250
</Card>
