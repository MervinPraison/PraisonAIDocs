...
sidebarTitle: "Memory"
description: "Memory: A single-file memory manager covering:"
icon: "brackets-curly"
---
...
<CardGroup cols={2}>
  <Card title="commit_memory_batch()" icon="function" href="../functions/Memory-commit_memory_batch">
    Persist a batch of staged memory writes.
  </Card>
  <Card title="acommit_memory_batch()" icon="function" href="../functions/Memory-acommit_memory_batch">
  ...
  <Card title="remember()" icon="function" href="../functions/Memory-remember">
    Store a fact in long-term memory; returns the memory id.
  </Card>
  <Card title="recall()" icon="function" href="../functions/Memory-recall">
    Retrieve matching facts from long-term memory.
  </Card>
  <Card title="forget()" icon="function" href="../functions/Memory-forget">
  ...
  <Card title="build_cache_optimized_context()" icon="function" href="../functions/Memory-build_cache_optimized_context">
    Build context with cache boundary markers for prompt prefix caching optimization.
  </Card>
  <Card title="get_context()" icon="function" href="../functions/Memory-get_context">
  ...
  <Card title="close_connections()" icon="function" href="../functions/Memory-close_connections">
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/memory/memory.py#L40">
  `praisonaiagents/memory/memory.py` at line 40
</Card>
