...
<ResponseField name="paths" type="List[str]">
  No description available.
</ResponseField>

<ResponseField name="dirs" type="List[str]">
  No description available.
</ResponseField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/config/feature_configs.py#L1327">
  `praisonaiagents/config/feature_configs.py` at line 1327
</Card>
