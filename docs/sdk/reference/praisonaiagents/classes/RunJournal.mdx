...
<CardGroup cols={2}>
  ...
  <Card title="delete_run()" icon="function" href="../functions/RunJournal-delete_run">
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/runtime/journal.py#L170">
  `praisonaiagents/runtime/journal.py` at line 170
</Card>
