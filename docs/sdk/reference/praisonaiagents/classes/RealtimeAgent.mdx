...
description: "RealtimeAgent: Agent for real-time voice conversations using OpenAI Realtime API."
icon: "brackets-curly"
---
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/realtime_agent.py#L36">
