...
<ResponseField name="automation" type="Optional[SkillAutomation]">
  No description available.
</ResponseField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/skills/models.py#L213">
  `praisonaiagents/skills/models.py` at line 213
</Card>
