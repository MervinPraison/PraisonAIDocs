...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/vision_agent.py#L47">
  `praisonaiagents/agent/vision_agent.py` at line 47
</Card>
