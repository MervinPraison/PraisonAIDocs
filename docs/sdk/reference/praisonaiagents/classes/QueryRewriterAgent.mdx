---
title: "Query Rewriter Agent • AI Agent SDK"
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/query_rewriter_agent.py#L88">
  `praisonaiagents/agent/query_rewriter_agent.py` at line 88
</Card>
