---
title: "Hooks Config • AI Agent SDK"
sidebarTitle: "Hooks Config"
description: "HooksConfig: Configuration for agent hooks/callbacks."
icon: "brackets-curly"
---
...
<ResponseField name="on_step" type="Optional[Callable]">
  No description available.
</ResponseField>

<ResponseField name="on_tool_call" type="Optional[Callable]">
  No description available.
</ResponseField>

<ResponseField name="middleware" type="List[Any]">
  No description available.
</ResponseField>
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/config/feature_configs.py#L1303">
  `praisonaiagents/config/feature_configs.py` at line 1303
</Card>
