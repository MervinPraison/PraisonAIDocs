---
title: "ContextLedger"
description: "Tracks token usage across context segments."
icon: "brackets-curly"
---
...
<CardGroup cols={2}>
  ...
  <Card title="to_dict()" icon="function" href="../functions/ContextLedger-to_dict">
  ...
  <Card title="copy()" icon="function" href="../functions/ContextLedger-copy">
