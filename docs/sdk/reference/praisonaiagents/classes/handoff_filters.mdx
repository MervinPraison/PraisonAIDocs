...
<CardGroup cols={2}>
  ...
  <Card title="compress_history()" icon="function" href="../functions/handoff_filters-compress_history">
...
<Card title="View on GitHub" icon="github" href="https://github.com/MervinPraison/PraisonAI/blob/main/src/praisonai-agents/praisonaiagents/agent/handoff.py#L1194">
  `praisonaiagents/agent/handoff.py` at line 1194
</Card>
