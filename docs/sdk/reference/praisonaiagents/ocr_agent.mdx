...
<Accordion title="extract(source: str, include_image_base64: Optional) -> Any">
...
<Accordion title="async aextract(source: str, include_image_base64: Optional) -> Any">
  Async version of extract().
</Accordion>
<Accordion title="read(source: str) -> str">
...
<Accordion title="async aread(source: str) -> str">
