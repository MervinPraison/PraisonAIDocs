...
<AccordionGroup>
<Accordion title="primary_query() -> str">
  Returns the primary rewritten query.
</Accordion>
<Accordion title="all_queries() -> List">
...
<AccordionGroup>
<Accordion title="agent() -> Any">
  Lazy initialization of internal Agent.
</Accordion>
<Accordion title="rewrite(query: str, strategy: RewriteStrategy, chat_history: Optional) -> RewriteResult">
...
<Accordion title="rewrite_basic(query: str) -> RewriteResult">
  Convenience method for basic rewriting.
</Accordion>
<Accordion title="rewrite_hyde(query: str) -> RewriteResult">
  Convenience method for HyDE rewriting.
</Accordion>
<Accordion title="rewrite_step_back(query: str) -> RewriteResult">
  Convenience method for step-back rewriting.
</Accordion>
<Accordion title="rewrite_sub_queries(query: str) -> RewriteResult">
  Convenience method for sub-query decomposition.
</Accordion>
<Accordion title="rewrite_multi_query(query: str, num_queries: int) -> RewriteResult">
  Convenience method for multi-query generation.
</Accordion>
<Accordion title="rewrite_contextual(query: str, chat_history: List) -> RewriteResult">
  Convenience method for contextual rewriting.
</Accordion>
<Accordion title="add_abbreviation(abbrev: str, expansion: str) -> None">
  Add a custom abbreviation expansion.
</Accordion>
<Accordion title="add_abbreviations(abbreviations: Dict) -> None">
