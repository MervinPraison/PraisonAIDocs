...
<Accordion title="expand(prompt: str, strategy: ExpandStrategy, context: Optional) -> ExpandResult">
...
<Accordion title="expand_basic(prompt: str, context: Optional) -> ExpandResult">
  Convenience method for basic expansion.
</Accordion>
<Accordion title="expand_detailed(prompt: str, context: Optional) -> ExpandResult">
  Convenience method for detailed expansion.
</Accordion>
<Accordion title="expand_structured(prompt: str, context: Optional) -> ExpandResult">
  Convenience method for structured expansion.
</Accordion>
<Accordion title="expand_creative(prompt: str, context: Optional) -> ExpandResult">
