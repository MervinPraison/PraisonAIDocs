...
<AccordionGroup>
<Accordion title="compute_quality_score(completeness: float, relevance: float, clarity: float, accuracy: float, weights: Dict) -> float">
...
<Accordion title="store_short_term(text: str, metadata: Dict) -> Any">
  Store in short-term memory with optional quality metrics
</Accordion>
<Accordion title="search_short_term(query: str, limit: int, min_quality: float, relevance_cutoff: float, rerank: bool) -> List">
  Search short-term memory with optional quality filter
</Accordion>
<Accordion title="reset_short_term() -> Any">
  Completely clears short-term memory.
</Accordion>
<Accordion title="store_long_term(text: str, metadata: Dict) -> Any">
  Store in long-term memory with optional quality metrics
</Accordion>
<Accordion title="search_long_term(query: str, limit: int, relevance_cutoff: float, min_quality: float, rerank: bool) -> List">
  Search long-term memory with optional quality filter
</Accordion>
<Accordion title="reset_long_term() -> Any">
  Clear local LTM DB, plus Chroma, MongoDB, or mem0 if in use.
</Accordion>
<Accordion title="delete_short_term(memory_id: str) -> bool">
...
<Accordion title="delete_long_term(memory_id: str) -> bool">
...
<Accordion title="delete_memory(memory_id: str, memory_type: Optional) -> bool">
...
<Accordion title="delete_memories(memory_ids: List) -> int">
...
<Accordion title="delete_memories_matching(query: str, memory_type: Optional) -> int">
...
<Accordion title="store_entity(name: str, type_: str, desc: str, relations: str) -> Any">
  Save entity info in LTM (or mem0/rag). 
We'll label the metadata type = entity for easy filtering.
</Accordion>
<Accordion title="search_entity(query: str, limit: int) -> List">
  Filter to items that have metadata 'category=entity'.
</Accordion>
<Accordion title="reset_entity_only() -> Any">
...
<Accordion title="store_user_memory(user_id: str, text: str, extra: Dict) -> Any">
  If mem0 is used, do user-based addition. Otherwise store in LTM with user in metadata.
</Accordion>
<Accordion title="search_user_memory(user_id: str, query: str, limit: int, rerank: bool) -> List">
  If mem0 is used, pass user_id in. Otherwise fallback to local filter on user in metadata.
</Accordion>
<Accordion title="search(query: str, user_id: Optional) -> List">
...
<Accordion title="reset_user_memory() -> Any">
  Clear all user-based info. For simplicity, we do a full LTM reset. 
Real usage might filter only metadata "user_id".
</Accordion>
<Accordion title="finalize_task_output(content: str, agent_name: str, quality_score: float, threshold: float, metrics: Dict) -> Any">
  Store task output in memory with appropriate metadata
</Accordion>
<Accordion title="build_context_for_task(task_descr: str, user_id: Optional) -> str">
...
<Accordion title="reset_all() -> Any">
  Fully wipes short-term, long-term, and any memory in mem0 or rag.
</Accordion>
<Accordion title="calculate_quality_metrics(output: str, expected_output: str, llm: Optional) -> Dict">
  Calculate quality metrics using LLM
</Accordion>
<Accordion title="store_quality(text: str, quality_score: float, task_id: Optional) -> None">
  Store quality metrics in memory
</Accordion>
<Accordion title="search_with_quality(query: str, min_quality: float, memory_type: Literal) -> List">
  Search with quality filter
</Accordion>
<Accordion title="get_all_memories() -> List">
  Get all memories from both short-term and long-term storage
</Accordion>
<Accordion title="learn() -> Any">
...
<Accordion title="get_learn_context() -> str">
