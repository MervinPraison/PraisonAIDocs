...
| `function_calling_llm` | `Optional[Any]` | No | `None` |
| `llm_config` | `Optional[Dict]` | No | `None` |
| `base_url` | `Optional[str]` | No | `None` |
| `api_key` | `Optional[str]` | No | `None` |
| `tools` | `Optional[List]` | No | `None` |
| `allow_delegation` | `bool` | No | `False` |
| `allow_code_execution` | `Optional[bool]` | No | `False` |
| `code_execution_mode` | `Literal` | No | `'safe'` |
| `handoffs` | `Optional[List]` | No | `None` |
| `auto_save` | `Optional[str]` | No | `None` |
| `rate_limiter` | `Optional[Any]` | No | `None` |
| `memory` | `Optional[Any]` | No | `None` |
...
| `verification_hooks` | `Optional[List]` | No | `None` |
| `output` | `Optional` | No | `None` |
| `execution` | `Optional` | No | `None` |
| `templates` | `Optional[Any]` | No | `None` |
...
- **run_autonomous**(`prompt`) → `Any`
  Run an autonomous task execution loop.
- **handoff_to**(`target_agent`) → `HandoffResult`
  Programmatically hand off a task to another agent.
- **async handoff_to_async**(`target_agent`) → `HandoffResult`
...
- **get_rules_context**(`file_path`) → `str`
...
- **async execute_tool_async**(`function_name`) → `Any`
