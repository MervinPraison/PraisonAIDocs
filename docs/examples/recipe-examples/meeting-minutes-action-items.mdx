...
- Prefer starting from an audio file? See **[Meeting Notes Agent](/features/meeting-notes-agent)**.
- **[Podcast Transcription Cleaner](/examples/recipe-examples/podcast-transcription-cleaner)** - Clean up meeting recordings
- **[Document Summarizer](/examples/recipe-examples/document-summarizer-with-citations)** - Summarize meeting documents
