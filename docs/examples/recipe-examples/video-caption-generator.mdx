...
- **[Podcast Transcription Cleaner](/examples/recipe-examples/podcast-transcription-cleaner)** - Similar recipe for audio files
- **[Multilingual Subtitle Translator](/examples/recipe-examples/multilingual-subtitle-translator)** - Translate your generated captions
- **[Integration Models](/guides/recipes/integration-models)** - Deep dive into deployment options
