...
- **[Multilingual Subtitle Translator](/examples/recipe-examples/multilingual-subtitle-translator)** - Translate text subtitles
- **[Podcast Transcription Cleaner](/examples/recipe-examples/podcast-transcription-cleaner)** - Clean up transcripts
