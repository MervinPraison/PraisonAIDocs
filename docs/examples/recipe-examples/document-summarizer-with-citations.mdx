...
- **[Meeting Minutes Action Items](/examples/recipe-examples/meeting-minutes-action-items)** - Summarize meeting transcripts
- **[Customer Support Reply Drafter](/examples/recipe-examples/customer-support-reply-drafter)** - Draft responses based on documentation
