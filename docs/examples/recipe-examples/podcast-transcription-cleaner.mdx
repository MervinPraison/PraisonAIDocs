...
- **[Video Caption Generator](/examples/recipe-examples/video-caption-generator)** - Caption video content
- **[Meeting Minutes Action Items](/examples/recipe-examples/meeting-minutes-action-items)** - Extract action items from recordings
