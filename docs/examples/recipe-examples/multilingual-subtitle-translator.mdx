...
- **[Video Caption Generator](/examples/recipe-examples/video-caption-generator)** - Generate captions first
- **[Voice-to-Voice Translator Lite](/examples/recipe-examples/voice-to-voice-translator-lite)** - Translate audio directly
