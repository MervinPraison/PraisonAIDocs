...
- **[Document Summarizer](/examples/recipe-examples/document-summarizer-with-citations)** - Summarize product descriptions
- **[Customer Support Reply Drafter](/examples/recipe-examples/customer-support-reply-drafter)** - Handle product inquiries
