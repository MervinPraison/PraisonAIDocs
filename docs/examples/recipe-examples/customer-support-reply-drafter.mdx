...
<Steps>
  ...
  <Step title="Create README.md">
    ...
    Generate professional support reply drafts.

    ## Quick Start

    ```bash
    praison recipes run customer-support-reply-drafter \
      --input '{"ticket_id": "T-123", "message": "I need help with my order"}'
    ```

    ## Tones

    - **professional**: Clear, courteous, business-appropriate
    - **friendly**: Warm, approachable, conversational
    - **formal**: Polished, respectful, traditional

    ## Confidence Scores

    - 0.9-1.0: Ready to send
    - 0.7-0.9: Minor review recommended
    - 0.5-0.7: Review before sending
    - Below 0.5: Needs revision
    ```
  </Step>
</Steps>
