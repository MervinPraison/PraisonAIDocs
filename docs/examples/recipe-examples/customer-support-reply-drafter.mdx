...
- **[Meeting Minutes Action Items](/examples/recipe-examples/meeting-minutes-action-items)** - Extract action items from support calls
- **[Document Summarizer](/examples/recipe-examples/document-summarizer-with-citations)** - Summarize support documentation
