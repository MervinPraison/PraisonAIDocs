...
def load_recipe(name: str):
    ...
    if not recipe_path.exists():
        recipe_path = Path("/path/to/your/Agent-Recipes/agent_recipes/templates") / name
...
- [CLI Reference](/examples/agent-recipes/cli) - Command line usage
- [Deploy as Server](/examples/agent-recipes/server) - HTTP API deployment
- [Troubleshooting](/examples/agent-recipes/troubleshooting) - Common issues
