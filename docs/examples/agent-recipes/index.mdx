...
<CardGroup cols={2}>
  <Card title="Video & Audio" icon="video" href="/examples/agent-recipes/video-audio/ai-subtitle-generator">
    8 tools for video/audio processing, transcription, and enhancement
  </Card>
  <Card title="Documents" icon="file-lines" href="/examples/agent-recipes/documents/ai-invoice-processor">
    8 tools for document parsing, analysis, and generation
  </Card>
  <Card title="Images" icon="image" href="/examples/agent-recipes/images/ai-background-remover">
    8 tools for image processing, enhancement, and analysis
  </Card>
  <Card title="Developer" icon="code" href="/examples/agent-recipes/developer/ai-commit-message-generator">
    8 tools for code generation, review, and documentation
  </Card>
  <Card title="Data & Analytics" icon="chart-bar" href="/examples/agent-recipes/data/ai-report-generator">
    8 tools for data analysis, visualization, and transformation
  </Card>
  <Card title="Web & Content" icon="globe" href="/examples/agent-recipes/web-content/ai-blog-generator">
    8 tools for SEO, content generation, and web automation
  </Card>
  <Card title="Productivity" icon="clock" href="/examples/agent-recipes/productivity/ai-email-parser">
