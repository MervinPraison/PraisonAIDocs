...
ls /path/to/your/Agent-Recipes/agent_recipes/templates/
...
def inspect_recipe(name):
    ...
    paths = [
        ...
        Path("/path/to/your/Agent-Recipes/agent_recipes/templates") / name,
    ]
...
- [Documentation](https://praison.ai/docs)

## Next Steps

- [Agent Recipes Overview](/examples/agent-recipes) - Getting started
- [CLI Reference](/examples/agent-recipes/cli) - Command reference
- [Python Integration](/examples/agent-recipes/integration) - Use in applications
