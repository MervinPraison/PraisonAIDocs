...
- [Invoice Processor](/examples/agent-recipes/documents/ai-invoice-processor)
- [Resume Parser](/examples/agent-recipes/documents/ai-resume-parser)
- [Contract Analyzer](/examples/agent-recipes/documents/ai-contract-analyzer)
