...
<CardGroup cols={2}>
<Card title="Research Assistant" icon="search" href="/examples/research-assistant">
  Multi-agent research workflow for comprehensive analysis
</Card>
<Card title="Agents Concepts" icon="user" href="/concepts/agents">
  Learn about agent fundamentals and architecture
</Card>
<Card title="Tasks & AgentTeam" icon="list-check" href="/concepts/tasks">
  Understand task coordination and team workflows
</Card>
<Card title="YAML Configuration" icon="file-code" href="/features/yaml-configuration-reference">
