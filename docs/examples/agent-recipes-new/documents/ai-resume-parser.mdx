---
title: "Resume Parser"
description: "Parse CVs/resumes into structured JSON"
icon: "id-card"
---
...
for event in run_recipe("ai-resume-parser", input={}, stream=True):
    print(event)
```
...
```python
from praisonai.recipes import run_recipe
result = run_recipe("ai-resume-parser", input={"input": "data"})
```
