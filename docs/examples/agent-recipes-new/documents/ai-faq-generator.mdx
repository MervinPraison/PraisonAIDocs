---
title: "FAQ Generator"
description: "Generate FAQ from documentation"
...
for event in run_recipe("ai-faq-generator", input={}, stream=True):
    print(event)
```
...
```python
from praisonai.recipes import run_recipe
result = run_recipe("ai-faq-generator", input={"input": "data"})
```
