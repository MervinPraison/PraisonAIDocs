---
title: "Voice Cloner"
description: "Clone voice from sample for TTS narration"
icon: "microphone"
---
...
for event in run_recipe("ai-voice-cloner", input={}, stream=True):
    print(event)
```
...
```python
from praisonai.recipes import run_recipe
result = run_recipe("ai-voice-cloner", input={"input": "data"})
```
