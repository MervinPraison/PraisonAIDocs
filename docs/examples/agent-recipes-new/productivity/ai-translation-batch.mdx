...
description: "Batch translate documents"
icon: "language"
---
...
for event in run_recipe("ai-translation-batch", input={}, stream=True):
    print(event)
```
...
```python
from praisonai.recipes import run_recipe
result = run_recipe("ai-translation-batch", input={"input": "data"})
```
