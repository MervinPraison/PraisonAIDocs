...
description: "Generate e-commerce descriptions"
icon: "box"
---
...
for event in run_recipe("ai-product-description-generator", input={}, stream=True):
    print(event)
```
...
```python
from praisonai.recipes import run_recipe
result = run_recipe("ai-product-description-generator", input={"input": "data"})
```
...
- [SEO Optimizer](/docs/examples/agent-recipes-new/web-content/ai-seo-optimizer)
- [Blog Generator](/docs/examples/agent-recipes-new/web-content/ai-blog-generator)
- [Newsletter Generator](/docs/examples/agent-recipes-new/web-content/ai-newsletter-generator)
