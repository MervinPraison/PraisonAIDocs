...
description: "Generate alt-text and captions for images"
icon: "message-image"
---
...
for event in run_recipe("ai-image-captioner", input={}, stream=True):
    print(event)
```
...
```python
from praisonai.recipes import run_recipe
result = run_recipe("ai-image-captioner", input={"input": "data"})
```
...
- [Image Upscaler](/docs/examples/agent-recipes-new/images/ai-image-upscaler)
