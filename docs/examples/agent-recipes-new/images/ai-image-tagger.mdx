---
title: "Image Tagger"
description: "Auto-tag images with keywords and categories"
icon: "tags"
---
...
for event in run_recipe("ai-image-tagger", input={}, stream=True):
    print(event)
```
...
```python
from praisonai.recipes import run_recipe
result = run_recipe("ai-image-tagger", input={"input": "data"})
```
