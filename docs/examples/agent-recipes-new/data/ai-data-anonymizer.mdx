...
description: "Anonymize PII in datasets"
icon: "user-shield"
---
...
for event in run_recipe("ai-data-anonymizer", input={}, stream=True):
    print(event)
```
...
```python
from praisonai.recipes import run_recipe
result = run_recipe("ai-data-anonymizer", input={"input": "data"})
```
