...
description: "Find and deduplicate similar files"
icon: "clone"
---
...
for event in run_recipe("ai-duplicate-finder", input={}, stream=True):
    print(event)
```
...
```python
from praisonai.recipes import run_recipe
result = run_recipe("ai-duplicate-finder", input={"input": "data"})
```
...
- [Report Generator](/docs/examples/agent-recipes-new/data/ai-report-generator)
- [Chart Generator](/docs/examples/agent-recipes-new/data/ai-chart-generator)
- [Sentiment Analyzer](/docs/examples/agent-recipes-new/data/ai-sentiment-analyzer)
