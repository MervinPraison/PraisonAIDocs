---
title: "Log Analyzer"
description: "Analyze logs for anomalies and patterns"
icon: "scroll"
---
...
for event in run_recipe("ai-log-analyzer", input={}, stream=True):
    print(event)
```
...
```python
from praisonai.recipes import run_recipe
result = run_recipe("ai-log-analyzer", input={"input": "data"})
```
