...
for event in run_recipe("ai-regex-generator", input={}, stream=True):
    print(event)
```
...
```python
from praisonai.recipes import run_recipe
result = run_recipe("ai-regex-generator", input={"input": "data"})
```
...
- [Commit Message Generator](/docs/examples/agent-recipes-new/developer/ai-commit-message-generator)
- [Code Refactorer](/docs/examples/agent-recipes-new/developer/ai-code-refactorer)
- [API Doc Generator](/docs/examples/agent-recipes-new/developer/ai-api-doc-generator)
