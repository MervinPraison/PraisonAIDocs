...
<Tabs>
  ...
  <Tab title="Goal-gated variant">
    Passing `goal=` delegates to the tool-using [goal loop](/features/goal-loop) — an independent judge gates completion against acceptance criteria.
...
<CardGroup cols={2}>
  ...
  <Card title="Evaluator-Optimizer" icon="arrows-rotate" href="/features/evaluator-optimiser">
    Multi-agent evaluator-optimizer pattern
  </Card>
  <Card title="Goal Loop" icon="bullseye-arrow" href="/features/goal-loop">
  ...
  <Card title="Trials Engine" icon="dice" href="/features/trials-engine">
