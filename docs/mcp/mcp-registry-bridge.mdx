...
<Note>
**Since the release cut from PraisonAI [PR #4311](https://github.com/MervinPraison/PraisonAI/pull/4311):** every tool exposed by `register_all()` executes against real core. Earlier releases advertised the same count, but 27 tools failed at binding time. See PraisonAI [issue #4304](https://github.com/MervinPraison/PraisonAI/issues/4304).
</Note>
...
- [MCP Tool Annotations](/mcp/mcp-tool-annotations) - Annotation hints
- [MCP Server](/mcp/mcp-server) - Core MCP server
- [PraisonAI Agents Tools](/tools/tools) - Agent tools documentation
