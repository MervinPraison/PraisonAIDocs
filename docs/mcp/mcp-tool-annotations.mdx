...
- [MCP Tool Annotations CLI](/cli/mcp-tool-annotations) - CLI commands for tool info
- [MCP Tool Search](/mcp/mcp-tool-search) - Search tools by annotations
- [MCP Server](/mcp/mcp-server) - Core MCP server documentation
