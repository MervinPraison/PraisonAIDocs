...
agent = Agent(
    ...
    llm="gpt-4o-mini",
    tools = MCP("/path/to/your/venv/bin/python /path/to/your/custom-python-server.py")
)

# NOTE: Python Path replace with yours: /path/to/your/venv/bin/python
# NOTE: custom-python-server.py file path, replace it with yours: /path/to/your/custom-python-server.py
...
```bash
export PYTHON_PATH=/path/to/your/venv/bin/python
export SERVER_PATH=/path/to/your/app.py
```