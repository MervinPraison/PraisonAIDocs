...
- [MCP Elicitation](/mcp/mcp-elicitation) - Request user input during tasks
- [MCP Sampling](/mcp/mcp-sampling) - LLM completions during tasks
- [PraisonAI MCP Server](/mcp/praisonai-mcp-server) - Full server documentation
