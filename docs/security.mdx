...
**What changed:**
1. **API servers now support optional authentication** - disabled by default, can be enabled via config
...
For step-by-step migration instructions, see [API Server Authentication](/deploy/api/api-server-auth#migration-guide).
