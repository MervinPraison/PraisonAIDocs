...
<Tip>
See [Agent Handoffs](/features/handoffs) for the delegation model and [Handoff Tool Policy](/features/handoff-tool-policy) for the tool-intersection rule applied on top of the SDK handoff mechanism.
</Tip>
...
<Card title="PraisonAI Agents" icon="brain" href="/framework/praisonaiagents">
  Native PraisonAI runtime
</Card>
<Card title="Agent Handoffs" icon="hand-holding-hand" href="/features/handoffs">
  Delegation model and Python API
</Card>
<Card title="Handoff Tool Policy" icon="shield" href="/features/handoff-tool-policy">
  Tool intersection on handoff
</Card>
<Card title="Framework Availability" icon="circle-check" href="/features/framework-availability">
