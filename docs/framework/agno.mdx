...
<AccordionGroup>
  ...
  <Accordion title="When to use handoffs">
    Use `handoff.to` in your YAML when you need a router agent to delegate to specialists at runtime. Multi-task configs fall back to sequential execution. See [Handoffs](/features/handoffs) for the full conceptual model and which frameworks support it.
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="Google ADK" icon="google" href="/framework/google-adk">
