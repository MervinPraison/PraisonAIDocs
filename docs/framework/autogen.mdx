...
**Unsupported framework error**: If you see `Unsupported framework: autogen. Registered: ['ag2', 'autogen', 'autogen_v4', 'crewai', 'praisonai']`, check spelling — frameworks are registered via the adapter registry.

**Missing installation errors**:
- `AG2 is not available. Install with: pip install ag2` — Install AG2 dependencies
- `AutoGen v0.2 is not available. Install with: pip install autogen` — Install AutoGen v0.2 dependencies
