...
<Note>
The PraisonAI monorepo includes sibling packages `praisonai-agents`, `praisonai-code`, and `praisonai`. See [praisonai-code Migration](/guides/praisonai-code-migration) for how the agentic terminal CLI is being extracted (C0–C6).
</Note>
