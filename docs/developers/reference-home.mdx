...
description: "Comprehensive reference documentation for PraisonAI including all features, diagrams, and examples."
icon: "book"
---
...
<Card title="Learn more about Agents" icon="robot" href="/agents/agents">
...
<Card title="Learn more about Workflows" icon="diagram-project" href="/features/workflows">
...
<Card title="Browse Agent Recipes" icon="wand-magic-sparkles" href="/examples/agent-recipes/index">
...
<Card title="Learn more about Tools" icon="wrench" href="/tools/custom">
...
<CardGroup cols={3}>
  <Card title="Single Agent" icon="user" href="/agents/single">
    Create a single AI agent
  </Card>
  <Card title="Multi Agents" icon="users" href="/agents/agents">
  ...
  <Card title="Knowledge/RAG" icon="book" href="/features/rag">
    Document retrieval
  </Card>
...
<CardGroup cols={3}>
  ...
  <Card title="Code Execution" icon="code" href="/tools/python_tools">
    Run Python code
  </Card>
  <Card title="Database Tools" icon="database" href="/tools/duckdb_tools">
    Query databases
  </Card>
  <Card title="Custom Tools" icon="wrench" href="/tools/custom">
    Build your own
  </Card>
  <Card title="All Tools" icon="toolbox" href="/tools/tools">
    Browse all tools
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="MCP Overview" icon="plug" href="/mcp/transports">
    What is MCP?
  </Card>
  <Card title="Stdio Transport" icon="terminal" href="/mcp/stdio">
    Local process communication
  </Card>
  <Card title="SSE Transport" icon="wifi" href="/mcp/sse">
    HTTP streaming
  </Card>
  <Card title="GitHub MCP" icon="github" href="/mcp/github">
    GitHub integration
  </Card>
  <Card title="Custom MCP" icon="code" href="/mcp/custom">
    Build MCP servers
  </Card>
...
<CardGroup cols={3}>
  <Card title="Deploy Overview" icon="cloud" href="/deploy/index">
    Deployment options
  </Card>
  <Card title="Agents Server" icon="server" href="/deploy/servers/agents">
    HTTP API for agents
  </Card>
  <Card title="MCP Server" icon="plug" href="/deploy/servers/tools-mcp">
    Deploy as MCP server
  </Card>
  <Card title="A2A Protocol" icon="arrows-left-right" href="/deploy/servers/a2a">
    Agent-to-agent communication
  </Card>
  <Card title="Docker" icon="docker" href="/deploy/cli/docker">
    Container deployment
  </Card>
  <Card title="Cloud Deploy" icon="cloud-arrow-up" href="/deploy/cli/aws">
    AWS, Azure, GCP
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="JS Overview" icon="js" href="/js/js">
    Getting started
  </Card>
  <Card title="TypeScript" icon="code" href="/js/typescript">
    TypeScript guide
  </Card>
  <Card title="Agent API" icon="robot" href="/js/agent">
    Create agents
  </Card>
...
<Card title="Full CLI Reference" icon="terminal" href="/cli/cli-reference">
...
<AccordionGroup>
  <Accordion title="Ollama Integration">
    Name the model with the `ollama/` prefix — it resolves the base URL automatically and routes through the `OllamaAdapter`:
    ```bash
    ...
    ```
    Setting only `OPENAI_BASE_URL` with no model sends the OpenAI default `gpt-4o-mini` to Ollama and fails with `404 model 'gpt-4o-mini' not found`. See [Ollama](/models/ollama#common-pitfall-naming-the-model-matters).
  </Accordion>
...
<CardGroup cols={3}>
  ...
  <Card title="Memory & Knowledge" icon="database" href="/features/advanced-memory">
    Persistent memory and RAG-powered knowledge bases for context-aware agents
  </Card>
  <Card title="MCP Integration" icon="plug" href="/mcp/transports">
    Connect to external tools and services via Model Context Protocol
  </Card>
  <Card title="Multimodal Agents" icon="icons" href="/features/multimodal">
...
<CardGroup cols={3}>
  ...
  <Card title="Code Interface" icon="code" href="/ui/code-ui">
