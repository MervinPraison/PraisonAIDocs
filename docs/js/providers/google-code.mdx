...
<CardGroup cols={2}>
  <Card title="Google CLI Usage" icon="terminal" href="/js/providers/google-cli">
    Google CLI Usage
  </Card>
  <Card title="Google Vertex AI" icon="book" href="/js/providers/google-vertex-code">
    Google Vertex AI
  </Card>
  <Card title="Providers Overview" icon="book" href="/js/providers">
    Providers Overview
  </Card>
</CardGroup>