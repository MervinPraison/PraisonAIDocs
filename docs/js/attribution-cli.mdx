...
<CardGroup cols={2}>
  <Card title="Attribution" icon="fingerprint" href="/js/attribution">
    SDK documentation
  </Card>
  <Card title="Telemetry CLI" icon="terminal" href="/js/telemetry-cli">
    Telemetry CLI
  </Card>
  <Card title="Agent CLI" icon="terminal" href="/js/agent-cli">
    Single-agent CLI
  </Card>
</CardGroup>
