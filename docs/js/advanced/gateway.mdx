...
<CardGroup cols={2}>
  <Card title="BotProtocol" icon="robot" href="/sdk/reference/typescript/classes/BotProtocol">
    Bot protocol interface
  </Card>
  <Card title="GatewayProtocol" icon="plug" href="/sdk/reference/typescript/classes/GatewayProtocol">
