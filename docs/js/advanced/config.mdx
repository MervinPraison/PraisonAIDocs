...
<CardGroup cols={2}>
  <Card title="MemoryConfig" icon="brain" href="/sdk/reference/typescript/classes/MemoryConfig">
    Memory configuration options
  </Card>
  <Card title="ExecutionConfig" icon="bolt" href="/sdk/reference/typescript/classes/ExecutionConfig">
    Execution configuration options
  </Card>
  <Card title="OutputConfig" icon="display" href="/sdk/reference/typescript/classes/OutputConfig">
    Output configuration options
  </Card>
  <Card title="PraisonConfig" icon="sliders" href="/sdk/reference/typescript/classes/PraisonConfig">
