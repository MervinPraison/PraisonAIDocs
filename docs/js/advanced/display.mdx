...
<CardGroup cols={2}>
  <Card title="DisplayContext" icon="code" href="/sdk/reference/typescript/classes/DisplayContext">
    Display context and callback types
  </Card>
  <Card title="FlowDisplay" icon="diagram-project" href="/sdk/reference/typescript/classes/FlowDisplay">
