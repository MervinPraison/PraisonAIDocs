...
<CardGroup cols={2}>
  <Card title="TraceSink" icon="database" href="/sdk/reference/typescript/classes/TraceSink">
    Trace sink base class
  </Card>
  <Card title="ContextTraceEmitter" icon="wave-pulse" href="/sdk/reference/typescript/classes/ContextTraceEmitter">
    Trace event emitter
  </Card>
</CardGroup>
