...
<CardGroup cols={2}>
  <Card title="DictCondition" icon="code" href="/sdk/reference/typescript/classes/DictCondition">
    Dictionary-based condition
  </Card>
  <Card title="ExpressionCondition" icon="terminal" href="/sdk/reference/typescript/classes/ExpressionCondition">
