...
For more details, see the [Deep Research SDK documentation](/js/deep-research).

## Related

<CardGroup cols={2}>
  <Card title="Deep Research" icon="book" href="/js/deep-research">
    SDK research agent
  </Card>
  <Card title="Citations" icon="book" href="/js/citations">
    Source tracking
  </Card>
</CardGroup>
