...
<AccordionGroup>
  ...
  <Accordion title="Task-Based Agent Example" icon="list-check" defaultOpen>
    ...
    2. Include an introduction about healthy eating`
        ...
        // Create tasks as plain objects — Team reads description/agent directly
        const createRecipesTask = {
            name: "Create Recipes",
        ...
        const writeBlogTask = {
            ...
            agent: blogAgent,
            dependsOn: [createRecipesTask]  // This task depends on the recipes being created first
        };
...
<CardGroup cols={2}>
  <Card title="TypeScript" icon="js" href="/js/typescript">TypeScript overview</Card>
