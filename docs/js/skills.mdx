...
Load skills from disk or a manager — see sections below.
...
<CardGroup cols={2}>
  <Card title="Tools" icon="wrench" href="/docs/js/tools">Executable capabilities</Card>
  <Card title="Workflows" icon="diagram-project" href="/docs/js/workflows">Orchestrate agents</Card>
</CardGroup>