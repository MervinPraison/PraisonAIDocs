...
<CardGroup cols={2}>
  <Card title="Tools" icon="wrench" href="/js/tools">Executable capabilities</Card>
  <Card title="Workflows" icon="diagram-project" href="/js/workflows">Orchestrate agents</Card>
</CardGroup>