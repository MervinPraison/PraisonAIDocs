...
- [Tavily Search](/js/tools/tavily) - Alternative web search
- [Perplexity Search](/js/tools/perplexity) - Real-time search with filtering
- [Firecrawl](/js/tools/firecrawl) - Web scraping and crawling
