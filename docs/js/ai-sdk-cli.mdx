---
title: "Multi-Provider Agent CLI"
description: "Command-line interface for running agents with any LLM provider"
icon: "terminal"
---
...
<CardGroup cols={2}>
  <Card title="AI SDK" icon="cpu" href="/js/ai-sdk">
    Code-based AI SDK usage
  </Card>
  <Card title="Streaming" icon="waveform" href="/js/streaming">
    Advanced streaming
  </Card>
  <Card title="Provider Registry" icon="book" href="/js/provider-registry">
    Managing providers
  </Card>
</CardGroup>
