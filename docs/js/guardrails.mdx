...
For guarding a single tool's arguments or results, see [Per-Tool Guardrails](/js/per-tool-guardrails).
...
<CardGroup cols={2}>
  <Card title="Per-Tool Guardrails" icon="shield-halved" href="/js/per-tool-guardrails">
    Guard a single tool's arguments and results
  </Card>
