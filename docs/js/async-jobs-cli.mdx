...
<CardGroup cols={2}>
  <Card title="Async Jobs" icon="server" href="/js/async-jobs">
    SDK documentation
  </Card>
  <Card title="Background Tasks CLI" icon="terminal" href="/js/background-tasks-cli">
    Background task CLI
  </Card>
  <Card title="Jobs" icon="list" href="/js/jobs">
    Jobs API overview
  </Card>
</CardGroup>
