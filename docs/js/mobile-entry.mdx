...
The mobile entry bundles well under the 400 kB target for a phone build, and its lazy-chunk footprint has a comfortable margin under the 1600 kB budget.

```
praisonai/mobile entry, minified:   77.8 kB    (target: < 400 kB)
praisonai/mobile lazy chunks:       891.2 kB   (was 1576.4 kB; budget 1600 kB)
praisonai/mobile headroom:          708.8 kB   (was 23.6 kB)
