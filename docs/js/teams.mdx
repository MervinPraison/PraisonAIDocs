...
<Note>
`runOn` is **refused** on a team — passing it throws a `TypeError` at construction, matching Python. Put `runOn` on an individual `Agent` instead. See [AgentTeam](/docs/js/agent-team#team-level-options) for the full list of team-level options.
</Note>
...
<Card title="TeamStructure" icon="code" href="/sdk/reference/typescript/classes/TeamStructure">
  Team configuration
</Card>
<Card title="MultiAgentExecutionConfig" icon="robot" href="/sdk/reference/typescript/classes/MultiAgentExecutionConfig">
