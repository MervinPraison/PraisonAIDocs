...
<Card title="KnowledgeConfig" icon="code" href="/sdk/reference/typescript/classes/KnowledgeConfig">
  Complete configuration options
</Card>
<Card title="RAG" icon="robot" href="/sdk/reference/typescript/classes/RAG">
...
<CardGroup cols={2}>
  ...
  <Card title="RAG" icon="book" href="/js/rag-agent">
