...
<Card title="FailoverConfig" icon="code" href="/sdk/reference/typescript/classes/FailoverConfig">
  Complete configuration options
</Card>
<Card title="FailoverManager" icon="robot" href="/sdk/reference/typescript/classes/FailoverManager">
