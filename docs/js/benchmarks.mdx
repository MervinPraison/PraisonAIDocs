...
```typescript
process.env.PRAISONAI_BACKEND = 'auto';
...
<CardGroup cols={2}>
  <Card title="Benchmarks CLI" icon="terminal" href="/docs/js/benchmarks-cli">
    Run benchmarks from the terminal
  </Card>
  <Card title="AI SDK" icon="book" href="/docs/js/ai-sdk">
