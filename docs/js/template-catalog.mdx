...
```mermaid
graph LR
    App([App]) --> Catalog[Template Catalog]
    Catalog --> Agent[Agent]
...
<CardGroup cols={2}>
  <Card title="Template Catalog CLI" icon="terminal" href="/docs/js/template-catalog-cli">CLI reference</Card>
  <Card title="Workflows" icon="diagram-project" href="/docs/js/workflows">Workflow templates</Card>
</CardGroup>
