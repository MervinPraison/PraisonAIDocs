...
<CardGroup cols={2}>
  <Card title="Template Catalog CLI" icon="terminal" href="/js/template-catalog-cli">CLI reference</Card>
  <Card title="Workflows" icon="diagram-project" href="/js/workflows">Workflow templates</Card>
</CardGroup>
