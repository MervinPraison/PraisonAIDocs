...
For programmatic usage, see the [Query Rewriter SDK documentation](/js/query-rewriter).
...
<CardGroup cols={2}>
  <Card title="Query Rewriter SDK" icon="code" href="/js/query-rewriter">
    Programmatic rewriting
  </Card>
  <Card title="Retrieval" icon="magnifying-glass" href="/js/retrieval">
