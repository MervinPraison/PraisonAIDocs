...
For programmatic usage, see the [Prompt Expander SDK documentation](/js/prompt-expander).

## Related

<CardGroup cols={2}>
  <Card title="Prompt Expander SDK" icon="text-height" href="/js/prompt-expander">
