...
<CardGroup cols={2}>
  <Card title="Hooks Manager" icon="book" href="/js/hooks-manager">
    Operation hooks
  </Card>
  <Card title="Workflow Hooks" icon="book" href="/js/workflow-hooks">
    Workflow lifecycle
  </Card>
  <Card title="Guardrails" icon="book" href="/js/guardrails">
