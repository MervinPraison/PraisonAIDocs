...
Use Zod schemas and AI SDK backends — see sections below.
...
<CardGroup cols={2}>
  <Card title="AI SDK" icon="sparkles" href="/docs/js/ai-sdk">AI SDK integration</Card>
