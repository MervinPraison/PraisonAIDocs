...
For more details, see the [LLM Guardrail SDK documentation](/js/llm-guardrail).

## Related

<CardGroup cols={2}>
  <Card title="LLM Guardrail" icon="book" href="/js/llm-guardrail">LLM Guardrail overview</Card>
  <Card title="Guardrails" icon="robot" href="/js/guardrails">Guardrails overview</Card>
</CardGroup>
