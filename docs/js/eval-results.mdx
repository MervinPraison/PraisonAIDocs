...
Collect, analyse, and export agent evaluation results.

```mermaid
graph LR
    Eval([Evaluation]) --> Res[Eval Results]
    Res --> Out([Report])
...
<CardGroup cols={2}>
  <Card title="Evaluation" icon="clipboard-check" href="/docs/js/evaluation">
    Evaluation framework
  </Card>
  <Card title="Benchmarks" icon="gauge" href="/docs/js/benchmarks">
    Performance benchmarking
  </Card>
  <Card title="Observability" icon="chart-line" href="/docs/js/observability">
    Monitoring
  </Card>
</CardGroup>
