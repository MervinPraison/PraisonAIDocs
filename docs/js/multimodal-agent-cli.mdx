...
<CardGroup cols={2}>
  <Card title="Multimodal Agent" icon="book" href="/js/multimodal-agent">Multimodal Agent overview</Card>
  <Card title="Vision" icon="robot" href="/js/vision">Vision overview</Card>
</CardGroup>
