...
Give agents relationship-aware knowledge with graph traversal.

```mermaid
graph LR
    Query([Query]) --> Graph[Graph RAG]
    Graph --> Answer([Answer])
...
<CardGroup cols={2}>
  <Card title="Vector Stores" icon="database" href="/js/vector-stores">
    Similarity-based knowledge
  </Card>
  <Card title="Reranking" icon="sort" href="/js/reranking">
    Improve retrieval accuracy
  </Card>
  <Card title="Knowledge Base" icon="book" href="/js/knowledge-base">
    Combined RAG for Agents
  </Card>
</CardGroup>
