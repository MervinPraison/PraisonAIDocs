...
<Card title="RealtimeConfig" icon="code" href="/sdk/reference/typescript/classes/RealtimeConfig">
  Complete configuration options
</Card>
<Card title="RealtimeAgent" icon="robot" href="/sdk/reference/typescript/classes/RealtimeAgent">
