...
For more details, see the [Workflows SDK documentation](/js/workflows).

## Related

<CardGroup cols={2}>
  <Card title="Workflows" icon="book" href="/js/workflows">Workflows overview</Card>
  <Card title="Agent Flow" icon="robot" href="/js/agent-flow">Agent Flow overview</Card>
</CardGroup>
