...
<Card title="VideoConfig" icon="code" href="/sdk/reference/typescript/classes/VideoConfig">
  Complete configuration options
</Card>
<Card title="VideoAgent" icon="robot" href="/sdk/reference/typescript/classes/VideoAgent">
...
<CardGroup cols={2}>
  ...
  <Card title="Audio" icon="headphones" href="/js/audio">
