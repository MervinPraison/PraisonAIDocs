...
const agent = new Agent({
  ...
  instructions: "You are an AI assistant that helps complete tasks step by step."
});

// A task is a plain object — agent.execute reads its description
const mainTask = {
  name: "Write Blog Post",
  description: "Write a blog post about artificial intelligence",
  expectedOutput: "A complete blog post"
};
...
<CardGroup cols={2}>
  <Card title="TypeScript" icon="book" href="/js/typescript">TypeScript overview</Card>
  <Card title="Getting Started" icon="robot" href="/js/nodejs">Getting Started overview</Card>
</CardGroup>
