...
For programmatic telemetry control, see the [Telemetry SDK documentation](/js/telemetry).

## Related

<CardGroup cols={2}>
  <Card title="Telemetry" icon="chart-line" href="/js/telemetry">Telemetry SDK</Card>
  <Card title="Agent CLI" icon="terminal" href="/js/agent-cli">Agent commands</Card>
</CardGroup>
