...
<CardGroup cols={2}>
  <Card title="Async Jobs CLI" icon="terminal" href="/js/async-jobs-cli">
    CLI commands
  </Card>
  <Card title="Background Tasks" icon="layer-group" href="/js/background-tasks">
    In-process execution
  </Card>
  <Card title="Scheduler" icon="clock" href="/js/scheduler">
    Periodic scheduling
  </Card>
</CardGroup>
