...
<Card title="VisionConfig" icon="code" href="/sdk/reference/typescript/classes/VisionConfig">
  Complete configuration options
</Card>
<Card title="VisionAgent" icon="robot" href="/sdk/reference/typescript/classes/VisionAgent">
...
<CardGroup cols={2}>
  <Card title="Video" icon="video" href="/js/video">
    Analyze videos
  </Card>
  <Card title="OCR" icon="font" href="/js/ocr">
