...
<Card title="Vector Store API Reference" icon="code" href="/sdk/reference/typescript/modules/tools">
...
<CardGroup cols={2}>
  ...
  <Card title="Embeddings" icon="vector-square" href="/js/embeddings">
