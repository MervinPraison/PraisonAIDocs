...
For more details, see the [Image Agent SDK documentation](/js/image-agent).

## Related

<CardGroup cols={2}>
  <Card title="Image Agent" icon="book" href="/js/image-agent">Image Agent overview</Card>
  <Card title="Multimodal Agent" icon="robot" href="/js/multimodal-agent">Multimodal Agent overview</Card>
</CardGroup>
