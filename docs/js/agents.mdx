...
<Note>
`AgentTeam` is now the primary class name (v1.5.5+). `Agents` is a silent alias for backward compatibility. See [AgentTeam](/js/agent-team) for the latest documentation.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Agents CLI" icon="terminal" href="/js/agents-cli">
    CLI commands
  </Card>
</CardGroup>
