...
icon: "database"
---
Give your Agents persistent memory so they remember conversations across restarts.

```mermaid
graph LR
    Agent([Agent]) --> DB[(Database)]
    DB --> Session([Session])
...
<CardGroup cols={2}>
  ...
  <Card title="Memory" icon="database" href="/docs/js/memory">
    Agent memory systems
  </Card>
  <Card title="Sessions" icon="database" href="/docs/js/sessions">
