...
<CardGroup cols={2}>
  <Card title="Computer Use CLI" icon="terminal" href="/js/computer-use-cli">
    Terminal automation
  </Card>
  <Card title="Tool Approval" icon="book" href="/js/approval">
    Human-in-the-loop approvals
  </Card>
  <Card title="Image Agent" icon="robot" href="/js/image-agent">
    Vision capabilities
  </Card>
</CardGroup>
