...
<CardGroup cols={2}>
  <Card title="Slackbot Agent" icon="slack" href="/js/slackbot-agent">Slack bot SDK</Card>
  <Card title="Server Adapters" icon="server" href="/js/server-adapters">HTTP deployment</Card>
</CardGroup>
