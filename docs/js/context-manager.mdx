...
<CardGroup cols={2}>
  <Card title="Context Manager CLI" icon="terminal" href="/js/context-manager-cli">
    CLI context commands
  </Card>
  <Card title="Memory" icon="book" href="/js/memory">
    Agent memory systems
  </Card>
  <Card title="Sessions" icon="book" href="/js/sessions">
