...
Efficiently manage context windows for your Agents. Budget tokens, prioritise content, and optimise long conversations.

```mermaid
graph LR
    Agent([Agent]) --> CM[Context Manager]
    CM --> Window([Context Window])
...
<CardGroup cols={2}>
  <Card title="Context Manager CLI" icon="terminal" href="/docs/js/context-manager-cli">
    CLI context commands
  </Card>
  <Card title="Memory" icon="book" href="/docs/js/memory">
    Agent memory systems
  </Card>
  <Card title="Sessions" icon="book" href="/docs/js/sessions">
