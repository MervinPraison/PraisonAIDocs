...
<Card title="GuardrailConfig" icon="code" href="/sdk/reference/typescript/classes/GuardrailConfig">
  Complete configuration options
</Card>
<Card title="Guardrails Module" icon="shield" href="/sdk/reference/typescript/modules/guardrails">
