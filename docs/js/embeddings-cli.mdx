...
```bash
praisonai-ts embed text "Hello" "World" --save embeddings.json --json
```
</Step>
...
<CardGroup cols={2}>
  <Card title="Embeddings" icon="book" href="/js/embeddings">Embeddings overview</Card>
  <Card title="TypeScript" icon="robot" href="/js/typescript">TypeScript overview</Card>
</CardGroup>
