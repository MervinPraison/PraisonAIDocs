...
```bash
praisonai-ts providers list --verbose --json
```
...
<CardGroup cols={2}>
  <Card title="Providers SDK" icon="plug" href="/docs/js/providers">
    Code-based provider usage
  </Card>
  <Card title="AI SDK" icon="code" href="/docs/js/ai-sdk">
    AI SDK integration
  </Card>
</CardGroup>
