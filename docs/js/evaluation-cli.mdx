...
For more details, see the [Evaluation SDK documentation](/js/evaluation).

## Related

<CardGroup cols={2}>
  <Card title="Evaluation" icon="book" href="/js/evaluation">Evaluation overview</Card>
  <Card title="Benchmarks CLI" icon="robot" href="/js/benchmarks-cli">Benchmarks CLI overview</Card>
</CardGroup>
