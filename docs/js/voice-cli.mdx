...
For more details, see the [Voice SDK documentation](/js/voice).

## Related

<CardGroup cols={2}>
  <Card title="Voice" icon="book" href="/js/voice">Voice overview</Card>
  <Card title="Audio" icon="robot" href="/js/audio">Audio overview</Card>
</CardGroup>
