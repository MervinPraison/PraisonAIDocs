...
<Note>
Building a chat bot that transcribes voice notes on Telegram / Slack / WhatsApp? See [Voice Notes (Speech-to-Text)](/docs/features/gateway-stt) — the gateway feature that wraps `AudioAgent` for you.
</Note>
