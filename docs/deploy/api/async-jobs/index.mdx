...
<CardGroup cols={2}>
  <Card title="Submit Run" icon="play" href="/deploy/api/async-jobs/submit-run">
    POST /api/v1/runs - Submit a new job
  </Card>
  <Card title="List Runs" icon="list" href="/deploy/api/async-jobs/list-runs">
    GET /api/v1/runs - List all jobs
  </Card>
  <Card title="Get Status" icon="circle-info" href="/deploy/api/async-jobs/get-run-status">
    GET /api/v1/runs/{job_id} - Get job status
  </Card>
  <Card title="Get Result" icon="check" href="/deploy/api/async-jobs/get-run-result">
    GET /api/v1/runs/{job_id}/result - Get job result
  </Card>
  <Card title="Stream Progress" icon="wave-pulse" href="/deploy/api/async-jobs/stream-run">
    GET /api/v1/runs/{job_id}/stream - SSE stream updates
  </Card>
  <Card title="Cancel Run" icon="stop" href="/deploy/api/async-jobs/cancel-run">
    POST /api/v1/runs/{job_id}/cancel - Cancel a job
  </Card>
  <Card title="Delete Run" icon="trash" href="/deploy/api/async-jobs/delete-run">
    DELETE /api/v1/runs/{job_id} - Delete a job
  </Card>
  <Card title="Health Check" icon="heart-pulse" href="/deploy/api/async-jobs/health">
...
- [Async Jobs Feature Guide](/features/async-jobs)
- [CLI Async Jobs](/cli/async-jobs)
