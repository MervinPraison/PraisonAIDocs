...
3. **Consider SSE streaming**: For real-time updates, use the [Stream Run](/deploy/api/async-jobs/stream-run) endpoint instead.
...
- [Get Run Result](/deploy/api/async-jobs/get-run-result)
