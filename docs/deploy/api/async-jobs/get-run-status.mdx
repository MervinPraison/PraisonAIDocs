...
3. **Consider SSE streaming**: For real-time updates, use the [Stream Run](/docs/deploy/api/async-jobs/stream-run) endpoint instead.
...
- [Get Run Result](/docs/deploy/api/async-jobs/get-run-result)
- [Stream Run](/docs/deploy/api/async-jobs/stream-run)
- [Async Jobs Overview](/docs/deploy/api/async-jobs)
