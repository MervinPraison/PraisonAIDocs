...
<CardGroup cols={2}>
  <Card title="Code Editing" icon="pen-to-square" href="/code/editing">
  ...
  <Card title="Grok CLI" icon="x-twitter" href="/code/grok-cli">
    Delegate Agent turns to xAI's Grok CLI using your subscription
  </Card>
...
await agent.astart("Refactor the auth module")
```
