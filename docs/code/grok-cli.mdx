...
<Note>
`cli_backend=` is deprecated (removal in 2.0.0). Prefer `runtime="grok-cli"` — see [Runtime Selection](/features/runtime-selection).
</Note>
</Step>
</Steps>
...
<CardGroup cols={2}>
<Card title="Codex CLI" icon="code" href="/code/codex-cli">
