...
Agent Train enables active improvement of agent behavior through iterative feedback loops. Unlike [Agent Learn](/concepts/agent-learn) which captures patterns passively, training uses explicit human or LLM feedback to refine responses.
...
See [Learn vs Train Comparison](/concepts/learn-vs-train) for detailed differences.
...
<CardGroup cols={2}>
  ...
  <Card title="Learn vs Train" icon="scale-balanced" href="/concepts/learn-vs-train">
    Detailed comparison
  </Card>
</CardGroup>
