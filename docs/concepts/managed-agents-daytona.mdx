...
<Note>
See [Sandbox & Compute Unified Architecture](/docs/features/sandbox-compute-adapter) to understand how Daytona workspaces are shared between Sandbox and Compute APIs.
</Note>
