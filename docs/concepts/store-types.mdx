...
<CardGroup cols={2}>
  <Card title="Context vs Memory" icon="arrows-split-up-and-left" href="/docs/concepts/context-vs-memory">
    Ephemeral vs persistent data
  </Card>
  <Card title="Context vs Knowledge" icon="book-open" href="/docs/concepts/context-vs-knowledge">
    Runtime vs pre-loaded data
  </Card>
  <Card title="Knowledge vs Memory vs Context" icon="layer-group" href="/docs/concepts/knowledge-memory-context-rag">
    Complete comparison with RAG
  </Card>
  <Card title="Session Management" icon="clock-rotate-left" href="/docs/concepts/session-management">
