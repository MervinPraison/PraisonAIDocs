...
<Info>
**LLM as Judge** is the most powerful evaluation technique - using AI to evaluate AI outputs with human-like reasoning.
</Info>
...
cases = [
    ...
    EvalCase(input="Hello", expected="Hi"),
]
...
print(f"Avg Score: {report.avg_score}/10")
```
...
<Steps>
  <Step title="Start with LLM as Judge">
  ...
  <Step title="Use Multiple Iterations">
