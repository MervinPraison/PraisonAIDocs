...
description: "Compare Agent, AgentTeam, Workflow, and AgentOS"
icon: "layer-group"
---
...
| `AgentFlow` | Deterministic pipelines | Step-by-step flows, loops, conditionals |
| `AgentOS` | Production deployment | Web APIs, production services |
...
| Capability | Agent | AgentTeam | Workflow | AgentOS |
|------------|-------|--------------|----------|----------|
...
graph TD
    ...
    class Agent,Workflow,AgentTeam,AgentOS answer
```
