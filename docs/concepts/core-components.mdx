...
description: "Compare Agent, AgentManager, Workflow, and AgentApp"
icon: "layer-group"
---
...
graph TD
    ...
    Q3 -->|Yes| AgentManager[Use AgentManager]
    ...
    class Agent,Workflow,AgentManager,AgentApp answer
```
