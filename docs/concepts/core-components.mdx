...
description: "Compare Agent, AgentTeam, AgentFlow, and AgentOS"
icon: "layer-group"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Process Types" icon="play" href="/docs/concepts/process">
    Sequential, parallel, hierarchical
  </Card>
  <Card title="AgentFlow" icon="diagram-project" href="/docs/features/workflows">
    Workflow patterns deep dive
  </Card>
  <Card title="AgentOS" icon="rocket" href="/docs/concepts/agentos">
