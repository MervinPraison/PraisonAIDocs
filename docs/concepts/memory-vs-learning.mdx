...
<CardGroup cols={2}>
  ...
  <Card title="Context vs Memory" icon="scale-balanced" href="/docs/concepts/context-vs-memory">
    Context window vs persistent memory
  </Card>
  <Card title="Knowledge vs Memory vs Context" icon="book" href="/docs/concepts/knowledge-memory-context-rag">
