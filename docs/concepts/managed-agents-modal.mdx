...
<Note>
See [Sandbox & Compute Unified Architecture](/docs/features/sandbox-compute-adapter) to understand how Modal compute is shared between Sandbox and Compute APIs.
</Note>
