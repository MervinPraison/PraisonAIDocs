...
# Interactive mode - prompts user and shows response
...
# Silent mode - for scripts and APIs
...
Use Pydantic models to validate and structure agent outputs:
...
# Agent output will be validated against UserInfo schema
result = agent.start("John Doe, john@example.com, 30 years old")
```
