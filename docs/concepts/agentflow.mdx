...
flowchart LR
    ...
    style AgentFlow fill:#1a1a2e,stroke:#4a9eff,stroke-width:2px
    style S1 fill:#16213e,stroke:#4a9eff
    style S2 fill:#16213e,stroke:#4a9eff
    style S3 fill:#16213e,stroke:#4a9eff
```
...
flow = AgentFlow(
    ...
    planning="gpt-4o",       # Or specify planning model
    output="verbose"         # See planning output
)
