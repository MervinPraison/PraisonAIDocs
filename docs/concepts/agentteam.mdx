...
flowchart LR
    ...
    style AgentTeam fill:#1a1a2e,stroke:#4a9eff,stroke-width:2px
    style A1 fill:#16213e,stroke:#4a9eff
    style A2 fill:#16213e,stroke:#4a9eff
    style A3 fill:#16213e,stroke:#4a9eff
```
