---
title: 'Workflow API'
description: 'API reference for Workflow, WorkflowStep, WorkflowContext, and StepResult classes'
...
from praisonaiagents import WorkflowManager, Workflow, WorkflowStep
# Pattern helpers
...
from praisonaiagents import WorkflowStepExecutionConfig
...
```python
from praisonaiagents import WorkflowStepOutputConfig
...
step = WorkflowStep(
    ...
    tools=["tavily_search"],
    output=WorkflowStepOutputConfig(variable="research_data")
)
```
...
```python
from praisonaiagents import WorkflowStepRoutingConfig
