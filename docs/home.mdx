...
<CardGroup cols={4}>
  <Card title="GitHub" icon="github" href="/docs/tools">
    Automate repos, issues, and PRs
  </Card>
  <Card title="Google" icon="google" href="/docs/tools">
    Calendar, Sheets, Drive, Gmail
  </Card>
  <Card title="Notion" icon="file-lines" href="/docs/tools">
    Read and write Notion pages
  </Card>
  <Card title="Jira" icon="jira" href="/docs/tools">
...
<CardGroup cols={3}>
  <Card title="Agents" icon="robot" href="/docs/agents/agents" cta="Learn more">
    Create and configure intelligent agents
  </Card>
  <Card title="Tools" icon="screwdriver-wrench" href="/docs/tools" cta="Browse tools">
  ...
  <Card title="Messaging Bots" icon="comments" href="/docs/features/messaging-bots" cta="Deploy bots">
    Slack, Discord, Telegram, and more
  </Card>
  <Card title="API Reference" icon="code" href="/docs/api" cta="View API">
