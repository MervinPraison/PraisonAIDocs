...
releases the underlying SQLite connection so the database file can be deleted or
reopened immediately — essential on Windows, and best practice everywhere for
