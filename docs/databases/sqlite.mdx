...
backend = SQLiteBackend(db_path="~/.praison/train.db")
...
backend = SQLiteBackend(db_path="~/.praison/sessions.db")
...
backend = SQLiteBackend(db_path="~/.praison/runs.db")
...
backend = SQLiteBackend(db_path="~/.praison/mcp.db")
...
praisonai train agents --input "Hello" --storage-backend sqlite --storage-path ~/.praison/train.db
