...
See [Configuration File → Cheap auxiliary model for internal calls](/docs/features/config-file#cheap-auxiliary-model-for-internal-calls) for the full precedence ladder.
