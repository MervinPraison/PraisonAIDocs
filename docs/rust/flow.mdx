...
<CardGroup cols={2}>
  <Card title="Conditions" icon="code-branch" href="/rust/conditions">
    Add branching
  </Card>
  <Card title="Loops" icon="rotate" href="/rust/loops">
    Add iteration
  </Card>
  <Card title="Agent Teams" icon="users" href="/rust/agent-team">
    Team processes
  </Card>
  <Card title="Parallel" icon="bolt" href="/rust/parallel-execution">
    Run in parallel
  </Card>
</CardGroup>
