...
| `Judge` | LLM-as-judge scoring — ⚠️ not yet implemented (fails closed) |
...
<CardGroup cols={2}>
  <Card title="Optimizer" icon="wand-sparkles" href="/rust/optimizer">
    Auto-improve agents
  </Card>
  <Card title="Tracing" icon="chart-line" href="/rust/tracing">
    Performance tracing
  </Card>
</CardGroup>
