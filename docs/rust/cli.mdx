---
title: "PraisonAI Rust CLI - Run AI Agents from Terminal"
sidebarTitle: "CLI"
description: "Run Rust AI agents from the command line with praisonai-cli. Interactive chat, YAML workflows, and model selection options."
icon: "terminal"
---
