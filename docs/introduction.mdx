...
description: "Welcome to PraisonAI — build, deploy, and manage multi-agent AI systems with self-reflection, 100+ LLM integrations, and production-ready tooling."
keywords: ["AI agents", "multi-agent framework", "PraisonAI", "LLM agents", "agentic AI"]
icon: "book-open"
---
...
sequenceDiagram
    ...
    Agent->>LLM: Send prompt to the selected model
...
<AccordionGroup>
<Accordion title="Pick the right building block">
