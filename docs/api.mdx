...
- OpenAI Agents support (requires `praisonai-frameworks[openai-agents]`)
...
pip install "praisonai-frameworks[openai-agents]"   # Install with OpenAI Agents support
...
### OpenAI Agents
When installing with `pip install "praisonai-frameworks[openai-agents]"`, you get:
- OpenAI Agents SDK framework support
- YAML handoffs and task chaining via `framework: openai_agents`

See [OpenAI Agents framework](/docs/framework/openai_agents) for runnable YAML.
