...
<CardGroup cols={2}>
  ...
  <Card title="RAG Guide" icon="book" href="/docs/rag/overview">
    Build RAG applications
  </Card>
  <Card title="Knowledge" icon="brain" href="/docs/knowledge/overview">
    Knowledge management
  </Card>
  <Card title="Memory" icon="memory" href="/docs/memory/overview">
