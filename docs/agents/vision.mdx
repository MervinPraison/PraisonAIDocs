...
<CardGroup cols={2}>
  <Card title="Image Agent" icon="image" href="/docs/agents/image">
    Generate images with AI
  </Card>
  <Card title="OCR Agent" icon="scanner" href="/docs/agents/image-to-text">
    Specialized OCR extraction
  </Card>
  <Card title="Embedding Agent" icon="vector-square" href="/agents/embedding">
    Generate text embeddings
  </Card>
  <Card title="Video Agent" icon="video" href="/docs/agents/video">
