...
<Note>
Deep Research uses these hosted tools internally. If you only need one of them (e.g. hosted web search or file search over a vector store), attach it to any `Agent` — see [Hosted Tools](/docs/features/hosted-tools).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card icon="globe" href="/agents/websearch">
