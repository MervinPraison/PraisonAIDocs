...
description: "Comprehensive guide to optimizing performance in multi-agent AI systems"
icon: "gauge-high"
---
...
To measure where time goes in your agents, see [Profiling](/docs/features/profiling).
