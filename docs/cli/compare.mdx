...
- [Deep Research](/cli/deep-research) - Comprehensive research mode
- [Planning](/cli/planning) - Planning-enabled execution
- [Web Search](/cli/web-search) - Native web search
- [Tools](/cli/tools) - Tool integration
- [Evaluation](/cli/eval) - Agent evaluation framework
