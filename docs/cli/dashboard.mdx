...
<Step title="Integrated Agent Dashboard">
...
<Warning>Set `PRAISONAI_HOST_LEGACY=1` for callback-only mode without provider wiring.</Warning>
</Step>
</Steps>
...
- Review the [Bot Security Guide](/best-practices/bot-security) for additional measures
...
| `--aiui` | `bool` | `False` | Use integrated agent host (Pattern B) with unified dashboard pages |
...
This uses Pattern B host integration with unified agent pages. See [Host Integration](/features/host-integration) for details.
...
graph TB
    ...
    Q -->|Agent-focused workflows| C[praisonai dashboard --aiui]
...
<Accordion title="Use --aiui for integrated agent workflows">
...
<CardGroup cols={2}>
  <Card title="Claw Dashboard" icon="claw" href="/ui/claw">
    Full administrative dashboard for managing agents, tools, and channels
  </Card>
  <Card title="Flow Builder" icon="workflow" href="/ui/flow">
    Visual workflow designer with drag-and-drop interface
  </Card>
  <Card title="Chat UI" icon="message-circle" href="/ui/ui">
    Clean, distraction-free chat interface
  </Card>
  <Card title="Unified Server" icon="server" href="/deploy/servers/unified">
