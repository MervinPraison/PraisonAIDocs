...
On Windows, sessions are stored under `%USERPROFILE%\.praison\sessions\{session_id}.json` following the OS convention via `Path.home()`. Cross-platform support was added in [PR #1837](https://github.com/MervinPraison/PraisonAI/pull/1837) and enhanced in [PR #1892](https://github.com/MervinPraison/PraisonAI/pull/1892).
