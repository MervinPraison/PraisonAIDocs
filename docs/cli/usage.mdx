...
<AccordionGroup>
  ...
  <Accordion title="Missing cost? Check pricing coverage">
    Cost only appears for models present in the default pricing table. See [Cost Tracking](/cli/cost-tracking) to add custom pricing.
  </Accordion>
