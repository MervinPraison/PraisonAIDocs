...
|--------|-------|-------------|
| `--schedule` | `-s` | When to run: `hourly`, `daily`, `weekly`, `*/30m`, `cron:...`, `at:...`, `in 20 minutes`, `at 9am`, `every day at 9am`, `weekdays at 9am`, `every monday 9am`, `every mon,wed,fri at 9am` |
