...
![Metrics Shows Token Usage](./metrics-metrics-shows-token-usage-and-.gif)
...
For cross-session aggregate reporting — rolling up token and cost totals by day, model, or project — see [Usage](/cli/usage).

## Related

- [Usage](/cli/usage)
- [Telemetry CLI](/cli/telemetry)
- [Router CLI](/cli/router)
- [Models](/models)
