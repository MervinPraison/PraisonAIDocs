...
|-------|---------|-------------------|
| `console` | Interactive terminal prompt (default) — see [Interactive Tool Approval](/docs/features/interactive-approval) for the once/session/always scope choices | — |
