...
If you installed only `praisonai-code`, this command will not appear in `--help` and will fail at dispatch time. See [Package Structure](/docs/installation#package-structure) for the three-package install model.
</Warning>
