...
├── praisonai chat           # TUI mode (resident TUI, standalone)
├── praisonai chat                  # Single prompt chat mode (resident TUI, standalone)
│
...
| `praisonai chat` / `-i` | flag | Interactive TUI mode (resident TUI, standalone) |
| `praisonai chat` | flag | Single prompt chat mode (resident TUI, standalone) |
