...
![Tool Tracking Shows Which Tools Used](./tool-tracking-tool-tracking-shows-which-tool.gif)
...
<CardGroup cols={2}>
  <Card title="Interactive Mode" icon="terminal" href="/cli/interactive-tui">
    Full interactive TUI with tool support
  </Card>
  <Card title="Tools Management" icon="wrench" href="/cli/tools">
    Discover and manage available tools
  </Card>
  <Card title="Cost Tracking" icon="dollar-sign" href="/cli/cost-tracking">
    Track token usage and costs
  </Card>
  <Card title="Verbose Output" icon="eye" href="/cli/cli#tool-call-tracking">
