...
### OpenAI Agents Runtime Check

The `praisonai doctor` command detects the OpenAI Agents SDK and reports its capabilities:
...
If not installed, doctor shows a failure with the install hint. Fix with:
