...
`bot_tokens` and `gateway_env_substitution` still run — they don't need the bot schema. See [Installation Extras](/docs/features/installation-extras) for the full list of optional extras.
</Note>
