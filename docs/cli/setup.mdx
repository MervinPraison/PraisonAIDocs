...
| `--no-verify` | Skip the post-setup smoke test (offline/CI). Default: run the smoke test. |
...
After saving your config, `setup` runs a smoke test to prove your key and model actually work.
