...
<img src="/img/cli/cli-direct-prompt-execution.gif" alt="Direct prompt execution" />
...
<img src="/img/cli/cli-with-specific-model.gif" alt="With specific model" />
...
<img src="/img/cli/cli-verbose-mode.gif" alt="Verbose mode" />
...
| `--research` | Run deep research on topic | `praisonai "topic" --research` |
