...
See [Auth](/cli/auth) and [First-run Onboarding](/docs/features/first-run-onboarding#keyless-local-first-ollama-openai-compatible) for the full behaviour matrix and CI examples.
