...
| `--no-rules` | | Disable auto-injection of project instruction files (AGENTS.md, CLAUDE.md, etc.) — includes both the up-front project-root walk-up and the on-demand subtree attach fired as the agent touches files under a nested AGENTS.md. | `false` |
