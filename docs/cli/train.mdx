...
| `1` | Expected, actionable failure — printed as a single `ERROR: <message>` line to stderr with no Python traceback. Covers preflight failures, config errors, HF/Ollama publish errors, and `ollama create`/`push` failures. |
