...
| [Videos](/capabilities/videos) | Video generation (default `openai/sora-2`) | [Code](/capabilities/videos) | [CLI](/capabilities/videos-cli) |
...
- **Videos**: [video_generate](/capabilities/videos) (default `openai/sora-2`)
