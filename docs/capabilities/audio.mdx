...
<Card title="AudioAgent" icon="user" href="/audio/overview">
Higher-level Agent abstraction for audio
</Card>
<Card title="Completions" icon="message" href="/capabilities/completions">
Sibling chat/text completion capability
</Card>
<Card title="Audio CLI" icon="terminal" href="/capabilities/audio-cli">
