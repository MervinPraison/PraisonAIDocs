...
<div className="mt-16 text-center">
  ...
  <div className="flex flex-wrap justify-center items-center gap-4">
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">OpenAI</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Anthropic</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Google Gemini</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">DeepSeek</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Azure</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Ollama</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Groq</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Mistral</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Cerebras</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Cohere</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">OpenRouter</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Perplexity</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Fireworks</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">AWS Bedrock</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">xAI Grok</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Vertex AI</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">HuggingFace</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Together AI</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Databricks</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Replicate</span>
    <span className="px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold text-sm border border-gray-200 dark:border-gray-700">Cloudflare</span>
    <a href="/docs/models" className="px-4 py-2 rounded-lg bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 font-semibold text-sm border border-primary-200 dark:border-primary-800 hover:bg-primary-200 dark:hover:bg-primary-900/50 transition-colors no-underline">+ 80 more →</a>
  </div>
</div>
...
<div className="mt-16">
  ...
  <CardGroup cols={3}>
    ...
    <Card title="🦞 AgentClaw" icon="layout-dashboard" href="/docs/concepts/claw">
...
<div className="mt-16">
  ...
  <CardGroup cols={4}>
    <Card title="Slack" icon="slack" href="/docs/concepts/claw">
      Deploy AI bots to Slack workspaces
    </Card>
    <Card title="Discord" icon="discord" href="/docs/concepts/claw">
      Create Discord bots with agent intelligence
    </Card>
    <Card title="Telegram" icon="telegram" href="/docs/concepts/claw">
      Build Telegram bots in minutes
    </Card>
    <Card title="WhatsApp" icon="whatsapp" href="/docs/concepts/claw">
...
<div className="mt-16">
  ...
  <p className="text-center text-gray-600 dark:text-gray-400 mb-6">AI agents solving real-world problems across industries</p>
  
  <CardGroup cols={3}>
    <Card title="Research & Analysis" icon="magnifying-glass" href="/docs/examples/agent-recipes/index">
      Conduct deep research, gather information, and generate insights from multiple sources automatically.
    </Card>
    <Card title="Code Generation" icon="code" href="/docs/examples/agent-recipes/index">
      Write, debug, and refactor code with AI agents that understand your codebase and requirements.
    </Card>
    <Card title="Content Creation" icon="pen-nib" href="/docs/examples/agent-recipes/index">
      Generate blog posts, documentation, marketing copy, and technical writing with multi-agent teams.
    </Card>
    <Card title="Data Pipelines" icon="chart-line" href="/docs/examples/agent-recipes/index">
      Extract, transform, and analyze data from APIs, databases, and web sources automatically.
    </Card>
    <Card title="Customer Support" icon="headset" href="/docs/concepts/claw">
      Deploy 24/7 support bots on Telegram, Discord, Slack with memory and knowledge-backed responses.
    </Card>
    <Card title="Workflow Automation" icon="gears" href="/docs/features/workflows">
