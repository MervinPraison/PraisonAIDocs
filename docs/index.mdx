...
<div className="mt-16 text-center">
  ...
  <div className="flex flex-wrap justify-center items-center gap-8">
    <img src="images/providers/openai.svg" alt="OpenAI" className="h-10 dark:invert" />
    <img src="images/providers/anthropic.svg" alt="Anthropic" className="h-10 dark:invert" />
    <img src="images/providers/google.svg" alt="Google" className="h-10 dark:invert" />
    <img src="images/providers/deepseek.svg" alt="DeepSeek" className="h-10 dark:invert" />
    <img src="images/providers/azure.svg" alt="Azure" className="h-10 dark:invert" />
    <img src="images/providers/ollama.svg" alt="Ollama" className="h-10 dark:invert" />
    <img src="images/providers/groq.svg" alt="Groq" className="h-10 dark:invert" />
    <img src="images/providers/mistral.svg" alt="Mistral" className="h-10 dark:invert" />
    <img src="images/providers/cerebras.svg" alt="Cerebras" className="h-10 dark:invert" />
    <img src="images/providers/cohere.svg" alt="Cohere" className="h-10 dark:invert" />
    <img src="images/providers/openrouter.svg" alt="OpenRouter" className="h-10 dark:invert" />
    <img src="images/providers/perplexity.svg" alt="Perplexity" className="h-10 dark:invert" />
    <img src="images/providers/fireworks.svg" alt="Fireworks" className="h-10 dark:invert" />
    <img src="images/providers/bedrock.svg" alt="AWS Bedrock" className="h-10 dark:invert" />
  </div>
</div>
