...
description: "Build, run, and manage multi-agent AI systems with self-reflection. Agents, teams, workflows, and 100+ LLM and tool integrations on PraisonAI."
keywords: ["PraisonAI documentation", "AI agents", "multi-agent systems", "agent framework"]
icon: "house"
mode: "custom"
---
...
<div className="text-center py-12">
  ...
  <div className="max-w-xl mx-auto mb-8">
    <div className="w-full flex items-center gap-3 px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400">
...
<CardGroup cols={3}>
  ...
  <Card title="Explore SDK" icon="code" href="/introduction">
...
<div className="mt-16 text-center">
  ...
  <div className="flex flex-wrap justify-center items-center gap-3">
    ...
    <a href="/models" className="no-underline"><img src="https://img.shields.io/badge/+_80_more_→-4f46e5?style=flat" alt="80+ more providers" /></a>
  </div>
</div>
...
<div className="mt-16">
  ...
  <Tabs>
    ...
    <Tab title="Low Code">
      ...
      The same `--continue`, `--session`, `--output`, and permission flags documented for [`praisonai run`](/cli/run) also work here — `praisonai agents.yaml --continue --output json` resumes the last session and emits machine-parseable output.
    </Tab>
  </Tabs>
</div>
...
<div className="mt-16">
  ...
  <CardGroup cols={3}>
    <Card title="Agents" icon="users" href="/agents/agents">
      Single agents, multi-agent teams, coordination
    </Card>
    <Card title="Tools" icon="toolbox" href="/tools/tools">
    ...
    <Card title="Memory & RAG" icon="database" href="/features/rag">
      Vector stores, knowledge bases, retrieval
    </Card>
    <Card title="🦞 AgentClaw" icon="layout-dashboard" href="/ui/claw">
      Full UI with chat, agents, Telegram, Discord, Slack
    </Card>
    <Card title="Recipes" icon="wand-magic-sparkles" href="/examples/agent-recipes/index">
...
<div className="mt-16">
  ...
  <CardGroup cols={4}>
    <Card title="Slack" icon="slack" href="/ui/claw">
      Deploy AI bots to Slack workspaces
    </Card>
    <Card title="Discord" icon="discord" href="/ui/claw">
      Create Discord bots with agent intelligence
    </Card>
    <Card title="Telegram" icon="telegram" href="/ui/claw">
      Build Telegram bots in minutes
    </Card>
    <Card title="WhatsApp" icon="whatsapp" href="/ui/claw">
      Connect via WhatsApp Business
    </Card>
  </CardGroup>
  
  <CardGroup cols={4}>
    <Card title="GitHub" icon="github" href="/tools/tools">
      Automate repos, issues, and PRs
    </Card>
    <Card title="Google" icon="google" href="/tools/tools">
      Calendar, Sheets, Drive, Gmail
    </Card>
    <Card title="Notion" icon="file-lines" href="/tools/tools">
      Read and write Notion pages
    </Card>
    <Card title="Jira" icon="jira" href="/tools/tools">
