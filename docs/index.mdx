...
<div className="flex justify-center gap-6 mb-0">
  ...
  <Tabs>
    ...
    <Tab title="🦞 Dashboard">
      ...
      praisonai claw
      ```
      Open **http://localhost:8082** — full dashboard with chat, agents, memory,
...
<div className="mt-16">
  ...
  <CardGroup cols={3}>
    ...
    <Card title="🦞 Dashboard" icon="layout-dashboard" href="/docs/concepts/claw">
...
<div className="mt-16 mb-12">
  ...
  <CardGroup cols={4}>
    <Card title="🦞 Claw" icon="layout-dashboard" href="/docs/concepts/claw">
      Full dashboard UI
    </Card>
