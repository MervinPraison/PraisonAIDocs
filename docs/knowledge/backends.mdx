...
<CardGroup cols={2}>
  <Card title="Vector Store" icon="database" href="/docs/features/vector-store">
    Embeddings, similarity search, namespaces, and custom backends
  </Card>
  <Card title="Knowledge Storage" icon="server" href="/docs/knowledge/storage">
    Choosing and configuring vector store backends
  </Card>
</CardGroup>
