...
backend = FileBackend(
    storage_dir="~/.praison/storage",  # Directory for files
...
backend = SQLiteBackend(
    db_path="~/.praison/storage.db",  # Database file
...
# Default: file-based storage in ~/.praison/runs/
history = RunHistory()
...
# Default: file-based in ~/.praison/sessions/
...
# Default: file-based in ~/.praison/mcp/
index = MCPToolIndex()
