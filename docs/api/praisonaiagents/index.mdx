...
<CardGroup cols={2}>
  ...
  <Card title="Display Functions" icon="display" href="/api/praisonaiagents/display">
    Display and formatting utilities for agent interactions
  </Card>
  <Card title="Output Classes" icon="square-check" href="/api/praisonaiagents/outputs">
    Data classes for task outputs and reflections
  </Card>
  <Card title="Telemetry" icon="chart-line" href="/api/praisonaiagents/telemetry">
    Telemetry and observability functions for monitoring
  </Card>
  <Card title="Memory" icon="brain" href="/api/praisonaiagents/memory/memory">
