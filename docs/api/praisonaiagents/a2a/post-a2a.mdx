...
- [A2A API Overview](/api/praisonaiagents/a2a/endpoints)
- [GET /.well-known/agent.json](/api/praisonaiagents/a2a/get-agent-card)
- [GET /status](/api/praisonaiagents/a2a/get-status)
- [A2A Architecture](/api/praisonaiagents/a2a/architecture)
