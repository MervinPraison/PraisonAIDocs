...
<CardGroup cols={2}>
  <Card title="Agent Launch API" icon="rocket" href="/docs/api/praisonaiagents/launch/endpoints">
    Deploy agents as HTTP REST endpoints
  </Card>
  <Card title="MCP Server API" icon="plug" href="/docs/api/praisonaiagents/mcp/endpoints">
...
| Service | Default URL |
|---------|-------------|
| Agent Launch | `http://localhost:8000/{path}` |
