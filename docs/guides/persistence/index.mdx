...
<CardGroup cols={2}>
  <Card title="Overview" icon="book" href="/guides/persistence/overview">
    Persistence concepts
  </Card>
  <Card title="Database Setup" icon="database" href="/guides/persistence/databases">
    Configure database backends
  </Card>
  <Card title="Session Resume" icon="rotate-right" href="/guides/persistence/session-resume">
