...
<CardGroup cols={2}>
  <Card title="Persistence Overview" icon="book" href="/guides/persistence/overview">
    Persistence concepts
  </Card>
  <Card title="Session Resume" icon="rotate" href="/guides/persistence/session-resume">
