...
<CardGroup cols={2}>
  ...
  <Card title="Event-Driven" icon="bolt" href="/guides/recipes/integration-models/event-driven">
    **High Volume** - Queue-based async processing
  </Card>
  <Card title="CLI Invocation" icon="terminal" href="/guides/recipes/integration-models/cli-invocation">
...
- [Remote Managed Runner](/guides/recipes/integration-models/remote-managed-runner) - Detailed deployment guide
- [Event-Driven](/guides/recipes/integration-models/event-driven) - Queue-based scaling
- [App Developer Persona](/guides/recipes/personas/app-developer) - Client integration