...
<CardGroup cols={2}>
  <Card title="App Developer" icon="code" href="/guides/recipes/personas/app-developer">
    **Build applications** that use recipes. Focus on SDK integration, error handling, and user experience.
  </Card>
  <Card title="Platform/DevOps" icon="server" href="/guides/recipes/personas/platform-devops">
    **Deploy and operate** recipe infrastructure. Focus on scaling, monitoring, security, and reliability.
  </Card>
  <Card title="Recipe Author" icon="wand-magic-sparkles" href="/guides/recipes/personas/recipe-author">
...
### App Developer
1. Start with [Embedded SDK](/guides/recipes/integration-models/embedded-sdk)
2. Learn [CLI Invocation](/guides/recipes/integration-models/cli-invocation) for scripts
3. Explore [Use Cases](/guides/recipes/use-cases) for patterns

### Platform/DevOps
1. Start with [Local HTTP Sidecar](/guides/recipes/integration-models/local-http-sidecar)
2. Progress to [Remote Managed Runner](/guides/recipes/integration-models/remote-managed-runner)
3. Learn [Event-Driven](/guides/recipes/integration-models/event-driven) for scale

### Recipe Author
1. Understand all [Integration Models](/guides/recipes/integration-models)
2. Study [Use Cases](/guides/recipes/use-cases) for inspiration
3. Review [Decision Guide](/guides/recipes/decision-guide) for recommendations
...
- [Integration Models](/guides/recipes/integration-models) - Technical integration options
- [Use Cases](/guides/recipes/use-cases) - Real-world implementation patterns
- [Decision Guide](/guides/recipes/decision-guide) - Choosing the right approach