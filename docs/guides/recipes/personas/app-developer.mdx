...
<CardGroup cols={2}>
  <Card title="Embedded SDK" icon="python" href="/guides/recipes/integration-models/embedded-sdk">
...
- [Embedded SDK](/guides/recipes/integration-models/embedded-sdk) - Detailed Python integration
- [Use Cases](/guides/recipes/use-cases) - Implementation patterns
- [Platform/DevOps Persona](/guides/recipes/personas/platform-devops) - Deployment guidance