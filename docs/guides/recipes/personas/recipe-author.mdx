...
<CardGroup cols={2}>
  <Card title="All Integration Models" icon="diagram-project" href="/guides/recipes/integration-models">
    Understand how recipes are consumed
  </Card>
  <Card title="Use Cases" icon="lightbulb" href="/guides/recipes/use-cases">
    Learn from existing patterns
  </Card>
  <Card title="Decision Guide" icon="map" href="/guides/recipes/decision-guide">
    Help users choose the right approach
  </Card>
  <Card title="App Developer Persona" icon="code" href="/guides/recipes/personas/app-developer">
...
- [Integration Models](/guides/recipes/integration-models) - How recipes are consumed
- [Use Cases](/guides/recipes/use-cases) - Inspiration for new recipes
