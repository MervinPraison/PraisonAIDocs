...
flowchart TD
    ...
    classDef net fill:#189AB4,stroke:#7C90A0,color:#fff
...
<CardGroup cols={2}>
  <Card title="Integration Models" icon="diagram-project" href="/guides/recipes/integration-models">
    Detailed setup for each model
  </Card>
  <Card title="Use Cases" icon="lightbulb" href="/guides/recipes/use-cases">
