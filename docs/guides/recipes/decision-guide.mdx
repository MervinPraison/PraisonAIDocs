...
└─────────────────────────────────────────────────────────────┘
                    ...
                    ┌─────────────────┐
                    │ Is your app     │
                    │ written in      │──── Yes ───▶ Model 1: Embedded SDK
                    │ Python?         │              (lowest latency)
                    └─────────────────┘
                              │ No
                              ▼
                    ┌─────────────────┐
                    │ Is this for     │
                    │ scripts/CI/CD?  │──── Yes ───▶ Model 2: CLI Invocation
                    └─────────────────┘              (simplest)
                              │ No
                              ▼
                    ┌─────────────────┐
                    │ Single machine/ │
                    │ dev environment?│──── Yes ───▶ Model 3: HTTP Sidecar
                    └─────────────────┘              (polyglot, local)
                              │ No
                              ▼
                    ┌─────────────────┐
                    │ Need async/     │
                    │ batch processing│──── Yes ───▶ Model 5: Event-Driven
                    └─────────────────┘              (scalable async)
                              │ No
                              ▼
                    ┌─────────────────┐
                    │ Building IDE/   │
                    │ CMS plugin?     │──── Yes ───▶ Model 6: Plugin Mode
                    └─────────────────┘              (native UX)
                              │ No
                              ▼
                    ┌─────────────────┐
                    │ Multi-tenant    │
                    │ production?     │──── Yes ───▶ Model 4: Remote Runner
                    └─────────────────┘              (managed, secure)
```
