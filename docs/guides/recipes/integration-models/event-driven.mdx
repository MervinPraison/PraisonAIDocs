...
- [Plugin Mode](/guides/recipes/integration-models/plugin-mode) - For IDE/CMS integration
- [Platform/DevOps Persona](/guides/recipes/personas/platform-devops) - Infrastructure patterns
- [Use Cases](/guides/recipes/use-cases) - Real-world implementations