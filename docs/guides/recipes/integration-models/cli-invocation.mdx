...
- [Local HTTP Sidecar](/guides/recipes/integration-models/local-http-sidecar) - For HTTP-based integration
- [Remote Managed Runner](/guides/recipes/integration-models/remote-managed-runner) - For production deployments
