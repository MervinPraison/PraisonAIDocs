...
- [CLI Invocation](/guides/recipes/integration-models/cli-invocation) - For scripts and automation
- [Local HTTP Sidecar](/guides/recipes/integration-models/local-http-sidecar) - For polyglot environments
