...
<CardGroup cols={2}>
  <Card title="Model 1: Embedded SDK" icon="python" href="/guides/recipes/integration-models/embedded-sdk">
    **Lowest latency** - Direct Python integration with zero network overhead. Best for Python applications and notebooks.
  </Card>
  <Card title="Model 2: CLI Invocation" icon="terminal" href="/guides/recipes/integration-models/cli-invocation">
    **Language-agnostic** - Invoke recipes from any language via subprocess. Perfect for scripts and CI/CD pipelines.
  </Card>
  <Card title="Model 3: Local HTTP Sidecar" icon="server" href="/guides/recipes/integration-models/local-http-sidecar">
    **Polyglot friendly** - HTTP API running locally. Ideal for microservices and non-Python applications.
  </Card>
  <Card title="Model 4: Remote Managed Runner" icon="cloud" href="/guides/recipes/integration-models/remote-managed-runner">
    **Production-ready** - Centralized, authenticated recipe execution. Built for multi-tenant cloud deployments.
  </Card>
  <Card title="Model 5: Event-Driven" icon="bolt" href="/guides/recipes/integration-models/event-driven">
    **Async at scale** - Queue-based invocation for high-volume batch processing and decoupled architectures.
  </Card>
  <Card title="Model 6: Plugin Mode" icon="puzzle-piece" href="/guides/recipes/integration-models/plugin-mode">
...
<Step title="Simple Usage">
  Run a recipe from Python with the embedded SDK:
...
<Step title="With Configuration">
  Use CLI or a local HTTP sidecar when you need language-agnostic or service-style invocation:
...
3. Review [Personas](/guides/recipes/personas) for role-specific guidance
4. Explore [Use Cases](/guides/recipes/use-cases) for implementation patterns