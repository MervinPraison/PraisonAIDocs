...
sequenceDiagram
    ...
    User->>Agent: Describe a business scenario
    Agent->>Recipe: Select pattern + integration model
    Recipe-->>Agent: Steps and schema
...
<AccordionGroup>
<Accordion title="Start from the closest listed pattern">
