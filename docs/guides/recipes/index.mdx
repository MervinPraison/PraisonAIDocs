...
<CardGroup cols={2}>
  ...
  <Card title="Personas" icon="users" href="/guides/recipes/personas">
    Who uses recipes and how
  </Card>
  <Card title="Decision Guide" icon="compass" href="/guides/recipes/decision-guide">
...
Six models trade latency, language, and operational complexity. The [Decision Guide](/guides/recipes/decision-guide) maps your stack to the right one.
</Accordion>
...
1. Review the [Integration Models](/guides/recipes/integration-models) to choose your approach
2. Explore [Use Cases](/guides/recipes/use-cases) for implementation patterns
