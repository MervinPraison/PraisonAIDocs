...
<CardGroup cols={2}>
  <Card title="Knowledge Base Setup" icon="database" href="/guides/rag/knowledge-base">
    Create and configure knowledge bases
  </Card>
  <Card title="Chunking Strategies" icon="scissors" href="/guides/rag/chunking">
    Optimize document chunking
  </Card>
  <Card title="Retrieval Methods" icon="magnifying-glass" href="/guides/rag/retrieval">
