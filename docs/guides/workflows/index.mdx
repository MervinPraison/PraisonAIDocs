...
<CardGroup cols={2}>
  ...
  <Card title="⚡ Parallel" icon="arrows-split-up-and-left" href="/guides/workflows/parallel">
    **"Everyone works at once"**
    
    Like a team researching different topics simultaneously.
  </Card>
  <Card title="➡️ Sequential" icon="arrow-right" href="/guides/workflows/sequential">
    **"One step at a time"**
    
    Like passing a document from person to person for review.
  </Card>
  <Card title="👔 Orchestrator" icon="sitemap" href="/guides/workflows/orchestrator">
...
<CardGroup cols={2}>
  <Card title="Sequential Workflow" icon="arrow-right" href="/guides/workflows/sequential">
    Start with the simplest pattern
  </Card>
  <Card title="Full Reference" icon="book" href="/features/workflows">
