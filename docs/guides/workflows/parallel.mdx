...
sequenceDiagram
    ...
    AgentFlow->>Agents: Launch all at once
    Agents-->>AgentFlow: parallel_outputs list
    AgentFlow-->>User: Combined result
```
...
<AccordionGroup>
<Accordion title="Only parallelise independent work">
...
<Accordion title="Pick a failure strategy on purpose">
...
<Accordion title="Read results from parallel_outputs">
...
<Accordion title="Import parallel from the top level">
...
<CardGroup cols={2}>
  <Card title="Sequential" icon="arrow-right" href="/guides/workflows/sequential">
    One step at a time
  </Card>
  <Card title="Routing" icon="route" href="/guides/workflows/routing">
