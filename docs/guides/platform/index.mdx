...
<CardGroup cols={2}>
  <Card title="Authentication" icon="shield-check" href="/features/platform/authentication">
    JWT authentication system
  </Card>
  
  <Card title="Workspaces" icon="building" href="/features/platform/workspaces">
    Multi-tenant workspace management
  </Card>
  
  <Card title="Projects" icon="folder" href="/features/platform/projects">
    Project organization and management
  </Card>
  
  <Card title="Issues" icon="bug" href="/features/platform/issues">
    Issue tracking and management
  </Card>
  
  <Card title="Agents" icon="robot" href="/features/platform/agents">
    AI agent registration and management
  </Card>
  
  <Card title="Comments" icon="message-circle" href="/features/platform/comments">
    Issue commenting system
  </Card>
  
  <Card title="Labels" icon="tag" href="/features/platform/labels">
    Issue labeling system
  </Card>
  
  <Card title="Dependencies" icon="link" href="/features/platform/dependencies">
    Issue dependency tracking
  </Card>
  
  <Card title="Data Model" icon="database" href="/features/platform/data-model">
