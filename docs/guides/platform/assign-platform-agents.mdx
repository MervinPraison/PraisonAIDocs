...
<CardGroup cols={2}>
<Card title="Issue Organization" icon="list-check" href="/guides/platform/organize-issues">
  Structure work for optimal agent assignment
</Card>

<Card title="Platform API" icon="code" href="/features/platform/agents">
  Complete agent management API reference
</Card>

<Card title="Workflow Automation" icon="workflow" href="/features/workflows">
  Advanced automation and orchestration
</Card>

<Card title="Integration Patterns" icon="puzzle-piece" href="/guides/recipes/index">
