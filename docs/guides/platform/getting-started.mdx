...
agent = Agent(
    ...
    instructions="Assist with workspace setup tasks.",
)
...
<Steps>
<Step title="Default: In-Memory SQLite">
By default, the platform uses an in-memory SQLite database — your data is lost when the server restarts.
...
<Note>
For complete database schema documentation, see the [Data Model](/features/platform/data-model) page.
</Note>
</Step>
</Steps>
...
<CardGroup cols={2}>
<Card title="Quick Tutorial" icon="graduation-cap" href="/guides/platform/quick-tutorial">
  Learn core Platform concepts with hands-on examples
</Card>

<Card title="Agent Management" icon="robot" href="/features/platform/agents">
  Connect and manage AI agents in your workspace
</Card>

<Card title="Python SDK" icon="code" href="/features/platform/sdk-client">
  Use the Python SDK for programmatic Platform access
</Card>

<Card title="API Reference" icon="book" href="/features/platform/agents">
