...
<Note>
**Prerequisites:** Platform server running on `localhost:8000`. If you haven't set up the server yet, see the [Getting Started guide](/docs/guides/platform/getting-started).
</Note>
