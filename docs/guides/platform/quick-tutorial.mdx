...
<Note>
Platform is now a separate repository - install with `pip install praisonai-platform` as before, and see the [PraisonAI-Platform repo](https://github.com/MervinPraison/PraisonAI-Platform) for source and issues. Details: [Where Platform Lives](/features/platform/where-platform-lives).
</Note>

Set up a complete project management workflow with AI agents in under 10 minutes.
...
agent = Agent(
    name="Tutorial Agent",
    instructions="Help complete the platform quick-start workflow.",
)
...
<Note>
**Prerequisites:** Platform server running on `localhost:8000`. If you haven't set up the server yet, see the [Getting Started guide](/guides/platform/getting-started).
</Note>
...
<CardGroup cols={2}>
<Card title="Platform Authentication" icon="shield-check" href="/features/platform/authentication">
  Advanced auth patterns and API key management
</Card>
<Card title="Issue Management" icon="ticket" href="/features/platform/issues">
  Advanced issue workflows and automation
</Card>
<Card title="Agent Configuration" icon="robot" href="/features/platform/agents">
  Customize agent capabilities and behavior
</Card>
<Card title="Workspace Management" icon="building" href="/features/platform/workspaces">
