...
agent = Agent(
    name="Triage Agent",
    instructions="Label and prioritise incoming issues.",
)
...
<CardGroup cols={2}>
<Card title="Platform Issues" icon="list" href="/features/platform/issues">
  Create and manage issues in your workspace
</Card>
<Card title="Issue IDs" icon="hashtag" href="/features/platform/issue-ids">
