...
See the [Tool Parameter Types](/tools/parameter-types) page for complete reference on using Optional, Union, Literal, Enum, List, and Dict types.
...
<CardGroup cols={2}>
  <Card title="Different Ways to Create" icon="layer-group" href="/guides/tools/different-ways-to-create-tools">
