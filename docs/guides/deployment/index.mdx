...
<CardGroup cols={2}>
  <Card title="24/7 Production Minimal" icon="rocket-launch" href="/guides/deployment/production-minimal">
    **Start here** - Always-on deployment with process supervision
  </Card>
  <Card title="Overview" icon="book" href="/guides/deployment/overview">
