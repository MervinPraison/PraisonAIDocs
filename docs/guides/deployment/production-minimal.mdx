...
<CardGroup cols={2}>
  <Card title="Bot Integration" icon="robot" href="/ui/claw">
    Connect to Slack, Discord, Telegram, and WhatsApp
  </Card>
  <Card title="Advanced Deployment" icon="gear" href="/tutorials/production-deployment">
...
- 📚 [Full Documentation](https://praison.ai/docs)
