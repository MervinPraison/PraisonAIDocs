...
|--------|----------|------------|-------|
| **Production Minimal** | Always-on 24/7 operation | **Low** | [📖 Guide](/guides/deployment/production-minimal) |
| Docker Compose | Containerized deployments | Low | [📖 Guide](/guides/deployment/docker) |
| Kubernetes | Scalable production | Medium | [📖 Guide](/tutorials/production-deployment) |
| Cloud Functions | Serverless | Low | [📖 Guide](/sdk/praisonai/deploy) |
| API Server | REST/WebSocket APIs | Medium | [📖 Guide](/sdk/praisonai/deploy) |
