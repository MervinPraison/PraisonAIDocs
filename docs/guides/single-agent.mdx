...
| `output` | `str \| OutputConfig` | Output mode (`"silent"`, `"verbose"`, `"stream"`, …) or `OutputConfig(...)` for fine-grained control |
...
- [Multi-Agent Systems](/guides/multi-agent) - Build systems with multiple agents
- [Adding Tools](/tools) - Extend agent capabilities
- [Agent Module Reference](/sdk/praisonaiagents/agent/agent) - Full API reference
