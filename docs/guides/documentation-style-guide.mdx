...
<Card title="[Feature] API Reference" icon="code" href="/docs/sdk/reference/praisonaiagents/classes/PraisonConfig">
...
```mdx
<CardGroup cols={2}>
<Card title="Card Title" icon="icon-name" href="/docs/guides/documentation-style-guide">
Card description.
</Card>
<Card title="Card Title" icon="icon-name" href="/docs/guides/documentation-style-guide">
Card description.
