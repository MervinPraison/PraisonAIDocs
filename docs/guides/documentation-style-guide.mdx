...
<Card title="[Feature] API Reference" icon="code" href="/docs/sdk/reference/typescript/classes/LearnConfig">
...
```mdx
<CardGroup cols={2}>
<Card title="Card Title" icon="icon-name" href="/docs/features/agents">
Card description.
</Card>
<Card title="Card Title" icon="icon-name" href="/docs/features/agents">
Card description.
