...
# Define leaf agents first, then wire handoffs to instances
editor = Agent(
    name="Editor",
...
- [Workflows](/guides/workflows/routing) - Advanced workflow patterns
- [Handoff](/features/handoffs) - Agent handoff concepts
- [Agents Module Reference](/sdk/praisonaiagents/agents/agents) - Full API reference
